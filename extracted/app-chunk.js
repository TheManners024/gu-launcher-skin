    ...
    1900: (Et, Se, g) => {
        ...
        function Jd(o, r) {
            if (1 & o && (e.TgZ(0, "div", 26, 27), e.YNc(2, Yd, 5, 0, "div", 28), e._UZ(3, "img", 29), e.TgZ(4, "div", 30), e._uU(5), e.qZA()()), 2 & o) {
                const t = e.oxw();
                e.xp6(2), e.Q6J("ngIf", t.gameMode.properties.sub_type === t.GuGameModeSubType.WEEKEND_EVENT), e.xp6(1), e.MGl("src", "/gu-assets/images/rank-progress/gu-progress-rank-cracks--", t.shieldCrackCount, ".svg", e.LSH), e.xp6(1), e.ekj("cardHeader__shield__rankInitials--maxRank", t.isMaxRank), e.xp6(1), e.hij("", (t.gameMode.rank?.rating?.toFixed(0) || t.currentRankInitials), "")
            }
        }

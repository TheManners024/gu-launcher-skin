...
(self.webpackChunkdesktop = self.webpackChunkdesktop || []).push([[848], {
    37848: (gt, be, g) => {
        ...
        function ue(o, r) {
            ...
            return r.isWindow ? function (o, r, t) {
                const {axis: n, container: i, isWindow: a} = t
                    , {offsetHeightKey: s, clientHeightKey: c} = pt(n)
                    , d = o + Qt(W(a, i), n, a)
                    , p = Rt(r.nativeElement, a, s, c)
                    , w = function (o, r, t) {
                    const n = r.topKey();
                    if (o.getBoundingClientRect)
                        return o.getBoundingClientRect()[n] + Qt(o, r, t)
                ...
                return {
                    height: o,
                    scrolled: i[n.scrollTopKey()],
                    totalToScroll: i[n.scrollHeightKey()],
                    isWindow: !1
                }
            }(t, 0, r)
        }
        ...
        function pt(o) {
            return {
                offsetHeightKey: o.offsetHeightKey(),
                clientHeightKey: o.clientHeightKey()
            }
        }
        ...
        function Yn(o, r, t) {
            let n, i;
            if (o.totalToScroll <= 0)
                return !1;
            const a = o.isWindow ? o.scrolled : o.height + o.scrolled;
            return t ? (n = (o.totalToScroll - a) / o.totalToScroll,
                i = r.down / 10) : (n = o.scrolled / (o.scrolled + (o.totalToScroll - a)),
                i = r.up / 10),
            n <= i
        }
        ...
        class Wn {
            ...
            updateTotalToScroll(r) {
                this.lastTotalToScroll !== r && (this.lastTotalToScroll = this.totalToScroll,
                    this.totalToScroll = r)
            }

            updateScroll(r, t) {
                this.updateScrollPosition(r),
                    this.updateTotalToScroll(t)
            }
        ...
        function zn(o) {
            const {scrollContainer: r, scrollWindow: t, element: n, fromRoot: i} = o
                ...
                axis: new E(!o.horizontal),
                windowElement: We(r, t, n, i)
            })
                , s = new Wn({
                totalToScroll: ue(n, a)
            })
                , d = {
                up: o.upDistance,
                down: o.downDistance
            ...
            return function (o) {
                let r = (0,
                    V.R)(o.container, "scroll");
                return o.throttle && (r = r.pipe((0,
                    $e.p)(o.throttle))),
                    r
            }({
            ...
            }(s.lastScrollPosition, p, d)), (0,
                b.b)(({stats: p}) => s.updateScroll(p.scrolled, p.totalToScroll)), (0,
                P.h)(({fire: p, scrollDown: w, stats: {totalToScroll: v}}) => function (o, r, t) {
                return !!(o && r || !t && r)
            }(o.alwaysCallback, p, s.isTriggeredScroll(v, w))), (0,
                b.b)(({scrollDown: p, stats: {totalToScroll: w}}) => {
        ...
        function Xn(o) {
            ...
            return {
                type: r ? "[NGX_ISE] DOWN" : "[NGX_ISE] UP",
                payload: {
        ...
        let ut = (() => {
                class o {
                    constructor(t, n) {
                        this.element = t,
                            this.zone = n,
                            this.scrolled = new e.vpe,
                            this.scrolledUp = new e.vpe,
        ...
        let Xe = (() => {
                class o {
                    ...
                    onContainerCreated(t, n) {
                        t = t.toLowerCase(),
                            this.createListeners[t] = (this.createListeners[t] || []).concat(n)
                    }

                    onContainerDestroyed(t, n) {
                        t = t.toLowerCase(),
                            this.destroyListeners[t] = (this.destroyListeners[t] || []).concat(n)
                    }
            ...
            Yt = function () {
                ...
                if (K = r || Yt()) {
                    ...
                    for (i in tt("slow", Ae),
                        ...
                        tt("rough", ce),
                        Ne)
                        "version" !== i && K.core.globals(i, Ne[i])
                }
            }, Jt = function (r, t, n) {
                var i = (r = Math.min(1, r || .7)) < 1 ? t || 0 === t ? t : .7 : 0
                    , a = (1 - r) / 2
                    , s = a + r
                    , c = ft(n);
                return function (d) {
                ...
                for (var v, O, A, G, U, q, ge, t = r.taper || "none", n = [], i = 0, a = 0 | (+r.points || 20), s = a, c = ft(r.randomize, !0), d = ft(r.clamp), p = K ? K.parseEase(r.template) : 0, w = .4 * (+r.strength || 1); --s > -1;)
                    v = c ? Math.random() : 1 / a * s,
                        O = p ? p(v) : v,
                        A = "none" === t ? w : "out" === t ? (G = 1 - v) * G * w : "in" === t ? v * v * w : v < .5 ? (G = 2 * v) * G * .5 * w : (G = 2 * (1 - v)) * G * .5 * w,
                        c ? O += Math.random() * A - .5 * A : s % 2 ? O += .5 * A : O -= .5 * A,
                    d && (O > 1 ? O = 1 : O < 0 && (O = 0)),
                        n[i++] = {
                            x: v,
                            y: O
                        };
                for (n.sort(function (ie, N) {
                    return ie.x - N.x
                }),
                         q = new Ct(1, 1, null),
                         s = a; s--;)
                    q = new Ct((U = n[s]).x, U.y, q);
                return ge = new Ct(0, 0, q.t ? q : q.next),
                    function (ie) {
                        var N = ge;
                        if (ie > N.t) {
                            for (; N.next && ie >= N.t;)
        ...
        var le = g(88632)
            , te = g(6674);
        const co = ["progressBar"]
            , lo = function (o, r) {
            return {
                "progressBar__divider--text--gameModeCard": o,
                "progressBar__divider--text--overlay": r
            }
        };

        function go(o, r) {
            if (1 & o && (e.TgZ(0, "span", 3),
                e._uU(1),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.Udp("left", t.dividerPercentage + "%"),
                    e.Q6J("ngClass", e.WLB(4, lo, t.forGameModeCard, t.overlayDivderText)),
                    e.xp6(1),
                    e.hij(" ", t.dividerText, "\n")
            }
        }
        ...
        function po(o, r) {
            ...
            2 & o) {
                const t = e.oxw();
                e.Gre("progressBar__divider progressBar__divider--", t.dividerOpacity, ""),
                    e.Udp("left", t.dividerPercentage + "%")
            }
        }
        ...
        const uo = function (o, r) {
            return {
                "progressBar__bar--supressAnimation": o,
                "progressBar__bar--empty": r
            }
        };

        function _o(o, r) {
            if (1 & o && e._UZ(0, "div", 4, 5),
            2 & o) {
                const t = e.oxw();
                e.Gre("progressBar__bar progressBar__bar--", t.color, ""),
                    e.Udp("width", t.percentage, "%"),
                    e.Q6J("ngClass", e.WLB(7, uo, t.supressAnimation, 0 === t.percentage)),
                    e.uIk("aria-valuenow", t.percentage)
            }
        }
                ...
                class o {
                    constructor(t) {
                        this.elRef = t,
                            this.color = "gold",
                            this.showDivider = !1,
                            this.dividerOpacity = "low",
                            this.dividerPercentage = 50,
                            this.dividerText = "",
                            this.forGameModeCard = !1,
                            this.overlayDivderText = !1,
                            this.animateFirstValue = !1,
                            this.animateDuration = .3,
                            this.supressAnimation = !1
                    }
                    ...
                    ngAfterViewInit() {
                        this.animateFirstValue && "number" == typeof this.percentage && (k.p8.set(this.progressBarDom.nativeElement, {
                            width: "0%"
                        }),
                            k.p8.to(this.progressBarDom.nativeElement, {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.YNc(0, go, 2, 7, "span", 0),
                                e.YNc(1, po, 1, 5, "span", 1),
                                e.YNc(2, _o, 2, 10, "div", 2)),
                            2 & t && (e.Q6J("ngIf", n.showDivider || n.overlayDivderText),
                                e.xp6(1),
                                e.Q6J("ngIf", n.showDivider),
                                e.xp6(1),
                                e.Q6J("ngIf", null !== n.percentage))
                        },
        ...
        const ho = ["progressBar"]
            , mo = ["leftShield"];

        function fo(o, r) {
            if (1 & o && e._UZ(0, "img", 12),
            2 & o) {
                const t = e.oxw();
        ...
        function Co(o, r) {
            if (1 & o && (e.TgZ(0, "div", 13),
                e._uU(1),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.hij(" ", t.playerAccount.username, " ")
            }
        }

        function vo(o, r) {
            if (1 & o && e._UZ(0, "app-progress-bar", 22, 23),
            2 & o) {
                const t = e.oxw(2);
        ...
        function bo(o, r) {
            ...
            2 & o) {
                const t = e.oxw(2);
                e.xp6(4),
                    e.hij(" ", e.lcZ(5, 2, t.progressionAnimationData.nextRankName), " "),
                    e.xp6(3),
                    e.hij(" ", t.progressionAnimationData.nextRankInitials, " ")
            }
        }

        function wo(o, r) {
            if (1 & o && (e.TgZ(0, "div", 14),
                e.YNc(1, vo, 2, 6, "app-progress-bar", 15),
                e.TgZ(2, "div", 16, 17),
                e._UZ(4, "img", 18),
                e.TgZ(5, "div", 19),
                e._uU(6),
                ...
                e.qZA(),
                e.qZA(),
                e.YNc(10, bo, 8, 4, "div", 21),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("ngIf", !t.isMaxRank),
                    e.xp6(1),
                    e.ekj("progressBarArea__level--maxRank", t.isMaxRank),
                    e.xp6(2),
                    e.MGl("src", "/gu-assets/images/rank-progress/gu-progress-rank-cracks--", t.progressionAnimationData.shieldCrackCount, ".svg", e.LSH),
                    e.xp6(2),
                    e.hij(" ", e.lcZ(7, 9, t.progressionAnimationData.currentRankName), " "),
                    e.xp6(2),
                    e.ekj("progressBarArea__level__rankInitials--maxRank", t.isMaxRank),
                    e.xp6(1),
                    e.hij(" ", t.progressionAnimationData.currentRankInitials, " "),
                    e.xp6(1),
                    e.Q6J("ngIf", !t.isMaxRank)
            }
        }
        ...
        const nt = "139, 225, 224"
            ...
            strength: 6,
            points: 6,
            template: "power2.inOut",
            randomize: !1
        });
        let Mo = (() => {
                class o {
                    constructor(t, n, i, a, s, c, d, p) {
                        this.guUserService = t,
                            this.authService = n,
                            this.progressionService = i,
                            this.modalService = a,
                            ...
                            this.ranksListing = [],
                            this.unsubscribe = new y.xQ,
                            this.loading = !0,
                            d.viewPortUnits$.pipe((0,
                                u.R)(this.unsubscribe), (0,
                                b.b)(({vh: w}) => {
                                    this.vh = w
                                }
                            )).subscribe()
                    ...
                    getViewData() {
                        return (0,
                            D.aj)([this.fetchPlayer(), this.fetchAccount()])
                    }
                    ...
                    createAnimationTimeline() {
                        ...
                        t > 0 ? this.levelUp() : t < 0 && this.levelDown(),
                            this.progressionTL.to(this.progressionAnimationData, 1, {
                        ...
                        n !== this.progressionAnimationData.shieldCrackCount && this.progressionTL.fromTo(this.leftShield.nativeElement, {
                            ...
                            ease: bt,
                            clearProps: "x"
                        }).add(() => this.setShieldCracking(n), "-=0.3"),
                            this.progressionTL.play()
                    }

                    calcNewCracksCount(t) {
                        let n = 3;
                        return t.loss_points < 37 ? n = 0 : t.loss_points < 53 ? n = 1 : t.loss_points < 78 && (n = 2),
                            n
                    }
                    ...
                    setRankLevelLabels(t) {
                        const n = this.ranksListing[t.rank_level - 1]
                            , i = this.ranksListing[t.rank_level];
                        this.progressionAnimationData.currentRankName = n.level_name,
                            this.progressionAnimationData.currentRankInitials = this.isMaxRank ? Math.trunc(t.rating).toString() : n.level_short_name,
                        !this.isMaxRank && i && (this.progressionAnimationData.nextRankName = i.level_name,
                            this.progressionAnimationData.nextRankInitials = i.level_short_name)
                    }

                    setUiElementsToNextLevel() {
                        this.progressionAnimationData.progressSafetyLine = this.nextRankedProgression.safety_line,
                            this.setRankLevelLabels(this.nextRankedProgression),
                            this.setShieldCracking(this.calcNewCracksCount(this.nextRankedProgression))
                    }
                    ...
                    levelUp() {
                        ...
                        this.progressionTL.to(this.progressionAnimationData, {
                            ...
                            duration: .2,
                            boxShadow: `0 0 ${2 * this.vh}px ${.5 * this.vh}px rgba(${nt}, 0.4)`
                        }).fromTo(this.leftShield.nativeElement, {
                            x: "-4px",
                            y: "-50%"
                        }, {
                            duration: .5,
                    ...
                    levelDown() {
                        this.progressionTL.to(this.progressionAnimationData, {
                            ...
                            ease: bt,
                            clearProps: "x"
                        }).add(() => this.setUiElementsToNextLevel(), "-=0.25").set(this.progressionAnimationData, {
                            percentage: 100
                        })
                    }
                    ...
                    fetchAccount() {
                        return this.authService.account$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            P.h)(t => !!t), (0,
                            x.q)(1), (0,
                            b.b)(t => {
                                this.playerAccount = t,
                                    this.cdr.detectChanges()
                            }
                        ), (0,
                            pe.zg)(t => (this.previousRankedProgression = this.progressionService.getStoredRankedProgression(t.id, this.gameModeId),
                            (0,
                                D.aj)([this.progressionService.getRankedProgressionById(t.id, this.gameModeId), this.progressionService.gameRanks$]))), (0,
                            P.h)(([t, n]) => !!t && !!n), (0,
                            b.b)(([t, n]) => (this.nextRankedProgression = t,
                            this.ranksListing = n,
                            this.isMaxRank = this.progressionService.isMaxRank(t, n),
                            console.log("RankProgress->fetchAccount() finished: prev next", this.previousRankedProgression, this.nextRankedProgression),
                            {})))
                    }
                    ...
                    fetchPlayer() {
                        return this.guUserService.extendedAccountProperties$.pipe((0,
                            x.q)(1), (0,
                            b.b)(t => (this.playerProperties = t,
                            t)))
                    }
                }
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        viewQuery: function (t, n) {
                            ...
                            2 & t) {
                                ...
                                e.iGM(i = e.CRH()) && (n.leftShield = i.first)
                            }
                        },
                        inputs: {
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "img", 0),
                                ...
                                e._UZ(3, "img", 3),
                                e.qZA(),
                                e.TgZ(4, "gu-heading-text", 4),
                                e._uU(5, " Ranked mode progression\n"),
                                e.qZA(),
                                e.TgZ(6, "div", 5),
                                e.TgZ(7, "div", 6),
                                e.YNc(8, fo, 1, 1, "img", 7),
                                e.qZA(),
                                e.YNc(9, Co, 2, 1, "div", 8),
                                e.YNc(10, wo, 11, 11, "div", 9),
                                e.TgZ(11, "div", 10),
                                e.TgZ(12, "gu-primary-hex-button", 11),
                                ...
                                e.qZA()),
                            2 & t && (e.xp6(6),
                                e.Q6J("ngClass", e.VKq(4, xo, n.loading)),
                                e.xp6(2),
                                e.Q6J("ngIf", n.playerProperties),
                                e.xp6(1),
                                e.Q6J("ngIf", n.playerAccount),
                                e.xp6(1),
                                e.Q6J("ngIf", n.nextRankedProgression))
                        },
                ...
                class o {
                    constructor(t, n) {
                        this.gameApi = t,
                            ...
                            this._gauntletSlots$ = new J.X([]),
                            this._gauntletFlux$ = new J.X(0),
                            this._refreshDate$ = new J.X(null)
                    }
                    ...
                    fetchGauntletSlots() {
                        ...
                        this.gameApi.get(`/user/${t}/gauntlet`).pipe((0,
                            x.q)(1), (0,
                            M.U)(n => this.validateGauntletSlots(n))).subscribe(([n, i, a]) => {
                                this.dataStore.gauntletSlots = n,
                                    this._gauntletSlots$.next(Object.assign({}, this.dataStore).gauntletSlots),
                                    this.dataStore.gauntletFlux = i,
                                    this._gauntletFlux$.next(Object.assign({}, this.dataStore).gauntletFlux),
                                a && this.watchForReset(a)
                            }
                        )
                    }
                    ...
                    watchForReset(t) {
                        const n = Date.parse(t)
                            , i = new Date(n + this.msInDay + 5e3)
                            , a = i.getTime() - Date.now();
                        this.dataStore.refreshDate = i,
                            this._refreshDate$.next(Object.assign({}, this.dataStore).refreshDate),
                            (0,
                                Vt.H)(a).pipe((0,
                                u.R)(this.unsubscribe), (0,
                                x.q)(1)).subscribe(s => {
        ...
        function ko(o, r) {
            if (1 & o && e._UZ(0, "app-flux-gauntlet-circle", 1),
            2 & o) {
                const n = r.index;
        ...
        let Oo = (() => {
                class o {
                    constructor(t) {
                        this.gauntletService = t,
                            this.highlightedIndices = [0, 0, 0, 0, 0, 0],
                            this.unsubscribe = new y.xQ
                    }
                    ...
                    watchGauntlet() {
                        this.gauntletService.gauntletSlots$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            M.U)(t => t && 0 !== t.length ? t.map(n => n.wins) : [0, 0, 0, 0, 0, 0])).subscribe(t => this.highlightedIndices = t)
                    }
                }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && e.YNc(0, ko, 1, 2, "app-flux-gauntlet-circle", 0),
                            2 & t && e.Q6J("ngForOf", n.highlightedIndices)
                        },
                        directives: [l.sg, yo],
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.F$t(Po),
                                ...
                                e.qZA(),
                                e.TgZ(6, "div", 4),
                                e._UZ(7, "app-flux-gauntlet-detail"),
                                e.qZA())
                        },
                        directives: [Oo],
        ...
        const To = ["gauntletToasts"]
            , Ao = ["rewardsContainer"]
            , Io = ["rewardItems"]
            , Zo = ["continueButton"]
            , Fo = ["progressStepInfoText"]
            , Do = ["progressBar"]
            , Go = ["starsUpgradeVideo"]
            , Bo = ["starsOpenVideo"]
            , Lo = ["initialProgress"]
            , Uo = ["starsFinalNumbers"]
            , qo = ["starsFinalIcon"];

        function Eo(o, r) {
            if (1 & o && (e.TgZ(0, "div", 30),
                e.TgZ(1, "div", 31),
                e._UZ(2, "img", 32),
                e.qZA(),
                e.TgZ(3, "gu-heading-text", 33),
                e._uU(4),
                e.qZA(),
                e.qZA()),
            2 & o) {
        ...
        function No(o, r) {
            if (1 & o && (e.TgZ(0, "div", 34),
                e.TgZ(1, "div", 35),
                e._UZ(2, "gu-card-pack-picture", 36),
                e.qZA(),
                e.TgZ(3, "div", 37),
                e.TgZ(4, "gu-paragraph-text", 38),
                e._uU(5),
                e.qZA(),
                e.qZA(),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(2),
                    e.Q6J("god", t.packsReward.god)("rarity", t.packsReward.rarity),
                    e.xp6(3),
                    e.AsE(" ", t.packRewardsCount, " ", 1 == t.packRewardsCount ? "Pack" : "Packs", " ")
            }
        }
        ...
        function Qo(o, r) {
            if (1 & o && (e.TgZ(0, "div", 34),
                ...
                e._UZ(5, "video", 43, 44),
                e._UZ(7, "video", 45, 46),
                e._UZ(9, "gu-icon", 47, 48),
                e.TgZ(11, "gu-heading-text", 49, 50),
                e._uU(13),
                e.qZA(),
                e.qZA(),
                e.TgZ(14, "div", 37),
                e.TgZ(15, "gu-paragraph-text", 38),
                e._uU(16),
                e.qZA(),
                e.qZA(),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("ngClass", e.WLB(11, Ro, t.animationState.showVialOpenVideo, t.animationState.showVialUpgradeVideo)),
                    e.xp6(2),
                    ...
                    e.xp6(1),
                    e.MGl("src", "//images.godsunchained.com/star-vials/128/", t.animationState.currentStarVialId, ".png", e.LSH),
                    e.xp6(1),
                    e.Q6J("muted", !0),
                    e.xp6(2),
                    e.Q6J("muted", !0),
                    e.xp6(6),
                    e.hij(" +", t.starsRewardInfo.stars, " "),
                    e.xp6(3),
                    e.hij(" ", t.animationState.currentStarVial, " Vial ")
            }
        }
        ...
        function Ho(o, r) {
            ...
            2 & o) {
                const t = r.$implicit;
                e.xp6(5),
                    e.AsE(" ", t.display_value > 0 ? t.display_value + " " : "", "", t.display_name, " ")
            }
        }

        function Yo(o, r) {
            1 & o && (e.TgZ(0, "div", 52, 53),
                e.TgZ(2, "app-flux-progress-box"),
                e.ynx(3, 54),
                e._uU(4, "gauntlet of the gods"),
                e.BQk(),
                e.ynx(5, 55),
                e._uU(6, "gather flux"),
                e.BQk(),
        ...
        let Jo = (() => {
                class o {
                    constructor(t, n, i, a, s, c, d, p, w, v, O, A, G, U, q, ge) {
                        this.authService = t,
                            this.playService = n,
                            this.guGameService = i,
                            this.progressionService = a,
                            this.modalService = s,
                            this.guUserService = c,
                            this.changeDetector = d,
                            this.resizeService = p,
                            this.gauntletService = w,
                            ...
                            this.cdr = U,
                            this.fluxService = q,
                            this.sealedService = ge,
                            this.unsubscribe = new y.xQ,
                            this.xpData = {
                                latest_xp: [],
                                latest_total_xp: 0
                            },
                            this.showContinueButton = !1,
                            this.loading = !0,
                            this.specialRewards = [],
                            this.animationState = {
                                percentage: 0,
                            ...
                            this.GuGameModeId = S.B_,
                            this.resizeService.viewPortUnits$.pipe((0,
                                u.R)(this.unsubscribe), (0,
                                b.b)(({vh: ie}) => this.vh = ie)).subscribe()
                    }

                    ngAfterViewInit() {
                        this.packService.fetchUnopenedPacks(),
                            this.starsService.fetchUserStarsTotal(),
                            this.fluxService.fetchFluxInfo(),
                        this.gameModeId === S.B_.RANKED_CONSTRUCTED && this.gauntletService.fetchGauntletSlots(),
                        this.gameModeId === S.B_.SEALED_DECK && this.sealedService.fetchSealed(),
                            this.getViewData().subscribe(() => {
                    ...
                    getViewData() {
                        return (0,
                            D.aj)([this.authService.account$, this.guUserService.getExtendedAccountProperties(), this.progressionService.accountThresholds$, this.playService.currentMatchId$]).pipe((0,
                            P.h)(([t, n, i]) => !!t && !!n && i.length > 0), (0,
                            x.q)(1), (0,
                            M.U)(([t, n, i, a]) => (this.userId = n.user_id,
                            this.userName = t.username,
                            this.userAvatar = n.image_url,
                            this.nextProgress = new X.oW(n.total_xp, n.xp_to_next, n.level),
                            this.thresholds = i,
                            [this.userId, a])), (0,
                            me.w)(([t, n]) => (0,
                            D.aj)([this.progressionService.fetchUserGameProgression({
                            userId: t,
                            gameModeId: this.gameModeId
                        }), this.starsService.fetchUserStarsRewards(n)])), (0,
                            M.U)(([t, n]) => {
                                var i, a;
                                ...
                                return this.displayProgress = {
                                    ...
                                    this.levelUpCount = this.nextProgress.lvl - this.displayProgress.lvl,
                                    this.animationState.xp = this.displayProgress.xp,
                                    this.animationState.currentLevel = this.displayProgress.lvl,
                                    this.animationState.percentage = ot({
                                        xp: this.animationState.xp,
                                        levelThresholds: this.thresholds
                                    }),
                                    this.logGameCompleted(t.latest_game),
                                    this.xpData = {
                                        latest_total_xp: t.latest_total_xp,
                                        latest_xp: t.latest_xp
                                    },
                                    this.packsReward = this.packService.fixGodAlignments(this.filterService.sort(t.latest_reward, m.PE.DescRarity))[0],
                                    this.specialRewards = t.latest_special_reward || [],
                                    this.packRewardsCount = t.latest_reward.map(c => c.count).reduce((c, d) => c + d, 0),
                                    this.specialRewardsCount = this.specialRewards.length,
                                    this.hasEarnedRewards = this.packRewardsCount > 0 || this.specialRewardsCount > 0 || n.stars > 0,
                                    this.starsRewardInfo = n,
                                    this.animationState.currentStarVial = null === (i = null == n ? void 0 : n.clusters[0]) || void 0 === i ? void 0 : i.cluster_name,
                                    this.animationState.currentStarVialId = null === (a = null == n ? void 0 : n.clusters[0]) || void 0 === a ? void 0 : a.cluster_id,
                                    this.loading = !1,
                                    (0,
                                        z.of)({})
                            }
                        ), (0,
                            ro.K)(t => (console.error(t),
                            (0,
                                z.of)(!1))))
                    }
                    ...
                    createProgressionAnimationTimeline(t) {
                        return (0,
                            se.mG)(this, void 0, void 0, function* () {
                            this.progressionTL = k.p8.timeline({
                                paused: !0,
                                delay: .5
                            }),
                                t.forEach((n, i) => this.addXpStepToProgressBar(n, i)),
                                yield(0,
                                    mt.w)(0),
                                this.progressionTL.add(() => {
                                        var n;
                                        (null === (n = this.starsUpgradeVideo) || void 0 === n ? void 0 : n.nativeElement) && (this.starsUpgradeVideo.nativeElement.pause(),
                                            this.starsOpenVideo.nativeElement.pause())
                                    }
                                ),
                            this.hasEarnedRewards && this.animateInRewards(),
                            this.gauntletToasts && this.animateInGauntletToasts(),
                                this.animateInCtaButton(),
                                this.progressionTL.play()
                        })
                    }
                    ...
                    addXpStepToProgressBar(t, n) {
                        ...
                        this.hasLevelledUp(a) && (this.progressionTL.to(this.animationState, {
                            ...
                            this.levelUpOnce(),
                            this.animationState.currentLevel = a);
                        const s = ot({
                            xp: i,
                            levelThresholds: this.thresholds
                        });
                    ...
                    animateTextLabel(t, n) {
                        ...
                        this.progressionTL.add(() => {
                                this.animationState.progressStepText = t.display_name,
                                    this.animationState.progressStepValue = t.xp,
                                    this.changeDetector.detectChanges()
                            }
                            , `xpStep-${n}`).set(i, {
                            x: "-40%",
                    ...
                    levelUpOnce() {
                        const t = this.progressBar.progressBarDom.nativeElement;
                        this.progressionTL.set(t, {
                            boxShadow: `0 0 ${2 * this.vh}px ${.5 * this.vh}px rgba(${(0,
                                Ke.hexToCssRgbString)(et.colors.apocyan[300])}, 0.4)`
                        }).to(t, {
                            duration: .3,
                            boxShadow: `0 0 ${3.5 * this.vh}px ${4 * this.vh}px rgba(${(0,
                                Ke.hexToCssRgbString)(et.colors.apocyan[300])}, 0.7)`
                        }).to(t, {
                            duration: .2,
                            boxShadow: `0 0 ${5 * this.vh}px ${2 * this.vh}px rgba(${(0,
                                Ke.hexToCssRgbString)(et.colors.apocyan[300])}, 0)`
                        }).to(t, {
                            duration: .2,
                            boxShadow: `0 0 ${2 * this.vh}px ${.5 * this.vh}px rgba(${(0,
                                Ke.hexToCssRgbString)(et.colors.apocyan[300])}, 0.4)`
                    ...
                    animateInRewards() {
                        this.progressionTL.to(this.initialProgress.nativeElement, {
                            ...
                            Array.from(this.rewardItems.nativeElement.children).forEach((t, n) => {
                    ...
                    continue() {
                        ...
                        if (this.animationState.disableCta)
                            return !1;
                        (null === (n = null === (t = this.starsRewardInfo) || void 0 === t ? void 0 : t.clusters) || void 0 === n ? void 0 : n.length) >= 1 && (null === (a = null === (i = this.starsRewardInfo) || void 0 === i ? void 0 : i.clusters[0]) || void 0 === a ? void 0 : a.cluster_id) !== (null === (s = this.starsRewardInfo) || void 0 === s ? void 0 : s.max_clusters) && this.animationState.currentStarVial !== (null === (c = this.starsRewardInfo) || void 0 === c ? void 0 : c.clusters[(null === (p = null === (d = this.starsRewardInfo) || void 0 === d ? void 0 : d.clusters) || void 0 === p ? void 0 : p.length) - 1].cluster_name) ? (this.playStarUpgrades(),
                            this.animationState.disableCta = !0) : (null === (w = this.starsRewardInfo) || void 0 === w ? void 0 : w.stars) && this.animationState.currentTotalStars !== (null === (v = this.starsRewardInfo) || void 0 === v ? void 0 : v.stars) ? (this.playOpenStarVial(),
                            this.animationState.disableCta = !0) : (this.guUserService.fetchExtendedAccount(),
                            this.guGameService.getGameMode$(this.gameModeId).pipe((0,
                                x.q)(1)).subscribe(O => {
                                    this.close(),
                                        O && O.ranked ? this.modalService.createModal(Mo, {
                                            gameModeId: this.gameModeId
                                        }, {
                                            blurredBackground: !1,
                    ...
                    logGameCompleted(t) {
                        ...
                        "function" == typeof gtag && gtag("event", "completed", {
                            event_category: "game",
                            event_label: "user"
                        }),
                            this.guGameService.getGameMode$(this.gameModeId).pipe((0,
                    ...
                    playStarUpgrades() {
                        return (0,
                            se.mG)(this, void 0, void 0, function* () {
                            const t = this.starsUpgradeVideo.nativeElement
                                , n = a => {
                                this.animationState.currentStarVial = this.starsRewardInfo.clusters[this.starsRewardInfo.clusters.length - 1].cluster_name,
                                    this.animationState.currentStarVialId = this.starsRewardInfo.clusters[this.starsRewardInfo.clusters.length - 1].cluster_id,
                                    this.animationState.disableCta = !1,
                                    this.cdr.detectChanges(),
                                    tn(t, n)
                            }
                                , i = 1.7 * (this.starsRewardInfo.clusters[0].cluster_id - 1);
                            this.animationState.showVialUpgradeVideo = !0,
                                t.currentTime = i,
                                en(t, n),
                                t.muted = !1,
                                t.play(),
                                yield(0,
                                    mt.w)(1700 * (this.starsRewardInfo.clusters.length - 1) - 20),
                                t.pause(),
                                this.animationState.disableCta = !0
                        })
                    }
                    ...
                    playOpenStarVial() {
                        return (0,
                            ...
                            this.animationState.showVialUpgradeVideo = !1,
                                this.animationState.showVialOpenVideo = !0;
                            const n = a => {
                                    this.animationState.currentTotalStars = this.starsRewardInfo.stars,
                                        k.p8.to(this.starsFinalNumbers.nativeElement, {
                                            duration: .5,
                                            opacity: 1,
                                            y: 0
                                        }),
                            ...
                            ;
                            t.currentTime = 1.7 * (this.starsRewardInfo.clusters[this.starsRewardInfo.clusters.length - 1].cluster_id - 1),
                                en(t, n),
                                t.muted = !1,
                                t.play(),
                                yield(0,
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        viewQuery: function (t, n) {
                            ...
                            2 & t) {
                                let i;
                                e.iGM(i = e.CRH()) && (n.gauntletToasts = i.first),
                                ...
                                e.iGM(i = e.CRH()) && (n.starsFinalNumbers = i.first),
                                e.iGM(i = e.CRH()) && (n.starsFinalIcon = i.first)
                            }
                        },
                        inputs: {
                            gameModeId: "gameModeId"
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "picture", 0),
                                ...
                                e._UZ(5, "img", 5),
                                e.qZA(),
                                e.TgZ(6, "gu-heading-text", 6),
                                e._uU(7, " Match Complete\n"),
                                e.qZA(),
                                e.TgZ(8, "div", 7, 8),
                                e.YNc(10, Eo, 5, 2, "div", 9),
                                e.TgZ(11, "div", 10),
                                e.TgZ(12, "gu-simple-text", 11),
                                e._uU(13),
                                e.qZA(),
                                e.TgZ(14, "gu-simple-text", 12),
                                e._uU(15),
                                e.qZA(),
                                e._UZ(16, "app-progress-bar", 13, 14),
                                e.TgZ(18, "div", 15, 16),
                                e.TgZ(20, "gu-heading-text", 17),
                                e._uU(21),
                                e.qZA(),
                                e.TgZ(22, "gu-heading-text", 18),
                                e._uU(23),
                                e.qZA(),
                                e.qZA(),
                                e.qZA(),
                                ...
                                e.qZA(),
                                e.TgZ(25, "div", 20, 21),
                                e.TgZ(27, "gu-heading-text", 22),
                                e._uU(28),
                                e.qZA(),
                                e.TgZ(29, "div", 23, 24),
                                e.YNc(31, No, 6, 4, "div", 25),
                                e.YNc(32, Qo, 17, 14, "div", 25),
                                e.YNc(33, Ho, 6, 2, "div", 26),
                                e.qZA(),
                                e._UZ(34, "div", 19),
                                e.qZA(),
                                e.TgZ(35, "gu-primary-hex-button", 27, 28),
                                e.NdJ("click", function () {
                                    return n.continue()
                                }),
                                e.qZA(),
                                e.YNc(37, Yo, 7, 0, "div", 29)),
                            2 & t && (e.xp6(10),
                                e.Q6J("ngIf", !n.loading),
                                e.xp6(1),
                                e.ekj("progressBarArea--hidden", n.loading),
                                e.xp6(2),
                                e.hij(" Level ", null == n.displayProgress ? null : n.displayProgress.lvl, " "),
                                e.xp6(2),
                                e.hij(" Level ", (null == n.displayProgress ? null : n.displayProgress.lvl) + 1, " "),
                                e.xp6(1),
                                e.Q6J("animateFirstValue", !1)("percentage", n.animationState.percentage)("supressAnimation", !0),
                                e.xp6(5),
                                e.hij(" +", n.animationState.progressStepValue, " "),
                                e.xp6(2),
                                e.hij(" ", n.animationState.progressStepText, " "),
                                e.xp6(5),
                                e.hij(" ", n.packRewardsCount + n.specialRewardsCount > 1 ? "Rewards" : "Reward", " Earned "),
                                e.xp6(3),
                                e.Q6J("ngIf", n.packsReward),
                                e.xp6(1),
                                e.Q6J("ngIf", n.starsRewardInfo && 0 !== (null == n.starsRewardInfo ? null : n.starsRewardInfo.stars)),
                                e.xp6(1),
                                e.Q6J("ngForOf", n.specialRewards),
                                e.xp6(2),
                                e.Q6J("disabled", n.animationState.disableCta),
                                e.xp6(2),
                                e.Q6J("ngIf", n.gameModeId === n.GuGameModeId.RANKED_CONSTRUCTED))
                        },
                        ...
                        data: {
                            animation: [(0,
                                C.X$)("fadeAndSlideIn", [(0,
                                C.eR)(":enter", [(0,
                                C.oB)({
                                opacity: 0,
                                transform: "translateY(calc(var(--vh) * 3))"
                            }), (0,
                                C.jt)("250ms 250ms ease-in-out", (0,
                                C.oB)({
                                opacity: 1,
                                transform: "translateY(0)"
                            }))])]), (0,
                                C.X$)("fadeAndScaleIn", [(0,
                                C.eR)(":enter", [(0,
                                C.oB)({
                                opacity: 0,
                                transform: "scale(0.5)"
                            }), (0,
                                C.jt)("250ms ease-in-out", (0,
                                C.oB)({
                                opacity: 1,
                                transform: "scale(1)"
                            }))])])]
        ...
        function $o(o, r) {
            if (1 & o) {
                ...
                e.TgZ(0, "div", 11),
                    ...
                    e.qZA(),
                    e._UZ(3, "div", 13),
                    e.TgZ(4, "gu-heading-text", 14),
                    e._uU(5),
                    e.qZA(),
                    e.TgZ(6, "gu-simple-text", 15),
                    e._uU(7),
                    e.qZA(),
                    e.qZA()
            }
        ...
        let Wo = (() => {
                class o {
                    ...
                    ngOnInit() {
                        const t = this.authService.getUserId();
                        this.gameService.updateUserTutorialMissions(t, {
                            mission: 1,
                            completed: !0
                        }).subscribe(i => {
                            ...
                            this.gameService.refreshGameContext(),
                            this.akumaService.postScreenEvent("tutorial", "Complete", "", "opened"),
                            this.akumaService.postFlowEvent("tutorialComplete", "succeeded"),
                            this.akumaService.postFlowEvent("tutorialReward", "started")
                    }
                    ...
                    openPacks() {
                        this.akumaService.postControlEvent("tutorial", "Complete", "", "temple", "Btn", "pressed"),
                            this.activeModal.dismiss(),
                            this.akumaService.postFlowEvent("tutorialReward", "succeeded"),
                            this.router.navigate([Qe.gv.routeContent(this.environment).openPacks.path])
                    }

                    close() {
                        this.akumaService.postControlEvent("tutorial", "Complete", "", "close", "Btn", "pressed"),
                            this.activeModal.dismiss()
                    }

                    gotoTask(t) {
                        this.activeModal.dismiss(),
                            this.akumaService.postControlEvent("tutorial", "Complete", "", this.tasks[t].name, "Btn", "pressed"),
                            this.router.navigate([this.tasks[t].route])
                    }
                }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "gu-icon", 0),
                                e.NdJ("click", function () {
                                    return n.close()
                                }),
                                e.qZA(),
                                e.TgZ(1, "gu-heading-text", 1),
                                e._uU(2, " Congratulations, Mortal\n"),
                                e.qZA(),
                                e.TgZ(3, "gu-simple-text", 2),
                                e._uU(4, " You\u2019ve won your first match, but there is much more for you to master...\n"),
                                e.qZA(),
                                e.TgZ(5, "div", 3),
                                e.YNc(6, $o, 8, 3, "div", 4),
                                e.qZA(),
                                ...
                                e._UZ(12, "img", 8),
                                e.qZA(),
                                e.TgZ(13, "gu-simple-text", 9),
                                e._uU(14, " Head to the temple to open your "),
                                e.TgZ(15, "strong"),
                                e._uU(16, "3 Core Packs "),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(17, "gu-primary-hex-button", 10),
                                e.NdJ("click", function () {
                                    return n.openPacks()
                                }),
                                e.qZA(),
        ...
        class zo {
            constructor(r, t, n, i) {
                this.card = r,
                    this.gridRowIndex = t,
                    this.groupingIndex = n,
                    this.cardRowIndex = i
            }
        }

        var Q = (() => {
                return (o = Q || (Q = {}))[o.FORGING = 0] = "FORGING",
                    o[o.SIGNING = 1] = "SIGNING",
                    o[o.SELLING = 2] = "SELLING",
                    Q;
                var o
            }
        )();
                ...
                class o {
                    constructor() {
                        this.alive = !0,
                            ...
                            this._expandedCard$ = new J.X(null)
                    }
                    ...
                    emitExpandedCard(t) {
                        this.dataStore.expandedCard = t,
                            this._expandedCard$.next(Object.assign({}, this.dataStore).expandedCard)
                    }

                    expandCard(t, n, i, a) {
                        if (this.dataStore.expandedCard && this.dataStore.expandedCard.card.pc.proto === t.pc.proto)
                ...
                class o {
                    constructor(t, n, i, a, s, c, d, p, w, v, O) {
                        this.gameApi = t,
                            ...
                            this.cardsService = i,
                            this.decksService = a,
                            this.cardGridService = s,
                            this.audioService = c,
                            this.http = d,
                            this.forgeWalletService = p,
                            this.moduleConfigService = w,
                            this.storageService = v,
                            this.tokenRefreshService = O,
                            this.unsubscribe = new y.xQ,
                            this.alive = !0,
                            this.dataStore = {
                                forgeCards: null,
                            ...
                            this._forgeCards$ = new J.X(null),
                            this._previewCard$ = new J.X(null),
                            this._fusingLevels$ = new J.X(null),
                            this._transactionInProgress$ = new J.X(null),
                            this.moduleConfig$ = this.moduleConfigService.loadConfigurations(),
                            this.watchForLogout()
                    }

                    watchForLogout() {
                        this.authService.account$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            P.h)(t => null === t)).subscribe(t => {
                                this.emitForgeCards(null),
                                    this.emitPreviewCard(null)
                            }
                        )
                    }
                    ...
                    setTransactionInProgress(t) {
                        this.dataStore.transactionInProgress = t,
                            this._transactionInProgress$.next(Object.assign(this.dataStore, {}).transactionInProgress)
                    }

                    clearTransactionInProgress() {
                        this.dataStore.transactionInProgress = void 0,
                            this._transactionInProgress$.next(Object.assign(this.dataStore, {}).transactionInProgress)
                    }

                    emitForgeCards(t) {
                        this.dataStore.forgeCards = t,
                            this._forgeCards$.next(this.dataStore.forgeCards)
                    }

                    emitPreviewCard(t) {
                        this.dataStore.previewCard = t,
                            this._previewCard$.next(this.dataStore.previewCard)
                    }

                    fetchFusingLevels() {
                        this.gameApi.get("/fusing_levels").pipe((0,
                            x.q)(1), (0,
                            M.U)(t => {
                                const n = {};
                                for (const i in m.nJ)
                                    if ("number" == typeof m.nJ[i]) {
                                ...
                                this.fusingLevels = t,
                                    this.dataStore.fusingLevels = t,
                                    this._fusingLevels$.next(Object.assign(this.dataStore, {}).fusingLevels)
                            }
                        )
                    }
                    ...
                    updateKeptId(t, n, i) {
                        if (null === this.dataStore.forgeCards || this.dataStore.forgeCards.proto !== t || this.dataStore.forgeCards.quality !== n)
                            return !1;
                        const a = Object.assign(Object.assign({}, this.dataStore.forgeCards), {
                            keptId: i
                        });
                        this.audioService.forgeSelectCard.play(),
                            this.emitForgeCards(a)
                    }
                    ...
                    addToForge(t, n, i) {
                        return (0,
                            se.mG)(this, void 0, void 0, function* () {
                            if (!(yield this.canAddToForge(t, n, i)))
                                return !1;
                            const c = null === this.dataStore.forgeCards || this.dataStore.forgeCards.proto !== t || this.dataStore.forgeCards.quality !== n ? new Vo(t, n, [i], i) : Object.assign(Object.assign({}, this.dataStore.forgeCards), {
                                ids: [...this.dataStore.forgeCards.ids, i]
                            });
                            this.emitForgeCards(c),
                                this.updatePreviewCard();
                            const d = yield this.numberOfQualityToForge(n);
                            this.dataStore.forgeCards.ids.length >= d ? (this.audioService.forgeSelectCard.play(),
                                this.audioService.forgeHeatingUp.play()) : this.audioService.forgeSelectCard.play()
                        })
                    }

                    removeFromForge(t, n, i) {
                        if (null === this.dataStore.forgeCards)
                            return !1;
                        if (this.dataStore.forgeCards.ids.some(a => a === i)) {
                            const a = this.dataStore.forgeCards.ids.filter(d => d !== i)
                                ...
                                , c = Object.assign(Object.assign({}, this.dataStore.forgeCards), {
                                ids: a,
                                keptId: s
                            });
                            return this.emitForgeCards(0 === c.ids.length ? null : c),
                                this.updatePreviewCard(),
                                !0
                        }
                        return !1
                    ...
                    updatePreviewCard() {
                        return (0,
                            se.mG)(this, void 0, void 0, function* () {
                            if (!this.dataStore.forgeCards)
                                return void this.emitPreviewCard(null);
                    ...
                    numberOfQualityToForge(t) {
                        return (0,
                            se.mG)(this, void 0, void 0, function* () {
                            const n = yield this.fusingLevels$.pipe((0,
                                P.h)(i => null !== i), (0,
                                x.q)(1)).toPromise();
                            return n[t] ? n[t].amount : null
                        })
                    ...
                    callForge(t = !1) {
                        if (!this.dataStore.forgeCards || void 0 === this.dataStore.forgeCards.keptId || !this.dataStore.forgeCards.ids)
                            return (0,
                                nn._)("This is an error!");
                        const i = this.authService.getUserId()
                            , s = (this.authService.getGameSessionTicket(),
                            this.dataStore.forgeCards.ids);
                        return this.moduleConfig$.pipe((0,
                            me.w)(({fusingHost: c}) => this.forgeWalletService.selectedWallet$.pipe((0,
                            M.U)(d => ({
                            wallet: d,
                            fusingHost: c
                        })))), (0,
                    ...
                    postToForge(t) {
                        if (!this.dataStore.forgeCards || void 0 === this.dataStore.forgeCards.keptId || !this.dataStore.forgeCards.ids)
                            return (0,
                                nn._)("This is an error!");
                        const n = this.dataStore.forgeCards.keptId
                            , i = this.authService.getUserId()
                            , a = this.authService.getGameSessionTicket()
                            , s = this.dataStore.forgeCards.ids.filter(c => c !== n);
                        return this.forgeWalletService.loadSelectedWallet(),
                            this.forgeWalletService.selectedWallet$.pipe((0,
                                x.q)(1), (0,
                                me.w)(c => this.gameApi.post(`/user/${i}/${t}?session=${a}`, {
                                card: n,
                                ids: s,
                                address: c
                            })))
                    ...
                    finalizeForging() {
                        this.emitForgeCards(null),
                            this.emitPreviewCard(null),
                            this.cardGridService.resetCardGrid()
                    }

                    handleForgeSuccess() {
                        if (!this.dataStore.forgeCards)
                            return !1;
                        const t = this.dataStore.forgeCards.ids
                            , n = this.dataStore.forgeCards.proto
                            , i = this.dataStore.forgeCards.quality;
                        return this.cardsService.forgeUpdate(t, n, this.getNextQuality(i)),
                            this.decksService.forgeUpdate(t, n, this.getNextQuality(i)),
                            this.finalizeForging(),
                            (0,
                                z.of)(!0)
                    }
                    ...
                    postTxHashForTracking(t) {
                        return this.moduleConfig$.pipe((0,
                            me.w)(n => this.http.post(`${n.walletAPIHost}/tracking`, t)))
                    }
                }
                ...
                class o {
                    constructor(t, n, i) {
                        this.gameApi = t,
                            ...
                            this._allBoards$ = new J.X([]),
                            this._ownedBoards$ = new J.X([]),
                            this._allTrinkets$ = new J.X([]),
                            this._ownedTrinkets$ = new J.X([]),
                            this._loadouts$ = new J.X([]),
                            this._protoCollectables$ = new J.X([])
                    }
                    ...
                    fetchData() {
                        (0,
                            D.aj)([this.fetchProtoCollectables(), this.assetsService.getBoardsAndTrinkets(), this.fetchAllLoadouts()]).pipe((0,
                            x.q)(1)).subscribe(([t, n, i]) => {
                                this.emitProtoCollectables(t);
                                const a = n.filter(c => "board" === c.type).map(c => Object.assign(Object.assign(Object.assign({}, c), c.class_properties), {
                                    owned: !0
                                }));
                                this.emitOwnedBoards(a),
                                    this.emitAllBoards(this.buildOutAllBoards(t, a));
                                const s = n.filter(c => "trinket" === c.type).map(c => Object.assign(Object.assign(Object.assign({}, c), c.class_properties), {
                                    owned: !0
                                }));
                                this.emitOwnedTrinkets(s),
                                    this.emitAllTrinkets(this.buildOutAllTrinkets(t, s)),
                                i && this.emitLoadouts(this.buildOutLoadouts(i))
                            }
                        )
                    }
                    ...
                    buildOutAllBoards(t, n) {
                        ...
                        return t.filter(s => "board" === s.type).forEach(s => {
                                this.isCollectableOwned(s.type, s.proto) || i.push(Object.assign(Object.assign({}, s), {
                                    owned: !1
                                }))
                            }
                        ),
                    ...
                    emitProtoCollectables(t) {
                        this.dataStore.protoCollectables = t,
                            this._protoCollectables$.next([...this.dataStore.protoCollectables])
                    }

                    emitAllBoards(t) {
                        this.dataStore.allBoards = t,
                            this._allBoards$.next([...this.dataStore.allBoards])
                    }

                    emitOwnedBoards(t) {
                        this.dataStore.ownedBoards = t,
                            this._ownedBoards$.next([...this.dataStore.ownedBoards])
                    }

                    emitOwnedTrinkets(t) {
                        this.dataStore.ownedTrinkets = t,
                            this._ownedTrinkets$.next([...this.dataStore.ownedTrinkets])
                    }

                    emitAllTrinkets(t) {
                        this.dataStore.allTrinkets = t,
                            this._allTrinkets$.next([...this.dataStore.allTrinkets])
                    }

                    emitLoadouts(t) {
                        this.dataStore.loadouts = t,
                            this._loadouts$.next([...this.dataStore.loadouts])
                    }
                    ...
                    createNewLoadout(t) {
                        const n = this.authService.getUserId()
                            , i = this.authService.getGameSessionTicket();
                        return this.gameApi.post(`/user/${n}/collection?session=${i}`, t).pipe((0,
                            x.q)(1), (0,
                            b.b)(a => {
                    ...
                    updateLoadout(t) {
                        const n = this.authService.getUserId()
                            , i = this.authService.getGameSessionTicket();
                        return this.gameApi.put(`/user/${n}/collection/${t.collection_id}?session=${i}`, t).pipe((0,
                            x.q)(1), (0,
                            b.b)(a => {
                    ...
                    getThenUpdateLocalLoadouts(t, n) {
                        this.fetchLoadout(t).pipe((0,
                            x.q)(1)).subscribe(i => {
                                let a = [];
                                if (n)
                                    a = [...this.dataStore.loadouts, this.buildOutLoadout(i)];
                                else {
        ...
        var rn = g(96727)
            ...
            , Xo = g(4390)
            , F = (() => {
                return (o = F || (F = {})).deckBuilder = "deck-builder",
                    o.arena = "game-modes",
                    o.workshop = "my-decks",
                    o.trader = "trader",
                    o.trailer = "trailer",
                    o.openPacks = "temple",
                    o.collections = "inventory",
                    o.drafter = "drafter",
                    o.forge = "forge",
                    ...
                    o.streamer = "streamer",
                    o.spgp = "spgp",
                    o.starStore = "star-store",
                    o.playToEarn = "play-to-earn",
                    F;
                var o
            }
        )()
        ...
        let oi = (() => {
                class o {
                    constructor(t, n, i, a, s, c, d, p, w, v, O, A, G, U, q) {
                        this.router = t,
                            this.ngZone = n,
                            this.userService = i,
                            this.navigationStateService = a,
                            this.queueService = s,
                            this.modalService = c,
                            this.authService = d,
                            this.navigation = p,
                            this.cerberusModalService = w,
                            this.packService = v,
                            this.environment = O,
                            this.akumaService = A,
                            this.starService = G,
                            this.fluxService = U,
                            this.featureFlagsService = q,
                            this.unsubscribe = new y.xQ,
                    ...
                    initMenuItems() {
                        (0,
                            D.aj)([this.navigationStateService.navigationItems$, this.navigationStateService.userMenuItems$, this.featureFlagsService.getMany([_.vU.forgeEnabled, _.vU.playToEarnEnabled])]).pipe((0,
                            u.R)(this.unsubscribe), (0,
                            P.h)(([t, n, i]) => !!t && !!n)).subscribe(([t, n, i]) => {
                                this.enabledFeatures = i,
                                    this.navigationItems = t,
                                    this.userMenuItems = n
                            }
                        ),
                            this.navigationStateService.storeNavigationItems(Object.assign({}, Qe.gv.routeContent(this.environment))),
                            this.navigationStateService.storeUserMenuItems(Object.assign({}, Qe.gv.userMenuItemsContent(this.environment)))
                    }

                    initUnopenedPacks() {
                        this.packService.fetchUnopenedPacks(),
                            this.packService.unopenedPacks$.pipe((0,
                                u.R)(this.unsubscribe)).subscribe(t => this.navigationStateService.toggleNotifyOpenPacks(!!t.length))
                    }

                    initRouteChanges() {
                        this.navigation.currentRoute$.pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => {
                    ...
                    initUserProperties() {
                        this.userService.fetchExtendedAccount(),
                            this.fluxService.fetchFluxInfo(),
                            this.starService.fetchUserStarsTotal(),
                            (0,
                                D.aj)([this.userService.extendedAccountProperties$, this.fluxService.fluxInfo$, this.starService.userStarTotal$]).pipe((0,
                                u.R)(this.unsubscribe)).subscribe(([t, n, i]) => {
                                    this.accountProperties = t,
                                        this.userStarsTotal = i,
                                        this.userFluxTotal = null == n ? void 0 : n.flux_available
                                }
                            )
                    }
                    ...
                    onConnectWallet(t) {
                        (0,
                            Xo.rb)({
                            url: Qe.gv.userMenuItemsContent(this.environment).connectWallet.url
                        })
                    }

                    onLogout(t) {
                        this.modalService.destroyTopModal(),
                            this.queueService.stopAllQueues(),
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.F$t(),
                                e.TgZ(0, "gu-header-bar", 0, 1),
                                e.NdJ("onLogoClick", function (a) {
                                ...
                                e.ALo(2, "filterNavItemsByFeatureFlags"),
                                e.TgZ(3, "gu-header-user-area", 2),
                                e.NdJ("onLogout", function (a) {
                                    return n.onLogout(a)
                                ...
                                e.ALo(4, "filterNavItemsByFeatureFlags"),
                                e.ALo(5, "numberAbbreviation"),
                                e.ALo(6, "numberAbbreviation"),
                                e.qZA(),
                                e.qZA(),
                                e.Hsn(7)),
                            2 & t && (e.Q6J("router", n.router)("ngZone", n.ngZone)("navigationItems", e.xi3(2, 10, n.navigationItems, n.enabledFeatures)),
                                e.xp6(3),
                                e.Q6J("menuItems", e.xi3(4, 13, n.userMenuItems, n.enabledFeatures))("userProperties", n.accountProperties)("userStarsTotal", e.xi3(5, 16, n.userStarsTotal, 2))("userFluxTotal", e.xi3(6, 19, n.userFluxTotal, 2))("router", n.router)("ngZone", n.ngZone)("downloadLauncherUrl", n.launcherUrl))
                        },
                        pipes: [ye.h4, ye.XX],
        ...
        let ai = (() => {
                class o {
                    constructor(t, n, i) {
                        this.vc = t,
                            this.el = n,
                            this.componentService = i,
                            this.componentService.registerContainer(n.nativeElement.nodeName, this.vc, this.el)
                    }
                }
        ...
        function si(o, r) {
            1 & o && (e.TgZ(0, "cerberus-announce-banner-control", 3),
                e._UZ(1, "gu-outage-banner"),
                e.qZA()),
            2 & o && e.Q6J("closable", !1)
        }

        function ci(o, r) {
            1 & o && (e.TgZ(0, "cerberus-announce-banner-control", 4),
                e._UZ(1, "gu-ranked-weekend-cancelled-banner"),
                e.qZA())
        }

        function li(o, r) {
            1 & o && (e.TgZ(0, "cerberus-announce-banner-control", 4),
                e._UZ(1, "cerberus-controllable-banner"),
                e.qZA())
        }
        ...
        function di(o, r) {
            1 & o && (e.TgZ(0, "div", 8),
                e.TgZ(1, "div", 9),
                e.TgZ(2, "gu-paragraph-text", 10),
                e._uU(3, " PTR REALM - DOES NOT REPRESENT THE FINAL PRODUCT "),
                e.qZA(),
                e.qZA(),
                e.qZA())
        }
        ...
        function gi(o, r) {
            if (1 & o && (e.TgZ(0, "main"),
                e.YNc(1, di, 4, 0, "div", 5),
                e._UZ(2, "router-outlet", null, 6),
                e.GkF(4, 7),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("ngIf", "ptr" === t.branch)
            }
        }

        let pi = (() => {
                class o {
                    constructor(t, n, i, a, s, c, d, p, w, v, O, A, G, U, q, ge, ie, N, ag, sg, cg, lg) {
                        this.gameService = n,
                            this.authService = p,
                            this.assetsService = q,
                            this.ngRxStore = ge,
                            this.modalService = ie,
                            this.audioService = N,
                            this.vcr = ag,
                            this.playService = sg,
                            this.loggerService = cg,
                            this.cerberusModalService = lg,
                            this.inGame = !1,
                            this.branch = "beta",
                            this.Flags = _.vU,
                            this.unsubscribe = new y.xQ,
                            ...
                            this.checkClearLogs(),
                            this.watchForInGame(),
                            this.audioService.loginToLauncher.play(),
                            n.checkInstallationPath(1),
                            this.branch = n.getProperty(1, "branch"),
                            p.account$.pipe((0,
                                P.h)(Ue => !!Ue), (0,
                                u.R)(this.unsubscribe)).subscribe(Ue => {
                            ...
                            i.fetchInventory(),
                            i.fetchQualityCount(),
                            i.loadInventoryCards().pipe((0,
                                u.R)(this.unsubscribe)).subscribe(),
                            a.fetchStarterDecks(),
                            a.fetchDecks(),
                            U.fetchSealed(),
                            n.setGuGameContext(),
                            s.fetchExtendedAccount(),
                            p.fetchAccount(),
                            A.fetchFusingLevels(),
                            G.fetchData(),
                            n.fetchBranchesExtended(1),
                            w.fetchFluxInfo(),
                            v.fetchGauntletSlots(),
                            O.loadSelectedWallet(),
                            d.onContainerCreated("#comment", (Ue, dg) => this.modalService.setModalVCRs(Ue, this.vcr)),
                            d.onContainerDestroyed("#comment", (Ue, dg) => this.modalService.setModalVCRs(null, null))
                    }
                    ...
                    ngOnDestroy() {
                        clearInterval(this.newSoldCardsCheckTimer),
                            this.unsubscribe.next(),
                            this.unsubscribe.complete()
                    }
                    ...
                    watchForInGame() {
                        this.playService.playing$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            ht.x)()).subscribe(t => {
                                switch (t.status) {
                                    case j.OC.IN:
                                        this.inGame = !0,
                                        t.gameModeId === S.B_.TUTORIAL && (this.inTutorial = !0);
                                        break;
                                    case j.OC.PROGRESSION_ACCOUNT:
                                        t.gameModeId === S.B_.TUTORIAL && this.inTutorial ? (this.showTutorialEndModal(),
                                            this.inTutorial = !1) : this.modalService.createModal(Jo, {
                    ...
                    showTutorialEndModal() {
                        const t = this.authService.getUserId();
                        this.gameService.getUserTutorialMissions(t).pipe((0,
                            x.q)(1)).subscribe(n => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "cerberus-desktop-header-provider"),
                                e.YNc(1, si, 2, 1, "cerberus-announce-banner-control", 0),
                                e.YNc(2, ci, 2, 0, "cerberus-announce-banner-control", 1),
                                e.YNc(3, li, 2, 0, "cerberus-announce-banner-control", 1),
                                e.qZA(),
                                e.YNc(4, gi, 5, 1, "main", 2)),
                            2 & t && (e.xp6(1),
                                e.Q6J("featureFlagIf", n.Flags.outageBannerEnabled),
                                e.xp6(1),
                                e.Q6J("featureFlagIf", n.Flags.rankedWeekendCancelledBannerEnabled),
                                e.xp6(1),
                                e.Q6J("featureFlagIf", n.Flags.showControllableBanner),
                                e.xp6(1),
                                e.Q6J("ngIf", !n.inGame))
                        },
        ...
        function ui(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "gu-plain-square-button", 10),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().copyClick()
                    }),
        ...
        function _i(o, r) {
            1 & o && (e.TgZ(0, "gu-plain-square-button", 11),
                e._uU(1, " Copied! "),
                e.qZA())
        }
        ...
        let hi = (() => {
                class o {
                    ...
                    copyClick() {
                        this.copyService.copyText(this.deckCode),
                            this.copied = !0
                    }
                }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "gu-modal-background", 0),
                                e.TgZ(1, "gu-vertical-space", 1),
                                e.TgZ(2, "gu-paragraph-text", 2),
                                e._uU(3, " Copy your deck and share with your friends "),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(4, "gu-vertical-space", 3),
                                e.TgZ(5, "gu-paragraph-text", 4),
                                e._uU(6),
                                e.qZA(),
                                e.YNc(7, ui, 2, 0, "gu-plain-square-button", 5),
                                e.YNc(8, _i, 2, 0, "gu-plain-square-button", 6),
                                e.qZA(),
                                e.TgZ(9, "gu-vertical-space"),
                                e.TgZ(10, "gu-paragraph-text", 7),
                                e._uU(11, " Players who you send this to can use the "),
                                e.TgZ(12, "strong"),
                                e._uU(13, "IMPORT DECK"),
                                e.qZA(),
                                e._uU(14, " feature when they create a new deck. "),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(15, "gu-vertical-space", 8),
                                e.TgZ(16, "gu-primary-hex-button", 9),
                                e.NdJ("click", function () {
                                    return n.ctaClick()
                                }),
                                e._uU(17, " GO BACK "),
        ...
        let ke = (() => {
                class o {
                    ...
                    closeButtonClick() {
                        this.audioService.clickTinyV2.play(),
                            this.closeButtonClickFn()
                    }
                }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        inputs: {
                            closeButtonClickFn: "closeButtonClickFn"
                        },
        ...
        class Ce {
            constructor(r, t, n, i = [], a) {
                this.property = r,
                    this.groups = t,
                    this.includedInGroup = n,
                    this.excludedTypes = i,
                    this.noMatchingGroup = a
            }
        }

        var Z = (() => {
                return (o = Z || (Z = {}))[o.Packge = 0] = "Packge",
                    o[o.Mana = 1] = "Mana",
                    o[o.Keyword = 2] = "Keyword",
                    o[o.Health = 3] = "Health",
                    o[o.Attack = 4] = "Attack",
                    o[o.Tribe = 5] = "Tribe",
                    o[o.Card = 6] = "Card",
        ...
        let Y = (() => {
                class o {
                    ...
                    ngOnChanges(t) {
                        t.protoId && !t.protoId.firstChange && (this.protoSubscription.unsubscribe(),
                            this.getCardProtoData())
                    }
                    ...
                    getCardProtoData() {
                        this.protoSubscription = this.cardsService.getProtoCard(this.protoId).pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => {
                                this.cardProtoData = Object.assign(Object.assign({}, t), {
                                    id: this.protoId
                                })
                            }
                        )
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "composited-card", 0),
                                e.NdJ("mouseenter", function () {
                                    // noop thanks
                                }),
                                e.qZA()),
                            2 & t && e.Q6J("inputProtoData", n.cardProtoData)("quality", n.quality)("responsiveSrcsetSizes", n.responsiveSrcsetSizes)
                        },
        ...
        function fi(o, r) {
            ...
            if (2 & o) {
                const t = e.oxw().$implicit
                    , n = e.oxw(3);
                e.Q6J("ngClass", e.VKq(2, Mt, -1 !== n.selectedHeaders.indexOf(t.value.header))),
                    e.xp6(2),
                    e.Oqu(n.shortenHeaderText(t.value.header))
            }
        }

        function Ci(o, r) {
            if (1 & o && (e.TgZ(0, "app-tooltip", 5),
                e.YNc(1, fi, 3, 4, "button", 6),
                e.qZA()),
            2 & o) {
                const t = r.$implicit;
                e.MGl("title", "Filter by ", t.value.header, ""),
                    e.xp6(1),
                    e.Q6J("ngIf", t.value.header)
            }
        }

        function vi(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Ci, 2, 2, "app-tooltip", 2),
                e.ALo(2, "keyvalue"),
                e.BQk()),
            2 & o) {
                const t = e.oxw(2);
                e.xp6(1),
                    e.Q6J("ngForOf", e.xi3(2, 1, t.cardGrouping, t.subGroupingOrder))
            }
        }
        ...
        function bi(o, r) {
            ...
            if (2 & o) {
                const t = e.oxw().$implicit
                    , n = e.oxw(3);
                e.Q6J("ngClass", e.VKq(2, Mt, -1 !== n.selectedHeaders.indexOf(t))),
                    e.xp6(2),
                    e.Oqu(n.shortenHeaderText(t))
            }
        }

        function wi(o, r) {
            if (1 & o && (e.TgZ(0, "app-tooltip", 5),
                e.YNc(1, bi, 3, 4, "button", 6),
                e.qZA()),
            2 & o) {
                const t = r.$implicit;
                e.MGl("title", "Filter by ", t, ""),
                    e.xp6(1),
                    e.Q6J("ngIf", t)
            }
        }
        ...
        function xi(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, wi, 2, 2, "app-tooltip", 2),
                e.BQk()),
            2 & o) {
                const t = e.oxw(2);
                e.xp6(1),
                    e.Q6J("ngForOf", t.filterHeaders)
            }
        }
        ...
        function Mi(o, r) {
            if (1 & o && (e.ynx(0),
                ...
                e._uU(2, "Filter by:"),
                e.qZA(),
                e.YNc(3, vi, 3, 4, "ng-container", 0),
                e.YNc(4, xi, 2, 1, "ng-container", 0),
                e.BQk()),
            2 & o) {
                const t = e.oxw();
                e.xp6(3),
                    e.Q6J("ngIf", t.cardGrouping),
                    e.xp6(1),
                    e.Q6J("ngIf", t.filterHeaders)
            }
        }
        ...
        function ki(o, r) {
            ...
            if (2 & o) {
                const t = r.$implicit
                    , n = e.oxw();
                e.MGl("title", "Sort by ", t.name, ""),
                    e.xp6(1),
                    e.Q6J("ngClass", e.VKq(3, Mt, n.activeSortOption === t)),
                    e.xp6(1),
                    e.Q6J("iconLigature", t.ligature)
            }
        }
        ...
        function Oi(o, r) {
            if (1 & o) {
                ...
                e.TgZ(0, "form", 11),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().selectCheckbox()
                    }),
                    e._UZ(1, "input", 12),
                    e._UZ(2, "label", 13),
                    e.TgZ(3, "label", 14),
                    e._uU(4, "Items in escrow"),
                    e.qZA(),
                    e._UZ(5, "input", 15),
                    e._UZ(6, "label", 16),
                    e.TgZ(7, "label", 17),
        ...
        let yt = (() => {
                class o {
                    constructor(t, n) {
                        this.fb = t,
                            ...
                            this.sortOptions = [],
                            this.showFilters = !0,
                            this.unownedCheckboxVisible = !1,
                            this.noSortByLabel = !1,
                            this.showUnowned = !0,
                            this.selectedHeaders = [],
                            this.groupingHeaderChange = new e.vpe,
                            this.sortChange = new e.vpe,
                            this.unownedChange = new e.vpe,
                            this.searchChange = new e.vpe,
                            this.ownershipChange = new e.vpe,
                            this.activeSortOption = this.sortOptions[0],
                            this.activeSortAsc = !1,
                            this.marked = !1,
                            this.unsubscribe = new y.xQ,
                            this.subGroupingOrder = (i, a) => {
                    ...
                    ngOnChanges(t) {
                        t.unownedCheckboxVisible && !t.unownedCheckboxVisible.firstChange && this.ownershipForm.setValue({
                            ownership: "all"
                        })
                    }
                    ...
                    clickGroupingHeader(t) {
                        this.audio.clickTinyV1.play(),
                            -1 === this.selectedHeaders.indexOf(t) ? this.selectedHeaders.push(t) : this.selectedHeaders = this.selectedHeaders.filter(n => n !== t),
                            this.groupingHeaderChange.emit(this.selectedHeaders)
                    }

                    clickSortOption(t) {
                        this.audio.clickTinyV1.play(),
                            t === this.activeSortOption ? this.activeSortAsc = !this.activeSortAsc : (this.activeSortOption = t,
                                this.activeSortAsc = !0),
                            this.sortChange.emit(this.activeSortAsc ? this.activeSortOption.sortAsc : this.activeSortOption.sortDesc)
                    }
                ...
                return o.\u0275fac = function (t) {
                    return new (t || o)(e.Y36(I.qu), e.Y36(f.pk))
                }
                    ,
                    o.\u0275cmp = e.Xpm({
                        type: o,
                        ...
                        template: function (t, n) {
                            1 & t && (e.YNc(0, Mi, 5, 2, "ng-container", 0),
                                e.YNc(1, yi, 2, 0, "div", 1),
                                e.YNc(2, ki, 3, 5, "app-tooltip", 2),
                                e.YNc(3, Oi, 13, 1, "form", 3)),
                            2 & t && (e.Q6J("ngIf", n.showFilters),
                                e.xp6(1),
                                e.Q6J("ngIf", !n.noSortByLabel),
                                e.xp6(1),
                                e.Q6J("ngForOf", n.sortOptions),
                                e.xp6(1),
                                e.Q6J("ngIf", n.unownedCheckboxVisible))
                        },
                        directives: [l.O5, l.sg, Fe.K, l.mk, I._Y, I.JL, I.sg, I.Fj, I._, I.JJ, I.u],
                        pipes: [l.Nd],
            ...
            , Oe = (() => {
                class o {
                    constructor(t) {
                        this.cardsService = t,
                            this.gods = ["death", "deception", "light", "magic", "nature", "war", "neutral"],
                            this.sets = ["genesis", "core", "etherbots", "promo", "mythic", "welcome", "trial", "order"],
                            this.rarities = ["legendary", "epic", "rare", "common", "mythic"],
                            this.types = ["spell", "weapon", "creature"],
                            this.tribes = ["aether", "amazon", "anubian", "atlantean", "dragon", "nether", "olympian", "viking", "guild", "mystic", "structure", "wild"],
                            this.qualities = ["no quality", "diamond", "gold", "shadow", "meteorite", "plain"],
                            this.numbers = [0, 1, 2, 3, 4, 5, 6, 7, 8],
                            this.numberIncludedInGroup = n => n < 9,
                            this.stringIncludedInGroup = n => !!n,
                            this._initGroupingRules(),
                            this._initGroupings(),
                            this.cardsService.inventory$.pipe((0,
                                b.b)(n => this.inventoryCardsMap = n)).subscribe()
                    }
                    ...
                    _initGroupingRules() {
                        this.godGrouping = new Ce("god", this.gods, this.stringIncludedInGroup),
                            this.setGrouping = new Ce("set", this.sets, this.stringIncludedInGroup),
                            this.rarityGrouping = new Ce("rarity", this.rarities, this.stringIncludedInGroup),
                            this.typeGrouping = new Ce("type", this.types, this.stringIncludedInGroup),
                            this.tribeGrouping = new Ce("tribe", this.tribes, this.stringIncludedInGroup, ["weapon", "spell"], "none"),
                            this.manaGrouping = new Ce("mana", this.numbers, this.numberIncludedInGroup, [], "9+"),
                            this.healthGrouping = new Ce("health", this.numbers, this.numberIncludedInGroup, ["spell"], "9+"),
                            this.attackGrouping = new Ce("attack", this.numbers, this.numberIncludedInGroup, ["spell"], "9+"),
                            this.qualityGrouping = new Ce("quality", this.qualities, this.stringIncludedInGroup, [])
                    }
                    ...
                    addToCardGrouping(t, n, i, a) {
                        const s = i.protoCard;
                        if (n.rules.excludedTypes.includes(s.type))
                            return t;
                    ...
                    removeFromCardGrouping(t, n, i) {
                        ...
                        return n.rules.includedInGroup(s) ? t.get(s.toString()).cards = t.get(s.toString()).cards.filter(c => c.id !== i.id) : n.rules.noMatchingGroup && (t.get(n.rules.noMatchingGroup).cards = t.get(n.rules.noMatchingGroup).cards.filter(c => c.id !== i.id)),
                            t
                    }
                    ...
                    createCardGrouping(t) {
                        ...
                        for (let i of t.rules.groups)
                            n.set(i.toString(), new sn(i.toString(), t));
                        return t.rules.noMatchingGroup && n.set(t.rules.noMatchingGroup, new sn(t.rules.noMatchingGroup, t)),
                            n
                    }

                    groupProtos(t, n, i = null, a = !1, s) {
                        const c = this._createProtoGrouping(n)
                            , d = s || this.inventoryCardsMap;
                        for (let p of t) {
                            if (!a && !p.collectable || i && p.god !== i && "neutral" !== p.god || n.rules.excludedTypes.includes(p.type))
                                continue;
                            const w = p[n.rules.property]
                                , v = d[p.proto] || []
                            ...
                            if (n.rules.includedInGroup(w)) {
                                ...
                                n.rules.noMatchingGroup && c.get(n.rules.noMatchingGroup).cards.push({
                                    pc: p,
                                    qualityMap: O
                                })
                        }
                    ...
                    _createProtoGrouping(t) {
                        const n = new Map;
                        for (let i of t.rules.groups)
                            n.set(i.toString(), new cn(i.toString(), t));
                        return t.rules.noMatchingGroup && n.set(t.rules.noMatchingGroup, new cn(t.rules.noMatchingGroup, t)),
                            n
                    }
                    ...
                    _createQualityGrouping(t) {
                        ...
                        return t.rules.noMatchingGroup && n.set(t.rules.noMatchingGroup, new ln(t.rules.noMatchingGroup, t, 0)),
                            n
                    }
                    ...
                    newQualityMap() {
                        const t = new Map;
                        for (let n in m.nJ)
                            "number" == typeof m.nJ[n] && t.set(m.nJ[n], []);
                        return t
                    }
                    ...
                    groupQualities(t, n, i = null, a = !1, s) {
                        const c = this._createQualityGrouping(n)
                            , d = s || this.inventoryCardsMap;
                        for (let p of t) {
                            if (!a && !p.collectable || i && p.god !== i && "neutral" !== p.god || n.rules.excludedTypes.includes(p.type))
                                continue;
        ...
        function Si(o, r) {
            ...
            if (2 & o) {
                const t = r.$implicit
                    , n = e.oxw();
                e.xp6(1),
                    e.MGl("title", "Group by ", t.name, ""),
                    e.xp6(1),
                    e.Q6J("ngClass", e.VKq(3, Pi, n.isSelected(t))),
                    e.xp6(1),
                    e.Q6J("iconLigature", "filter_" + t.name.toLowerCase())
            }
        }
        ...
        let Ot = (() => {
                class o {
                    constructor(t) {
                        this.audioService = t,
                            this.displayGroupingName = !0,
                            this.displaySearch = !0,
                            this.groupingChange = new e.vpe,
                            this.searchChange = new e.vpe,
                            this.searchControl = new I.NI(""),
                            this.unsubscribe = new y.xQ
                    }
                    ...
                    watchSearch() {
                        this.searchControl.valueChanges.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            kt.b)(500), (0,
                            ht.x)(), (0,
                            b.b)(t => this.searchChanged(t))).subscribe()
                    }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.YNc(0, Si, 4, 5, "ng-container", 0),
                                e.YNc(1, Ti, 1, 1, "input", 1)),
                            2 & t && (e.Q6J("ngForOf", n.groupings),
                                e.xp6(1),
                                e.Q6J("ngIf", n.displaySearch))
                        },
                        directives: [l.sg, l.O5, Fe.K, l.mk, I.Fj, I.JJ, I.oH],
        ...
        let dn = (() => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && e.YNc(0, Ai, 1, 1, "img", 0),
                            2 & t && e.Q6J("ngIf", n.god)
                        },
                        directives: [l.O5],
                ...
                class o {
                    constructor(t, n, i, a) {
                        this.resizeService = t,
                            ...
                            this.renderer = a,
                            this.columns = 4,
                            this.columnGapVwMultiplyer = 1.2,
                            this.rowGapVhMultiplyer = .5,
                            this.vw = 0,
                            this.vh = 0,
                            this.unsubscribe = new y.xQ,
                            t.viewPortUnits$.pipe((0,
                                u.R)(this.unsubscribe), (0,
                                b.b)(({vw: s, vh: c}) => {
                                    this.vw = s,
                                        this.vh = c
            ...
            , Pt = (() => {
                class o {
                    constructor(t, n) {
                        this.el = t,
                            this.renderer = n,
                            this.leftSideOrigin = "20% 50%",
                            this.middleOrigin = "50% 50%",
                            this.rightSideOrigin = "80% 50%",
                            this.transformOrigin = this.middleOrigin
                    }
                    ...
                    initPosition() {
                        if (void 0 === this.cardIndex || void 0 === this.columnsCount)
                            return;
                    ...
                    showCard() {
                        if (!this.cloneImage) {
                            ...
                            this.cloneImage.inputProtoData = t.inputProtoData,
                                this.cloneImage.quality = t.quality
                        }
                        this.renderer.appendChild(this.el.nativeElement, this.cloneImage),
                            k.p8.set(this.cloneImage, {
                                position: "absolute",
                                top: 0,
                                left: 0,
                            ...
                            k.p8.set(this.el.nativeElement, {
                                zIndex: 1
                            }),
        ...
        function Fi(o, r) {
            ...
            2 & o) {
                const t = e.oxw(2).$implicit
                    , n = e.oxw(3);
                e.xp6(3),
                    e.Oqu(n.calculateDisplayedCount(t.value))
            }
        }
        ...
        function Di(o, r) {
            ...
            if (2 & o) {
                const t = e.oxw().$implicit
                    , n = e.oxw(2).$implicit
                    , i = e.oxw();
                e.ekj("cardItemWrapper--dimmed", 0 === i.calculateDisplayedCount(t.value)),
                    e.xp6(1),
                    e.Q6J("protoId", n.pc.proto)("quality", t.key)("inputCw", 0)("inputCh", 0),
                    e.xp6(1),
                    e.Q6J("ngIf", i.showCardCounts)
            }
        }

        function Gi(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Di, 3, 7, "div", 6),
                e.BQk()),
            2 & o) {
                const t = r.$implicit
                    , n = e.oxw(3);
                e.xp6(1),
                    e.Q6J("ngIf", t.value.length > 0 && n.calculateDisplayedCount(t.value) > 0)
            }
        }

        function Bi(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Gi, 2, 1, "ng-container", 4),
                e.ALo(2, "keyvalue"),
                e.BQk()),
            2 & o) {
                const t = e.oxw().$implicit;
                e.xp6(1),
                    e.Q6J("ngForOf", e.lcZ(2, 1, t.qualityMap))
            }
        }

        function Li(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Bi, 3, 3, "ng-container", 5),
                e.BQk()),
            2 & o) {
                const t = r.$implicit;
                e.xp6(1),
                    e.Q6J("ngIf", t.qualityMap)
            }
        }

        function Ui(o, r) {
            if (1 & o && (e.TgZ(0, "div", 14),
                e._UZ(1, "app-card2", 15),
                e.qZA()),
            2 & o) {
                const t = e.oxw().$implicit;
                e.xp6(1),
                    e.Q6J("protoId", t.pc.proto)("quality", 5)("inputCw", 0)("inputCh", 0)
            }
        }

        function qi(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Ui, 2, 4, "div", 13),
                e.BQk()),
            2 & o) {
                const t = r.$implicit
                    , n = e.oxw();
                e.xp6(1),
                    e.Q6J("ngIf", !t.qualityMap && n.showUnowned)
            }
        }
        ...
        let Ei = (() => {
                class o {
                    constructor() {
                        this.columns = 8,
                            this.showOnlyEscrow = !1,
                            this.showUnowned = !1,
                            this.filterCardIds = [],
                            this.showCardCounts = !0,
                            this.selectCardId = new e.vpe
                    }
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "header", 0),
                                ...
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(7, "app-grid-display", 3),
                                e.YNc(8, Li, 2, 1, "ng-container", 4),
                                e.YNc(9, qi, 2, 1, "ng-container", 4),
                                e.qZA()),
                            2 & t && (e.xp6(2),
                                e.AsE(" ", e.lcZ(3, 8, n.grouping.currentGrouping.name), ": ", e.lcZ(4, 10, n.grouping.header), " "),
                                e.xp6(4),
                                e.AsE(" ", n.calculateOwnedCards(n.grouping.cards), " / ", n.grouping.cards.length, " "),
                                e.xp6(1),
                                e.Q6J("columns", n.columns)("columnGapVwMultiplyer", .8),
                                e.xp6(1),
                                e.Q6J("ngForOf", n.grouping.cards),
                                e.xp6(1),
                                e.Q6J("ngForOf", n.grouping.cards))
                        },
        ...
        function Ni(o, r) {
            1 & o && (e.TgZ(0, "div", 13),
                e.TgZ(1, "div", 14),
                e.TgZ(2, "gu-vertical-space", 15),
                e.TgZ(3, "gu-paragraph-text", 16),
                e._uU(4, " NOT FUSABLE "),
                e.qZA(),
                e._UZ(5, "gu-icon", 17),
                e.qZA(),
        ...
        function Hi(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "div", 10),
                    e.YNc(1, Ni, 6, 0, "div", 11),
                    e.TgZ(2, "app-card2", 12),
                    e.NdJ("click", function () {
                        const a = e.CHM(t).$implicit
                            , s = e.oxw(2).$implicit
                            , c = e.oxw();
            ...
            if (2 & o) {
                const t = r.$implicit
                    , n = e.oxw(2).$implicit
                    , i = e.oxw();
                e.Q6J("ngClass", e.VKq(5, Ri, "escrow" === t.status)),
                    e.xp6(1),
                    e.Q6J("ngIf", "escrow" === t.status),
                    e.xp6(1),
                    e.Q6J("protoId", i.card.pc.proto)("quality", n.key)("ngClass", e.WLB(7, Qi, i.isCardInForge(t.id), !i.isCardSelectable(n.key, t.id)))
            }
        }

        function Yi(o, r) {
            1 & o && (e.TgZ(0, "p", 18),
                e._uU(1, " You cannot forge Diamond cards. "),
                e.qZA())
        }
        ...
        function Ji(o, r) {
            ...
            2 & o) {
                const t = e.oxw(3).$implicit
                    , n = e.oxw();
                e.xp6(1),
                    e.AsE(" You need ", n.forgeService.fusingLevels[t.key].amount - t.value.length, " more ", e.lcZ(2, 2, n.forgeService.fusingLevels[t.key].name), " cards to forge ")
            }
        }

        function $i(o, r) {
            if (1 & o && e.YNc(0, Ji, 3, 4, "p", 19),
            2 & o) {
                const t = e.oxw(2).$implicit
                    , n = e.oxw();
        ...
        function Wi(o, r) {
            if (1 & o && (e.ynx(0),
                ...
                e.qZA(),
                e.TgZ(7, "div", 6),
                e.YNc(8, Hi, 3, 10, "div", 7),
                e.qZA(),
                e.YNc(9, Yi, 2, 0, "p", 8),
                e.YNc(10, $i, 1, 1, "ng-template", null, 9, e.W1O),
                e.BQk()),
            2 & o) {
                const t = e.MAs(11)
                    , n = e.oxw().$implicit
                    , i = e.oxw();
                e.xp6(3),
                    e.hij(" ", e.lcZ(4, 5, i.forgeService.fusingLevels[n.key].name), " "),
                    e.xp6(3),
                    e.hij(" ", n.value.length, " "),
                    e.xp6(2),
                    e.Q6J("ngForOf", n.value),
                    e.xp6(1),
                    e.Q6J("ngIf", 1 === n.key)("ngIfElse", t)
            }
        }

        function zi(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Wi, 12, 7, "ng-container", 2),
                e.BQk()),
            2 & o) {
                const t = r.$implicit;
                e.xp6(1),
                    e.Q6J("ngIf", t.value.length > 0)
            }
        }
        ...
        let gn = (() => {
                class o {
                    ...
                    initForgeCards() {
                        this.forgeService.forgeCards$.pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => this.forgeCards = t)
                    }
                    ...
                    isCardSelectable(t, n) {
                        return (0,
                            se.mG)(this, void 0, void 0, function* () {
                            return t !== m.nJ.DIAMOND && (!this.forgeCards || this.forgeCards.quality === t && (this.isCardInForge(n),
                                !0))
                        })
                    }
                }
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "h1", 0),
                                ...
                                e.ALo(2, "titlecase"),
                                e.qZA(),
                                e.YNc(3, zi, 2, 1, "ng-container", 1),
                                e.ALo(4, "keyvalue")),
                            2 & t && (e.xp6(1),
                                e.Oqu(e.lcZ(2, 2, n.card.pc.name)),
                                e.xp6(2),
                                e.Q6J("ngForOf", e.lcZ(4, 4, null == n.card ? null : n.card.qualityMap)))
                        },
        ...
        const Vi = function (o) {
            return {
                "gridRow__cardItemWrapper--dimmed": o
            }
        };
        ...
        function Xi(o, r) {
            if (1 & o && e._UZ(0, "cerberus-app-expanded-cards", 9),
            2 & o) {
                const t = e.oxw(4);
        ...
        function Ki(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Xi, 1, 2, "cerberus-app-expanded-cards", 8),
                e.BQk()),
            2 & o) {
                const t = e.oxw().index
                    , n = e.oxw(2);
                e.xp6(1),
                    e.Q6J("ngIf", n.expandedCard && n.expandedCard.groupingIndex === n.groupingIndex && n.expandedCard.gridRowIndex === t)
            }
        }

        function er(o, r) {
            if (1 & o && e._UZ(0, "app-expanded-cards-signing", 9),
            2 & o) {
                const t = e.oxw(4);
                e.Q6J("card", t.expandedCard.card)("cardRowIndex", t.expandedCard.cardRowIndex)
            }
        ...
        function tr(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, er, 1, 2, "app-expanded-cards-signing", 8),
                e.BQk()),
            2 & o) {
                const t = e.oxw().index
                    , n = e.oxw(2);
        ...
        function nr(o, r) {
            if (1 & o && e._UZ(0, "app-expanded-cards-selling", 9),
            2 & o) {
                const t = e.oxw(4);
                e.Q6J("card", t.expandedCard.card)("cardRowIndex", t.expandedCard.cardRowIndex)
            }
        ...
        function or(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, nr, 1, 2, "app-expanded-cards-selling", 8),
                e.BQk()),
            2 & o) {
                const t = e.oxw().index
                    , n = e.oxw(2);
        ...
        function ir(o, r) {
            if (1 & o && (e.TgZ(0, "app-grid-display", 5),
                e.YNc(1, ji, 1, 7, "app-card2", 6),
                e.YNc(2, Ki, 2, 1, "ng-container", 0),
                e.YNc(3, tr, 2, 1, "ng-container", 0),
                e.YNc(4, or, 2, 1, "ng-container", 0),
                e.qZA()),
            2 & o) {
                const t = r.$implicit
                    , n = e.oxw(2);
                e.Q6J("columns", n.columns)("columnGapVwMultiplyer", .8),
                    ...
                    e.Q6J("ngForOf", t),
                    e.xp6(1),
                    e.Q6J("ngIf", n.expandedViewMode === n.ExpandedViewMode.FORGING),
                    e.xp6(1),
                    e.Q6J("ngIf", n.expandedViewMode === n.ExpandedViewMode.SIGNING),
                    e.xp6(1),
                    e.Q6J("ngIf", n.expandedViewMode === n.ExpandedViewMode.SELLING)
            }
        }
        ...
        function rr(o, r) {
            if (1 & o && (e.ynx(0),
                ...
                e.qZA(),
                e.qZA(),
                e.YNc(8, ir, 5, 6, "app-grid-display", 4),
                e.BQk()),
            2 & o) {
                const t = e.oxw();
                e.xp6(3),
                    e.AsE(" ", e.lcZ(4, 4, t.grouping.currentGrouping.name), ": ", e.lcZ(5, 6, t.grouping.header), " "),
                    e.xp6(4),
                    e.hij(" ", t.numCards, " "),
                    e.xp6(1),
                    e.Q6J("ngForOf", t.chunkedCards)
            }
        }
        ...
        let ar = (() => {
                class o {
                    constructor(t, n, i) {
                        this.forgeService = t,
                            ...
                            this.showCardCounts = !0,
                            this.showBundle = !1,
                            this.selectCard = new e.vpe,
                            this.ExpandedViewMode = Q,
                            this.numCards = 0,
                            this.chunkedCards = [],
                            this.alive = !0
                    }
                    ...
                    onSelectCard(t, n, i) {
                        t && (this.cardGridService.expandCard(t, n, this.groupingIndex, i),
                            this.selectCard.emit(t))
                    }

                    initChunk() {
                        this.forgeService.fusingLevels$.pipe((0,
                            P.h)(t => null !== t), (0,
                            x.q)(1)).subscribe(t => {
                                const n = this.grouping.cards.filter(i => this.doShowCard(i.pc, i.qualityMap, t));
                                this.numCards = n.length,
                                    this.chunkedCards = this.utils.chunk(n, this.columns)
                            }
                        )
                    }

                    initExpandedCard() {
                        this.cardGridService.expandedCard$.pipe((0,
                            St.o)(t => this.alive), (0,
                            b.b)(t => this.expandedCard = t)).subscribe()
                    }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && e.YNc(0, rr, 9, 8, "ng-container", 0),
                            2 & t && e.Q6J("ngIf", n.numCards > 0)
                        },
        ...
        function sr(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-inventory-cards-quality", 6),
                    e.NdJ("selectCardId", function (i) {
                        return e.CHM(t),
                            e.oxw(3).onSelectCardId(i)
                    }),
                    e.qZA()
            }
            if (2 & o) {
                const t = e.oxw(2).$implicit
                    , n = e.oxw();
                e.ekj("cardsListingArea__cardsListing--4Column", 4 === n.columns),
                    e.Q6J("columns", n.columns)("grouping", t)("showCardCounts", n.showCardCounts)("showOnlyEscrow", n.showOnlyEscrow)("showUnowned", n.showUnowned)("filterCardIds", n.filterCardIds)("expandedViewMode", n.expandedViewMode)
            }
        }
        ...
        function cr(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-inventory-cards-proto", 7),
                    e.NdJ("selectCard", function (i) {
                        return e.CHM(t),
                            e.oxw(3).onSelectCard(i)
                    }),
                    e.qZA()
            }
            if (2 & o) {
        ...
        function lr(o, r) {
            if (1 & o && (e.ynx(0),
                e.ynx(1, 3),
                e.YNc(2, sr, 1, 9, "app-inventory-cards-quality", 4),
                e.YNc(3, cr, 1, 9, "app-inventory-cards-proto", 5),
                e.BQk(),
                e.BQk()),
            2 & o) {
                const t = e.oxw(2);
                e.xp6(1),
                    e.Q6J("ngSwitch", t.mode),
                    e.xp6(1),
                    e.Q6J("ngSwitchCase", "quality"),
                    e.xp6(1),
                    e.Q6J("ngSwitchCase", "proto")
            }
        }

        function dr(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, lr, 4, 3, "ng-container", 2),
                e.BQk()),
            2 & o) {
                const t = r.$implicit;
                e.xp6(1),
                    e.Q6J("ngIf", t.cards.length > 0)
            }
        }
        ...
        function gr(o, r) {
            1 & o && (e.TgZ(0, "div", 8),
                e.TgZ(1, "h4", 9),
                e._uU(2, " No cards match your filters "),
                e.qZA(),
                e.qZA())
        }
        ...
        let Tt = (() => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.YNc(0, dr, 2, 1, "ng-container", 0),
                                e.YNc(1, gr, 3, 0, "div", 1)),
                            2 & t && (e.Q6J("ngForOf", n.displayedGroupedProtos),
                                e.xp6(1),
                                e.Q6J("ngIf", !n.displayedGroupedProtos || 0 === n.displayedGroupedProtos.length))
                        },
                        directives: [l.sg, l.O5, l.RF, l.n9, Ei, ar],
        ...
        function pr(o, r) {
            ...
            2 & o) {
                const t = e.oxw(3).$implicit
                    , n = e.oxw(2);
                e.xp6(2),
                    e.Oqu(n.calculateDisplayedCount(t.ics))
            }
        }

        function ur(o, r) {
            if (1 & o && (e.TgZ(0, "span", 13),
                e._uU(1),
                e.qZA()),
            2 & o) {
                const t = e.oxw(3).$implicit;
        ...
        function _r(o, r) {
            if (1 & o && (e.TgZ(0, "div", 9),
                e._UZ(1, "gu-icon", 10),
                e.YNc(2, pr, 3, 1, "ng-container", 11),
                e.YNc(3, ur, 2, 1, "ng-template", null, 12, e.W1O),
                e.qZA()),
            2 & o) {
                const t = e.MAs(4)
                    , n = e.oxw(4);
                e.xp6(2),
                    e.Q6J("ngIf", n.filterCardIds.length > 0)("ngIfElse", t)
            }
        }
        ...
        function hr(o, r) {
            ...
            if (2 & o) {
                const t = e.oxw().$implicit
                    , n = e.oxw(2);
                e.xp6(1),
                    e.ekj("cardItemWrapper--dimmed", 0 === n.calculateDisplayedCount(t.ics)),
                    e.xp6(1),
                    e.Q6J("protoId", t.pc.proto)("quality", t.ics[0].q)("inputCw", 0)("inputCh", 0),
                    e.xp6(1),
                    e.Q6J("ngIf", n.showCardCounts)
            }
        }

        function mr(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, hr, 4, 7, "ng-container", 0),
                e.BQk()),
            2 & o) {
                const t = r.$implicit;
                e.xp6(1),
                    e.Q6J("ngIf", t.ics && t.ics.length)
            }
        }
        ...
        function fr(o, r) {
            if (1 & o && (e.ynx(0),
                ...
                e.qZA(),
                e.qZA(),
                e.TgZ(8, "app-grid-display", 4),
                e.YNc(9, mr, 2, 1, "ng-container", 5),
                e.qZA(),
                e.BQk()),
            2 & o) {
                const t = e.oxw();
                e.xp6(3),
                    e.AsE(" ", e.lcZ(4, 6, t.grouping.currentGrouping.name), ": ", e.lcZ(5, 8, t.grouping.header), " "),
                    e.xp6(4),
                    e.hij(" ", t.grouping.cards.length, " "),
                    e.xp6(1),
                    e.Q6J("columns", t.columns)("columnGapVwMultiplyer", .8),
                    e.xp6(1),
                    e.Q6J("ngForOf", t.grouping.cards)
            }
        }
        ...
        let Cr = (() => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && e.YNc(0, fr, 10, 10, "ng-container", 0),
                            2 & t && e.Q6J("ngIf", n.grouping.cards.length > 0)
                        },
        ...
        function br(o, r) {
            ...
            if (2 & o) {
                const t = e.oxw().$implicit
                    , n = e.oxw(3);
                e.xp6(1),
                    e.Q6J("ngClass", e.VKq(5, vr, n.expandedCard && t.pc.proto !== n.expandedCard.card.pc.proto))("protoId", t.pc.proto)("quality", t.ics[0].q)("inputCw", 0)("inputCh", 0)
            }
        }

        function wr(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, br, 2, 7, "ng-container", 0),
                e.BQk()),
            2 & o) {
                const t = r.$implicit;
                e.xp6(1),
        ...
        function Mr(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, xr, 1, 2, "cerberus-app-expanded-cards", 8),
                e.BQk()),
            2 & o) {
                const t = e.oxw().index
                    , n = e.oxw(2);
        ...
        function kr(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, yr, 1, 2, "app-expanded-cards-signing", 8),
                e.BQk()),
            2 & o) {
                const t = e.oxw().index
                    , n = e.oxw(2);
        ...
        function Pr(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Or, 1, 2, "app-expanded-cards-selling", 8),
                e.BQk()),
            2 & o) {
                const t = e.oxw().index
                    , n = e.oxw(2);
        ...
        function Sr(o, r) {
            if (1 & o && (e.TgZ(0, "app-grid-display", 5),
                e.YNc(1, wr, 2, 1, "ng-container", 6),
                e.YNc(2, Mr, 2, 1, "ng-container", 0),
                e.YNc(3, kr, 2, 1, "ng-container", 0),
                e.YNc(4, Pr, 2, 1, "ng-container", 0),
                e.qZA()),
            2 & o) {
                const t = r.$implicit
                    , n = e.oxw(2);
        ...
        function Tr(o, r) {
            if (1 & o && (e.ynx(0),
                ...
                e.qZA(),
                e.qZA(),
                e.YNc(8, Sr, 5, 6, "app-grid-display", 4),
                e.BQk()),
            2 & o) {
                const t = e.oxw();
                e.xp6(3),
        ...
        let Ar = (() => {
                class o {
                    constructor(t, n, i, a) {
                        this.forgeService = t,
                            this.cardGridService = n,
                            this.utils = i,
                            this.groupingService = a,
                            this.columns = 8,
                            this.showOnlyEscrow = !1,
                            this.showUnowned = !1,
                            this.filterCardIds = [],
                    ...
                    onSelectCard(t, n, i) {
                        if (t) {
                            ...
                            this.cardGridService.expandCard({
                                pc: t.pc,
                                qualityMap: a
                            }, n, this.groupingIndex, i)
                        }
                    }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && e.YNc(0, Tr, 9, 8, "ng-container", 0),
                            2 & t && e.Q6J("ngIf", n.numCards > 0)
                        },
                        directives: [l.O5, l.sg, st, Y, l.mk, gn],
                        pipes: [l.rS],
        ...
        function Ir(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.ynx(0),
                    e.TgZ(1, "app-group-quality-inventory", 4),
                    e.NdJ("selectCardId", function (i) {
                        return e.CHM(t),
                            e.oxw(2).onSelectCard(i)
                    }),
                    e.qZA(),
                    e.BQk()
            }
            if (2 & o) {
                const t = e.oxw().$implicit
                    , n = e.oxw();
                e.xp6(1),
                    e.Q6J("showOnlyEscrow", n.showOnlyEscrow)("showUnowned", n.showUnowned)("grouping", t)("filterCardIds", n.filterCardIds)
            }
        }
        ...
        function Zr(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-group-quality-forge", 5),
                    e.NdJ("selectCardId", function (i) {
                        return e.CHM(t),
                            e.oxw(2).onSelectCard(i)
                    }),
        ...
        function Fr(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Ir, 2, 4, "ng-container", 2),
                e.YNc(2, Zr, 1, 7, "ng-template", null, 3, e.W1O),
                e.BQk()),
            2 & o) {
                const t = e.MAs(3)
                    , n = e.oxw();
                e.xp6(1),
                    e.Q6J("ngIf", void 0 === n.expandedViewMode)("ngIfElse", t)
            }
        }
        ...
        let At = (() => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.YNc(0, Fr, 4, 2, "ng-container", 0),
                                e.YNc(1, Dr, 3, 0, "div", 1)),
                            2 & t && (e.Q6J("ngForOf", n.groupedQualities),
                                e.xp6(1),
                                e.Q6J("ngIf", !(n.loading || n.displayedGroupedQualities && 0 !== n.displayedGroupedQualities.length)))
                        },
                        directives: [l.sg, l.O5, Cr, Ar],
        ...
        function Lr(o, r) {
            if (1 & o && (e.TgZ(0, "div", 10),
                e._UZ(1, "app-god-badge", 11),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("god", t.god.toLowerCase())
            }
        }
        ...
        function Ur(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-inventory-cards", 12, 13),
                    e.NdJ("selectCardId", function (i) {
                        return e.CHM(t),
                            e.oxw().selectCard(i)
                    }),
        ...
        function qr(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-group-quality", 14, 13),
                    e.NdJ("selectCardId", function (i) {
                        return e.CHM(t),
                            e.oxw().selectCard(i)
                    }),
        ...
        let It = (() => {
                class o {
                    constructor(t, n, i, a) {
                        this.resizeService = t,
                            this.groupingService = n,
                            this.filterService = i,
                            this.audioService = a,
                            this.activeGrouping = this.groupingService.defaultGrouping,
                            this.filterCardIds = [],
                            this.sound = !0,
                            this.mode = "quality",
                            this.columns = 8,
                            ...
                            this.selectedHeaders = [],
                            this.showOnlyEscrow = !1,
                            this.activeSort = H.PE.AscMana,
                            this.sortOptions = [new B("Mana", "filter_mana", H.PE.AscMana, H.PE.DescMana), new B("Health", "filter_health", H.PE.AscHealth, H.PE.DescHealth), new B("Attack", "filter_attack", H.PE.AscAttack, H.PE.DescAttack), new B("Tribe", "filter_tribe", H.PE.AscTribe, H.PE.DescTribe), new B("Type", "filter_type", H.PE.AscType, H.PE.DescType), new B("God", "filter_god", H.PE.AscGod, H.PE.DescGod), new B("Rarity", "filter_rarity", H.PE.AscRarity, H.PE.DescRarity), new B("Set", "filter_set", H.PE.AscSet, H.PE.DescSet)],
                            this.allGroupedProtos = [],
                            this.allGroupedQualities = [],
                            this.unsubscribe = new y.xQ,
                            this.watchForResize()
                    }
                    ...
                    initGroupings() {
                        this.groupings = this.groupingService.groupings,
                            this.groupingChange(this.activeGrouping)
                    }

                    watchForResize() {
                        this.resizeService.viewPortUnits$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            b.b)(({vh: t}) => this.vh = t)).subscribe()
                    }

                    groupingChange(t, n = !0) {
                        this.sortCards(this.activeSort),
                            this.selectedHeaders = n ? [] : this.selectedHeaders,
                            this.activeGrouping = t,
                            t.groupingType === Z.Quality ? (this.protoGrouping = null,
                                this.qualityGrouping = this.groupingService.groupQualities(this.protoCards, t, this.god, !1, this.customInventoryCardsMap),
                                this.filterCardGroupingQuality()) : (this.qualityGrouping = null,
                                this.protoGrouping = this.groupingService.groupProtos(this.protoCards, t, this.god, !1, this.customInventoryCardsMap),
                                this.filterCardGrouping())
                    }

                    filterCardGrouping() {
                        if (!this.protoGrouping)
                            return;
                        ...
                        this.allGroupedProtos = n.map(i => {
                                ...
                                this.search && this.search.length > 0 && (this.search = this.search.toLowerCase(),
                                    a.cards = [...a.cards].filter(s => s.pc.name.toLowerCase().includes(this.search) || s.pc.tribe && s.pc.tribe.toLowerCase().includes(this.search) || s.pc.god.toLowerCase().includes(this.search) || s.pc.effect.toLowerCase().includes(this.search))),
                                    a
                            }
                        ).filter(i => i.cards.length > 0).reduce((i, a) => i.concat(a), []),
                            this.loadGroup()
                    }

                    loadGroup() {
                        if (this.activeGrouping.groupingType === Z.Quality)
                            return void this.loadGroupQuality();
                        if (!this.allGroupedProtos || 0 === this.allGroupedProtos.length)
                            return;
                        this.displayedGroupedProtos.push(this.allGroupedProtos.pop());
                        let t = this.getDisplayedCardsCount()
                            , n = this.isContainerScrollable(t);
                        for (; this.allGroupedProtos.length > 0 && (0 === t || !n);)
                            this.displayedGroupedProtos.push(this.allGroupedProtos.pop()),
                                t = this.getDisplayedCardsCount(),
                                n = this.isContainerScrollable(t)
                    }

                    filterCardGroupingQuality() {
                        if (!this.qualityGrouping)
                            return;
                        ...
                        this.allGroupedQualities = n.map(i => {
                                ...
                                return this.showOnlyEscrow && (a.cards = [...a.cards].filter(s => {
                                        let c = !1;
                                        return c = s.ics.some(d => "escrow" === d.status),
                                            c
                                    }
                                )),
                                this.search && this.search.length > 0 && (this.search = this.search.toLowerCase(),
                            ...
                            this.loadGroupQuality()
                    }

                    loadGroupQuality() {
                        if (!this.allGroupedQualities || 0 === this.allGroupedQualities.length)
                            return;
                        this.displayedGroupedQualities.push(this.allGroupedQualities.pop());
                        let t = this.getDisplayedCardsCountQuality()
                            , n = this.isContainerScrollable(t);
                        for (; this.allGroupedQualities.length > 0 && (0 === t || !n);)
                            this.displayedGroupedQualities.push(this.allGroupedQualities.pop()),
                                t = this.getDisplayedCardsCountQuality(),
                                n = this.isContainerScrollable(t)
                    }

                    groupingHeaderChange(t) {
                        this.selectedHeaders = t,
                            this.activeGrouping.groupingType === Z.Quality ? this.filterCardGroupingQuality() : this.filterCardGrouping()
                    }
                    ...
                    sortChange(t) {
                        this.activeSort = t,
                            this.groupingChange(this.activeGrouping, !1)
                    }
                    ...
                    ownershipChange(t) {
                        this.showUnowned = "all" === t,
                            this.showOnlyEscrow = "escrow" === t,
                    ...
                    selectCard(t) {
                        this.sound && this.audioService.clickItemV1.play(),
                            this.selectCardId.emit(t)
                    }
                    ...
                    getFilterGroups(t) {
                        let n = [];
                        if (this.expandedViewMode === Q.SELLING)
                            n = t.map(i => Object.assign(Object.assign({}, i), {
                                cards: i.cards.filter(({pc: a}) => "genesis" === a.set)
                            }));
                        else {
                            if (this.expandedViewMode !== Q.FORGING)
                                return t;
                            n = t.map(i => Object.assign(Object.assign({}, i), {
                                cards: i.cards.filter(({pc: a}) => "core" === a.set)
                            }))
                        }
                        return n
                    }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        viewQuery: function (t, n) {
                            ...
                            2 & t) {
                                let i;
                                e.iGM(i = e.CRH()) && (n.groupsContainer = i.first),
                                e.iGM(i = e.CRH()) && (n.cardComponents = i)
                            }
                        },
                        inputs: {
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "header", 0),
                                e.YNc(1, Br, 2, 1, "h3", 1),
                                e.TgZ(2, "app-singular-active-filter-bar", 2),
                                e.NdJ("groupingChange", function (a) {
                                    return n.groupingChange(a)
                                })("searchChange", function (a) {
                                    return n.searchChange(a)
                                }),
                                e.qZA(),
                                e.TgZ(3, "app-filter-sort-bar", 3),
                                e.NdJ("sortChange", function (a) {
                                ...
                                e.qZA(),
                                e.YNc(4, Lr, 2, 1, "div", 4),
                                e.qZA(),
                                e.TgZ(5, "section", 5, 6),
                                e.NdJ("scrolled", function () {
                                    return n.loadGroup()
                                }),
                                e.YNc(7, Ur, 2, 7, "app-inventory-cards", 7),
                                e.YNc(8, qr, 2, 6, "app-group-quality", 8),
                                e.qZA()),
                            2 & t && (e.xp6(1),
                                e.Q6J("ngIf", n.title),
                                e.xp6(1),
                                e.Q6J("activeGrouping", n.activeGrouping)("groupings", n.groupings),
                                e.xp6(1),
                                e.Q6J("sortOptions", n.sortOptions)("selectedHeaders", n.selectedHeaders)("cardGrouping", n.activeGrouping.groupingType === n.GroupingType.Quality ? n.qualityGrouping : n.protoGrouping)("unownedCheckboxVisible", !(n.activeGrouping.groupingType === n.GroupingType.Quality || void 0 !== n.expandedViewMode)),
                                e.xp6(1),
                                e.Q6J("ngIf", n.god),
                                e.xp6(1),
                                e.Q6J("scrollWindow", !1),
                                e.xp6(2),
                                e.Q6J("ngIf", n.activeGrouping.groupingType !== n.GroupingType.Quality),
                                e.xp6(1),
                                e.Q6J("ngIf", n.activeGrouping.groupingType === n.GroupingType.Quality))
                        },
            ...
            , Er = (() => {
                class o {
                    ...
                    ngOnInit() {
                        this.baseImage = this.el.nativeElement,
                            this.originalBrightness = this.baseImage.style.filter
                    }
                    ...
                    showCard() {
                        ...
                        this.renderer.appendChild(this.el.nativeElement.parentNode, this.cloneImage),
                            k.p8.set(this.cloneImage, {
                                position: "absolute",
                                top: 20,
                                left: 15,
                    ...
                    hideCard() {
                        return new Promise(t => {
                                k.p8.set(this.el.nativeElement, {
                                    filter: this.originalBrightness
                                }),
                                    k.p8.to(this.cloneImage, {
                                        duration: .2,
                                        scale: 1,
        ...
        function Nr(o, r) {
            ...
            if (2 & o) {
                const t = r.$implicit;
                e.ekj("cardListing__card--removed", t.isRemoved),
                    e.Q6J("protoId", t.card.proto)("quality", t.card.quality)
            }
        }
        ...
        let Rr = (() => {
                class o {
                    constructor() {
                        this.chosenCards = [],
                            this.unsubscribe = new y.xQ,
                            this.chooserSelectCards = new e.vpe,
                            this.closeBundleChooser = () => {
                            }
                            ,
                            this.closeOverlay = () => {
                                this.closeBundleChooser(),
                                this.chosenCards.length > 0 && this.chooserSelectCards.emit(this.chosenCards)
                            }
                    }
                    ...
                    ngOnChanges(t) {
                        t.cards && !t.cards.firstChange && (this.cards = t.cards.currentValue,
                            this.initCards())
                    }
                    ...
                    initCards() {
                        this.allCards = this.cards.map(t => ({
                            card: t,
                            isRemoved: !1
                        }))
                    }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        outputs: {
                            chooserSelectCards: "chooserSelectCards"
                        },
                        features: [e.TTD],
                        decls: 6,
                        vars: 2,
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "app-modal-sidebar", 0),
                                e.TgZ(1, "header", 1),
                                e.TgZ(2, "h3", 2),
                                e._uU(3, " Click to Remove "),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(4, "div", 3),
                                e.YNc(5, Nr, 1, 4, "app-card2", 4),
                                e.qZA()),
                            2 & t && (e.Q6J("closeButtonClickFn", n.closeOverlay),
                                e.xp6(5),
                                e.Q6J("ngForOf", n.allCards))
                        },
        ...
        function Yr(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-card-chooser-overlay", 6),
                    e.NdJ("chooserSelectCards", function (i) {
                        return e.CHM(t),
                            e.oxw().onChooserSelectCards(i)
                    }),
                    e.qZA()
            }
            if (2 & o) {
        ...
        let Jr = (() => {
                class o {
                    constructor(t) {
                        this.audioService = t,
                            this.selectCards = new e.vpe,
                            this.showCardChooserOverlay = !1,
                            this.unsubscribe = new y.xQ,
                            this.closeBundleChooser = () => {
                                this.audioService.clickTinyV2.play(),
                                    this.showCardChooserOverlay = !1
                    ...
                    clickCard(t) {
                        this.audioService.clickItemV1.play(),
                            this.bundle.cards.length >= 2 ? this.openBundleChooser() : this.selectCards.emit([t])
                    }
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "div", 0),
                                ...
                                e.YNc(5, Hr, 1, 7, "app-card2", 3),
                                e.qZA(),
                                e.qZA(),
                                e.YNc(6, Yr, 1, 5, "app-card-chooser-overlay", 4)),
                            2 & t && (e.xp6(2),
                                e.Oqu(e.lcZ(3, 3, n.bundle.header)),
                                e.xp6(3),
                                e.Q6J("ngForOf", n.bundle.cards),
                                e.xp6(1),
                                e.Q6J("ngIf", n.showCardChooserOverlay))
                        },
                        directives: [l.sg, l.O5, Y, Er, l.PC, Rr],
                        pipes: [l.rS],
        ...
        function $r(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "gu-primary-hex-button", 7),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().clickDelete()
                    }),
        ...
        let zr = (() => {
                class o {
                    constructor(t, n) {
                        this.akumaService = t,
                            this.audioService = n,
                            this.closeEditDeckOverlay = () => {
                            }
                            ,
                            this.deckName = "",
                            this.changeDeckName = new e.vpe,
                            this.deleteDeck = new e.vpe,
                            this.deckNameControl = new I.NI(""),
                            this.confirmingDelete = !1,
                            this.unsubscribe = new y.xQ,
                            this.closeOverlay = () => {
                                this.audioService.clickTinyV2.play(),
                                    this.akumaService.postControlEvent("gu", "DeckEditor", "", "close", "Btn", "pressed"),
                                    this.closeEditDeckOverlay()
                            }
                    }

                    ngOnInit() {
                        this.inputDeckName = this.deckName,
                            this.watchSearch()
                    }
                    ...
                    clickDelete() {
                        this.akumaService.postControlEvent("gu", "DeckEditor", "", "deleteDeck", "Btn", "pressed"),
                            this.confirmingDelete = !0
                    }

                    confirmDelete() {
                        this.audioService.workshopDelete.play(),
                    ...
                    watchSearch() {
                        this.deckNameControl.valueChanges.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            kt.b)(500), (0,
                            ht.x)(), (0,
                            b.b)(t => this.inputDeckName = t)).subscribe()
                    }

                    saveChanges() {
                        this.akumaService.postControlEvent("gu", "DeckEditor", "", "saveDeck", "Btn", "pressed"),
                            this.changeDeckName.emit(this.inputDeckName)
                    }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        inputs: {
                            closeEditDeckOverlay: "closeEditDeckOverlay",
                            deckName: "deckName"
                        },
                        outputs: {
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "app-modal-sidebar", 0),
                                ...
                                e._uU(3, " Edit Deck "),
                                e.qZA(),
                                e.TgZ(4, "gu-primary-hex-button", 3),
                                e.NdJ("click", function () {
                                ...
                                e.qZA(),
                                e.YNc(6, $r, 1, 0, "gu-primary-hex-button", 5),
                                e.YNc(7, Wr, 6, 0, "p", 6)),
                            2 & t && (e.Q6J("closeButtonClickFn", n.closeOverlay),
                                e.xp6(5),
                                e.Q6J("ngModel", n.inputDeckName)("formControl", n.deckNameControl),
                                e.xp6(1),
                                e.Q6J("ngIf", !n.confirmingDelete),
                                e.xp6(1),
                                e.Q6J("ngIf", n.confirmingDelete))
                        },
                        directives: [ke, I.Fj, I.nD, I.JJ, I.oH, l.O5],
        ...
        function Vr(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-singular-active-filter-bar", 11),
                    e.NdJ("groupingChange", function (i) {
                        return e.CHM(t),
                            e.oxw().groupingChange(i)
                    }),
                    e.qZA()
            }
            if (2 & o) {
        ...
        function jr(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-card-bundle", 13),
                    e.NdJ("selectCards", function (i) {
                        return e.CHM(t),
                            e.oxw(2).onSelectCards(i)
                    }),
                    e.qZA()
            }
        ...
        function Xr(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, jr, 1, 1, "app-card-bundle", 12),
                e.ALo(2, "keyvalue"),
                e.BQk()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("ngForOf", e.lcZ(2, 1, t.cardGrouping))
            }
        }
        ...
        function Kr(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-edit-deck", 14),
                    e.NdJ("deleteDeck", function () {
                        return e.CHM(t),
                            e.oxw().deleteDeck()
                    })("changeDeckName", function (i) {
                        return e.CHM(t),
                            e.oxw().changeDeckName(i)
                    }),
                    e.qZA()
            }
            if (2 & o) {
                ...
                class o {
                    constructor(t, n, i, a, s, c, d, p) {
                        this.guGameService = t,
                            ...
                            this.utils = p,
                            this.activeGrouping = this.groupingService.defaultGrouping,
                            this.deckSelectMode = !1,
                            this.forAI = !1,
                            this.deckCards = [],
                            this.selectCards = new e.vpe,
                            this.showEditDeckOverlay = !1,
                            this.closeEditDeckOverlay = () => {
                                this.audioService.clickTinyV2.play(),
                                    this.showEditDeckOverlay = !1
                            }
                    ...
                    initGroupings() {
                        this.groupings = this.groupingService.groupingsNoTribe.filter(t => t.groupingType !== Z.Quality),
                            this.groupingChange(this.activeGrouping)
                    }

                    groupingChange(t) {
                        this.activeGrouping = t,
                            this.cardGrouping = this.groupingService.createCardGrouping(t),
                            this.deckCards.forEach(n => this.groupingService.addToCardGrouping(this.cardGrouping, t, n))
                    }
                    ...
                    saveDeck() {
                        this.decksService.saveActiveDeck(this.deckSelectMode).pipe((0,
                            x.q)(1), (0,
                            b.b)(t => {
                                t > -1 && this.deckSelectMode ? (this.logSelectDeck(),
                                    this.guGameService.updateGameModeDeck(this.gameModeID, t, this.forAI),
                                    this.modalService.destroyModalsStack(),
                                    this.router.navigate(["/game/gu/game-modes"])) : this.modalService.destroyTopModal()
                            }
                        )).subscribe()
                    }

                    openEditDeckOverlay() {
                        this.akumaService.postControlEvent("gu", "DeckEditor", "", "editDeck", "Btn", "pressed"),
                            this.audioService.clickItemV1.play(),
                            this.showEditDeckOverlay = !0
                    }

                    deleteDeck() {
                        this.closeEditDeckOverlay(),
                            this.decksService.deleteDeck(this.deck.id),
                            this.modalService.destroyTopModal()
                    }

                    changeDeckName(t) {
                        this.closeEditDeckOverlay(),
                            this.decksService.updateActiveDeckName(t)
                    }
                }
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "header", 0),
                                ...
                                e._uU(2),
                                e.qZA(),
                                e.YNc(3, Vr, 1, 3, "app-singular-active-filter-bar", 2),
                                e.TgZ(4, "div", 3),
                                e._UZ(5, "gu-icon", 4),
                                e.TgZ(6, "div", 5),
                                e._uU(7),
                                e.qZA(),
                                e.TgZ(8, "gu-primary-hex-button", 6),
                                e.NdJ("click", function () {
                                    return n.openEditDeckOverlay()
                                }),
                                e.qZA(),
                                e.TgZ(9, "gu-primary-hex-button", 7),
                                e.NdJ("click", function () {
                                    return n.saveDeck()
                                }),
                                e.qZA(),
                                ...
                                e.qZA(),
                                e.TgZ(10, "div", 8),
                                e.YNc(11, Xr, 3, 3, "ng-container", 9),
                                e.qZA(),
                                e.YNc(12, Kr, 1, 3, "app-edit-deck", 10)),
                            2 & t && (e.xp6(2),
                                e.Oqu(n.deck.name),
                                e.xp6(1),
                                e.Q6J("ngIf", n.deckCards),
                                e.xp6(4),
                                e.hij("", n.deckCards.length, "/30 Cards"),
                                e.xp6(1),
                                e.Q6J("disabled", "starter" === n.deck.deck_type || "sealed_deck" === n.deck.deck_type),
                                e.xp6(1),
                                e.Q6J("text", n.deckSelectMode ? "SELECT" : "SAVE DECK")("disabled", !!n.deckSelectMode && 30 !== n.deckCards.length),
                                e.xp6(2),
                                e.Q6J("ngIf", n.cardGrouping),
                                e.xp6(1),
                                e.Q6J("ngIf", n.showEditDeckOverlay))
                        },
        ...
        function ta(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "gu-plain-square-button", 6),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().exportClick()
                    }),
        ...
        function na(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-cards-list", 7),
                    e.NdJ("selectCardId", function (i) {
                        return e.CHM(t),
                            e.oxw().selectCardId(i)
                    }),
                    e.qZA()
            }
            if (2 & o) {
        ...
        let Ye = (() => {
                class o {
                    constructor(t, n, i, a, s, c, d, p) {
                        this.decksService = t,
                            this.cardsService = n,
                            this.modalService = i,
                            this.moduleConfigService = a,
                            this.audioService = s,
                            this.akumaService = c,
                            this.cerberusModalService = d,
                            this.deckCodeService = p,
                            this.filters = _.iZ.standardCardFilters(m.nE.All, m.PE.AscID, "genesis", ""),
                            this.availableFilters = [{
                                name: "Quality",
                                options: _.iZ.qualityOptions
                            }, {
                                name: "Rarity",
                                options: _.iZ.rarityOptions
                            }, {
                                name: "Tribe",
                                options: _.iZ.tribeOptions
                            }, {
                                name: "Mana",
                                options: _.iZ.manaOptions
                            }, {
                                name: "Set",
                            ...
                            this.destroyModal = () => {
                                ...
                                v.title = "You\u2019re about to leave",
                                    v.text = "Make sure you've saved your deck.",
                                    v.secondaryCtaText = "Cancel",
                                    v.primaryCtaText = "Confirm",
                                    v.onPrimaryCtaClick = () => {
                                        this.modalService.destroyTopModal(),
                    ...
                    ngOnInit() {
                        this.initDecks(),
                            this.initSelectMode(),
                            this.initCards(),
                            this.cardsService.checkToRefreshInventory()
                    }
                    ...
                    initSelectMode() {
                        this.decksService.deckSelectMode$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            b.b)(t => {
                                this.deckSelectMode = t.deckSelect,
                                    this.gameModeID = t.gameModeID,
                                    this.forAI = t.forAI
                            }
                        )).subscribe()
                    }
                    ...
                    selectNewDeck(t) {
                        this.activeDeck = t,
                            this.god = t.god,
                            this.deckCards = [...t.items],
                            this.deckCardIds = [...t.items.map(n => n.id)]
                    }

                    initCards() {
                        this.loading = !0,
                            (0,
                                D.aj)([this.cardsService.inventoryCards$, this.cardsService.protoCards$]).pipe((0,
                                u.R)(this.unsubscribe), (0,
                                b.b)(([t, n]) => {
                                    this.inventoryCards = t,
                                        this.protoCards = this.moduleConfigService.useDevApis() ? Array.from(n.values()) : Array.from(n.values()).filter(i => i.live),
                                        this.loading = !1
                                }
                            )).subscribe()
                    }
                    ...
                    removeCards(t) {
                        this.audioService.clickItemV1.play(),
                            this.decksService.removeCardsFromActiveDeck(t)
                    }
                    ...
                    exportClick() {
                        ...
                        this.cerberusModalService.open(hi, {
                            defaultStylings: !1,
                            centered: !0
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "app-modal-sidebar", 0),
                                e.YNc(1, ea, 1, 0, "app-rectangular-spinner", 1),
                                e.YNc(2, ta, 2, 1, "gu-plain-square-button", 2),
                                e.YNc(3, na, 1, 5, "app-cards-list", 3),
                                e.YNc(4, oa, 1, 5, "app-active-deck", 4)),
                            2 & t && (e.Q6J("closeButtonClickFn", n.destroyModal),
                                e.xp6(1),
                                e.Q6J("ngIf", n.loading),
                                e.xp6(1),
                                e.Q6J("featureFlagIf", n.Flags.deckCodesEnabled),
                                e.xp6(1),
                                e.Q6J("ngIf", !n.loading),
                                e.xp6(1),
                                e.Q6J("ngIf", n.activeDeck))
                        },
                        directives: [ke, l.O5, rt.w, at, It, pn],
        ...
        function ra(o, r) {
            if (1 & o) {
                ...
                e.ynx(0),
                    e.TgZ(1, "header", 2),
                    e.TgZ(2, "h1", 3),
                    e._uU(3, " CONNECT YOUR WALLET "),
                    e.qZA(),
                    e.TgZ(4, "div", 4),
                    e._uU(5, " We want to make sure your cards get to the right wallet. Please connect your wallet via the Gods Unchained website. "),
                    e.qZA(),
                    e.TgZ(6, "gu-primary-hex-button", 5),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().linkWallet()
                    }),
        ...
        function aa(o, r) {
            if (1 & o) {
                ...
                e.ynx(0),
                    e.TgZ(1, "header", 2),
                    e.TgZ(2, "h1", 3),
                    e._uU(3, " CONFIRM YOUR WALLET "),
                    e.qZA(),
                    e.TgZ(4, "div", 4),
                    e._uU(5, " We want to make sure your cards get to the right wallet. Please confirm this is the right address to send cards to. "),
                    e.qZA(),
                    e.TgZ(6, "div", 6),
                    e._uU(7),
                    e.qZA(),
                    e.TgZ(8, "gu-primary-hex-button", 7),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().confirmWallet()
                    }),
        ...
        function sa(o, r) {
            if (1 & o) {
                ...
                e.ynx(0),
                    ...
                    e.qZA(),
                    e.TgZ(4, "div", 4),
                    e._uU(5, " It looks like you have more then one wallet linked to your account. To ensure your new card goes to the right place, please confirm which wallet you want linked. "),
                    e.qZA(),
                    e.TgZ(6, "gu-primary-hex-button", 9),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().selectWallet()
                    }),
        ...
        let hn = (() => {
                class o {
                    ...
                    watchWalletStatus() {
                        (0,
                            D.aj)([this.forgeWalletService.playerWallets$, this.forgeWalletService.selectedWallet$]).pipe((0,
                            u.R)(this.unsubscribe)).subscribe(([t, n]) => {
                                this.playerWallets = t,
                                    this.selectedWallet = n,
                                this.selectedWallet && this.playerWallets && this.playerWallets.length > 0 && this.onHide()
                            }
                        )
                    }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "div", 0),
                                e.YNc(1, ra, 7, 0, "ng-container", 1),
                                e.YNc(2, aa, 11, 1, "ng-container", 1),
                                e.YNc(3, sa, 7, 0, "ng-container", 1)),
                            2 & t && (e.xp6(1),
                                e.Q6J("ngIf", !n.playerWallets || 0 === n.playerWallets.length),
                                e.xp6(1),
                                e.Q6J("ngIf", n.playerWallets && 1 === n.playerWallets.length),
                                e.xp6(1),
                                e.Q6J("ngIf", n.playerWallets && n.playerWallets.length > 1))
                        },
                        directives: [l.O5],
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "header", 0),
                                e.TgZ(1, "h1", 1),
                                e._uU(2, " WELCOME TO THE FORGE "),
                                e.qZA(),
                                e.TgZ(3, "div", 2),
                                e._uU(4, " Fuse multiple cards to create one of higher quality "),
                                e.qZA(),
                                e.qZA(),
                                e._UZ(5, "img", 3),
                                e.TgZ(6, "gu-primary-hex-button", 4),
                                e.NdJ("click", function () {
                                    return n.onHide()
                                }),
                                e.qZA())
        ...
        function da(o, r) {
            if (1 & o && e._UZ(0, "app-inventory-cards", 12),
            2 & o) {
                const t = e.oxw();
        ...
        function ga(o, r) {
            if (1 & o && e._UZ(0, "app-group-quality", 13),
            2 & o) {
                const t = e.oxw();
                ...
                class o {
                    constructor(t, n, i, a, s) {
                        this.resizeService = t,
                            ...
                            this.showUnowned = !0,
                            this.loading = !0,
                            this.activeSort = m.PE.AscMana,
                            this.sortOptions = [new B("Mana", "filter_mana", m.PE.AscMana, m.PE.DescMana), new B("Health", "filter_health", m.PE.AscHealth, m.PE.DescHealth), new B("Attack", "filter_attack", m.PE.AscAttack, m.PE.DescAttack), new B("Tribe", "filter_tribe", m.PE.AscTribe, m.PE.DescTribe), new B("Type", "filter_type", m.PE.AscType, m.PE.DescType), new B("God", "filter_god", m.PE.AscGod, m.PE.DescGod), new B("Rarity", "filter_rarity", m.PE.AscRarity, m.PE.DescRarity), new B("Set", "filter_set", m.PE.AscSet, m.PE.DescSet)],
                            this.allGroupedProtos = [],
                            this.allGroupedQualities = [],
                            this.unsubscribe = new y.xQ,
                            this.watchForResize()
                    ...
                    groupingChange(t, n = !0) {
                        this.sortCards(this.activeSort),
                            ...
                            this.activeGrouping = t,
                            t.groupingType === Z.Quality ? (this.protoGrouping = null,
                                this.qualityGrouping = this.groupingService.groupQualities(this.protoCards, t, this.god),
                                this.filterCardGroupingQuality()) : (this.qualityGrouping = null,
                                this.protoGrouping = this.groupingService.groupProtos(this.protoCards, t, this.god),
                                this.filterCardGrouping()),
                            this.loading = !1
                    }
                    ...
                    filterCardGrouping() {
                        ...
                        this.allGroupedProtos = n.map(i => {
                                const a = Object.assign({}, i);
                                return this.search && this.search.length > 0 && (this.search = this.search.toLowerCase(),
                                    a.cards = [...a.cards].filter(s => s.pc.name.toLowerCase().includes(this.search) || s.pc.tribe && s.pc.tribe.toLowerCase().includes(this.search) || s.pc.god.toLowerCase().includes(this.search) || s.pc.effect.toLowerCase().includes(this.search))),
                                    a
                            }
                        ).filter(i => i.cards.length > 0).reduce((i, a) => i.concat(a), []),
                    ...
                    searchChange(t) {
                        this.cardGridService.resetCardGrid(),
                            this.search = t,
                            this.filterCardGroupingQuality()
                    }
                    ...
                    isContainerScrollable(t) {
                        if (void 0 !== this.expandedViewMode)
                            return !1;
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "header", 0),
                                ...
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(5, "app-singular-active-filter-bar", 4),
                                e.NdJ("searchChange", function (a) {
                                    return n.searchChange(a)
                                }),
                                e.qZA(),
                                e.TgZ(6, "app-filter-sort-bar", 5),
                                e.NdJ("sortChange", function (a) {
                                    return n.sortChange(a)
                                })("groupingHeaderChange", function (a) {
                                    return n.groupingHeaderChange(a)
                                ...
                                e.qZA(),
                                e.qZA(),
                                e.YNc(7, la, 1, 0, "gu-loading-spinner", 6),
                                e.TgZ(8, "section", 7, 8),
                                e.NdJ("scrolled", function () {
                                    return n.loadGroup()
                                }),
                                e.YNc(10, da, 1, 7, "app-inventory-cards", 9),
                                e.YNc(11, ga, 1, 7, "app-group-quality", 10),
                                e.qZA()),
                            2 & t && (e.xp6(3),
                                e.Oqu(n.title),
                                e.xp6(2),
                                e.Q6J("displaySearch", !0),
                                e.xp6(1),
                                e.Q6J("showFilters", !1)("sortOptions", n.sortOptions)("selectedHeaders", n.selectedHeaders)("cardGrouping", n.protoGrouping)("unownedCheckboxVisible", !1),
                                e.xp6(1),
                                e.Q6J("ngIf", n.loading),
                                e.xp6(1),
                                e.Q6J("scrollWindow", !1),
                ...
                class o {
                    transform(t, n = 6) {
                        try {
                            const i = _a.O$.from(t);
                            return (0,
                                Cn.Fn)(Number.parseFloat(Number((0,
                                Cn.dF)(i)).toFixed(n)))
                        } catch (i) {
                            return "0"
                        }
        ...
        function ma(o, r) {
            1 & o && (e.TgZ(0, "div", 12),
                e.TgZ(1, "gu-body-text", 13),
                e._uU(2, " There\u2019s nothing here! "),
                e.qZA(),
                e.TgZ(3, "gu-body-text", 14),
                e._uU(4, " Start fusing then check back again. "),
                e.qZA(),
                e.qZA())
        }
        ...
        function fa(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.ynx(0),
                    e.TgZ(1, "gu-simple-text-button", 33),
                    e.NdJ("click", function () {
                        e.CHM(t);
                        const i = e.oxw().$implicit;
            ...
            if (2 & o) {
                const t = e.oxw().$implicit
                    , n = e.oxw(3);
                e.xp6(1),
                    e.hYB("href", "", n.environment.guWebsite, "/fusing-next-step?request_id=", t.request_id, "")
            }
        }

        function Ca(o, r) {
            if (1 & o && (e.TgZ(0, "a", 34),
                e.TgZ(1, "gu-body-text", 28),
                e._uU(2),
                e.qZA(),
                e.qZA()),
            2 & o) {
                const t = e.oxw().$implicit
                    , n = e.oxw(3);
                e.hYB("href", "", n.environment.GUCollectioimmutableXMarketplaceUrlGUInventory, "/", t.target_assets[0].id, "", e.LSH),
                    e.xp6(2),
                    e.hij(" ", t.target_assets[0].id, " ")
            }
        }

        const va = function (o, r) {
            return {
                tableSection__rowEven: o,
                tableSection__rowOdd: r
            }
        };

        function ba(o, r) {
            if (1 & o && (e.TgZ(0, "tr", 24),
                e.TgZ(1, "td", 25),
                e.TgZ(2, "gu-body-text", 26),
                e._uU(3),
                e.ALo(4, "date"),
                e.qZA(),
                e.TgZ(5, "gu-body-text", 27),
                e._uU(6),
                e.ALo(7, "date"),
                e.qZA(),
                e.qZA(),
                e.TgZ(8, "td", 25),
                e.TgZ(9, "gu-body-text", 28),
                e._uU(10),
                e.ALo(11, "titlecase"),
                e.YNc(12, fa, 2, 2, "ng-container", 8),
                e.qZA(),
                e.qZA(),
                e.TgZ(13, "td", 25),
                e.TgZ(14, "gu-body-text", 28),
                e._uU(15),
                e.qZA(),
                e.qZA(),
                e.TgZ(16, "td", 25),
                e.YNc(17, Ca, 3, 3, "a", 29),
                e.qZA(),
                e.TgZ(18, "td", 25),
                e.TgZ(19, "gu-body-text", 28),
                e._uU(20),
                e.ALo(21, "titlecase"),
                e.qZA(),
                e.qZA(),
                e.TgZ(22, "td", 25),
                e.TgZ(23, "gu-body-text", 30),
                e._uU(24),
                e.ALo(25, "numberAbbreviation"),
                e._UZ(26, "gu-icon", 31),
                e._uU(27),
                e.ALo(28, "formatEther"),
                e._UZ(29, "gu-icon", 32),
                e.qZA(),
                e.qZA(),
                e.TgZ(30, "td", 25),
                e.TgZ(31, "gu-body-text", 28),
                e._uU(32),
                e.ALo(33, "addressTruncate"),
                e.qZA(),
                e.qZA(),
                e.qZA()),
            2 & o) {
                const t = r.$implicit
                    , n = r.even
                    , i = e.oxw(3);
                e.Q6J("ngClass", e.WLB(29, va, n, !n)),
                    e.xp6(3),
                    e.hij(" ", e.xi3(4, 12, t.created_at, "dd/MM/YYYY"), " "),
                    e.xp6(3),
                    e.hij(" ", e.xi3(7, 15, t.created_at, "h:mm:ss"), " "),
                    e.xp6(4),
                    e.hij(" ", e.lcZ(11, 18, i.ForgeStatusMapping[t.status]), "\xa0 "),
                    e.xp6(2),
                    e.Q6J("ngIf", t.status !== i.ForgeStatus.COMPLETED && t.status !== i.ForgeStatus.VALIDATING_PAYMENT),
                    e.xp6(3),
                    e.hij(" ", t.request_id, " "),
                    e.xp6(2),
                    e.Q6J("ngIf", (null == t.target_assets[0] ? null : t.target_assets[0].id) > 0),
                    e.xp6(3),
                    e.AsE(" ", t.target_assets[0].name, " - ", e.lcZ(21, 20, i.QualityMapping[t.target_assets[0].quality]), " "),
                    e.xp6(4),
                    e.hij(" ", e.xi3(25, 22, t.flux_amount, 2), " "),
                    e.xp6(3),
                    e.hij(" \xa0 ", e.lcZ(28, 25, t.token_amount), " "),
                    e.xp6(5),
                    e.hij(" ", e.lcZ(33, 27, t.address), " ")
            }
        }

        function wa(o, r) {
            if (1 & o && (e.TgZ(0, "table", 15),
                e.TgZ(1, "thead"),
                e.TgZ(2, "tr"),
                e.TgZ(3, "th", 16),
                e.TgZ(4, "gu-body-text", 17),
                e._uU(5, " Time (UTC) "),
                e.qZA(),
                e.qZA(),
                e.TgZ(6, "th", 16),
                e.TgZ(7, "div", 18),
                e.TgZ(8, "gu-body-text", 17),
                e._uU(9, " Status "),
                e.qZA(),
                e._uU(10, " \xa0 "),
                e.TgZ(11, "app-tooltip", 19),
                e._UZ(12, "gu-icon", 20),
                e.qZA(),
                e.qZA(),
                e.qZA(),
                e.TgZ(13, "th", 16),
                e.TgZ(14, "div", 18),
                e.TgZ(15, "gu-body-text", 17),
                e._uU(16, " Fusing ID "),
                e.qZA(),
                e._uU(17, " \xa0 "),
                e.TgZ(18, "app-tooltip", 21),
                e._UZ(19, "gu-icon", 20),
                e.qZA(),
                e.qZA(),
                e.qZA(),
                e.TgZ(20, "th", 16),
                e.TgZ(21, "div", 18),
                e.TgZ(22, "gu-body-text", 17),
                e._uU(23, " Card ID "),
                e.qZA(),
                e._uU(24, " \xa0 "),
                e.TgZ(25, "app-tooltip", 22),
                e._UZ(26, "gu-icon", 20),
                e.qZA(),
                e.qZA(),
                e.qZA(),
                e.TgZ(27, "th", 16),
                e.TgZ(28, "gu-body-text", 17),
                e._uU(29, " Card Fused "),
                e.qZA(),
                e.qZA(),
                e.TgZ(30, "th", 16),
                e.TgZ(31, "gu-body-text", 17),
                e._uU(32, " Cost "),
                e.qZA(),
                e.qZA(),
                e.TgZ(33, "th", 16),
                e.TgZ(34, "gu-body-text", 17),
                e._uU(35, " Wallet "),
                e.qZA(),
                e.qZA(),
                e.qZA(),
                e.qZA(),
                e.TgZ(36, "tbody"),
                e.YNc(37, ba, 34, 32, "tr", 23),
                e.qZA(),
                e.qZA()),
            2 & o) {
                const t = e.oxw(2);
                e.xp6(37),
                    e.Q6J("ngForOf", t.items)
            }
        }

        function xa(o, r) {
            if (1 & o && (e.TgZ(0, "div", 9),
                e.YNc(1, ma, 5, 0, "div", 10),
                e.YNc(2, wa, 38, 1, "table", 11),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("ngIf", 0 === t.items.length),
                    e.xp6(1),
                    e.Q6J("ngIf", t.items.length > 0)
            }
        }
        ...
        let ya = (() => {
                class o {
                    constructor(t, n, i, a, s) {
                        this.authService = t,
                            this.fusingService = n,
                            this.modalService = i,
                            this.environment = a,
                            this.window = s,
                            this.unsubscribe = new y.xQ,
                            this.items = [],
                            this.fusingRequestResponseLoading = !0
                    }
                    ...
                    ngOnInit() {
                        const t = this.authService.getUserId();
                        this.fusingRequestResponseLoading = !0,
                            this.fusingService.getFusingLatestsRequests(t).pipe((0,
                                u.R)(this.unsubscribe), (0,
                                ua.x)(() => {
                ...
                return o.\u0275fac = function (t) {
                    return new (t || o)(e.Y36(f.mI), e.Y36(_.pH), e.Y36(T.Z), e.Y36(f.Ho), e.Y36(Window))
                }
                    ,
                    o.\u0275cmp = e.Xpm({
                        type: o,
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "gu-icon", 0),
                                ...
                                e.TgZ(1, "div", 1),
                                e.TgZ(2, "header", 2),
                                e.TgZ(3, "gu-heading-text", 3),
                                e._uU(4, " Fusing History "),
                                e.qZA(),
                                e.TgZ(5, "gu-body-text", 4),
                                e._uU(6, " A list of your past 60 fuses and their status. See your Immutable X inventory "),
                                e.TgZ(7, "gu-simple-text-button", 5),
                                e._UZ(8, "gu-icon", 6),
                                e.qZA(),
                                e.qZA(),
                                e.qZA(),
                                e.YNc(9, xa, 3, 2, "div", 7),
                                e.qZA(),
                                e.YNc(10, Ma, 1, 0, "gu-loading-spinner", 8)),
                            2 & t && (e.xp6(9),
                                e.Q6J("ngIf", !n.fusingRequestResponseLoading),
                                e.xp6(1),
                                e.Q6J("ngIf", n.fusingRequestResponseLoading))
                        },
        ...
        let Oa = (() => {
                class o {
                    ...
                    getRegisteredUserStarkKeys(t) {
                        return this.moduleConfig$.pipe((0,
                            me.w)(({imxApiHost: n}) => this.http.get(`${n}/users/${t}`)))
                    }

                    getUserListOfBalance(t, n = "GODS") {
                        return this.moduleConfig$.pipe((0,
                            me.w)(({imxApiHostV2: i}) => this.http.get(`${i}/balances/${t}`, {
                            params: {
                                symbols: n
                            }
                        })))
                    ...
                    getBalance(t) {
                        return this.moduleConfig$.pipe((0,
                            me.w)(({imxApiHostV2: n}) => this.http.get(`${n}/balances/${t}`, {})))
                    }
                }
            ...
            , Pa = (() => {
                class o {
                    constructor(t) {
                        this.imxApiService = t,
                            this._godsInfo$ = new J.X(null),
                            this.dataStore = {
                                godsInfo: void 0
                            }
                    }
                    ...
                    fetchGodsInfo(t) {
                        this.imxApiService.getUserListOfBalance(t).pipe((0,
                            x.q)(1)).subscribe(n => {
                                const {result: [i]} = n;
                                this.emitGodsInfo(i)
                            }
                    ...
                    emitGodsInfo(t = {
                        ...
                        this.dataStore.godsInfo = t,
                            this._godsInfo$.next(Object.assign({}, this.dataStore.godsInfo))
                    }
                }
            ...
            , vn = (() => {
                class o {
                    constructor(t, n) {
                        this.forgeWalletService = t,
                            this.addressTruncatePipe = n,
                            this.unsubscribe = new y.xQ,
                            this.addresses = [],
                            this.truncateAddress = !1
                    }
                    ...
                    initWalletAddress() {
                        this.forgeWalletService.playerWallets$.pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "gu-select", 0),
                                e.NdJ("change", function (a) {
                                    return n.onDropdownSelect(a)
                                }),
                                e.qZA()),
                            2 & t && e.Q6J("options", n.addresses)("value", n.selectedWallet)
                        },
        ...
        function Sa(o, r) {
            1 & o && (e.ynx(0),
                e.TgZ(1, "gu-body-text"),
                e._uU(2, "Wallet:"),
                e.qZA(),
                e._UZ(3, "cerberus-select-wallet-dropdown", 11),
                e.BQk())
        }
        ...
        let Ta = (() => {
                class o {
                    constructor(t, n, i, a) {
                        this.fluxService = t,
                            this.imxBalanceService = n,
                            this.forgeWalletService = i,
                            this.modalService = a,
                            this.unsubscribe = new y.xQ,
                            this.fluxBalance = 0
                    }
                    ...
                    initFluxBalance() {
                        this.fluxService.fetchFluxInfo(),
                            this.fluxService.fluxInfo$.pipe((0,
                                u.R)(this.unsubscribe), (0,
                                P.h)(t => !!t)).subscribe(t => {
                    ...
                    initGodBalance() {
                        this.imxBalanceService.godsInfo$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            P.h)(t => !!t)).subscribe(t => {
                    ...
                    initWalletAddress() {
                        this.forgeWalletService.selectedWallet$.pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => {
                                this.selectedWallet = t,
                                    this.imxBalanceService.fetchGodsInfo(this.selectedWallet)
                            }
                        )
                    }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "div", 0),
                                e.YNc(1, Sa, 4, 0, "ng-container", 1),
                                e.TgZ(2, "gu-plain-square-button", 2),
                                e.NdJ("click", function () {
                                ...
                                e.TgZ(12, "h2", 10),
                                e._uU(13),
                                e.ALo(14, "formatEther"),
                                e.qZA(),
                                e.qZA(),
                                e.qZA()),
                            2 & t && (e.xp6(1),
                                e.Q6J("ngIf", n.selectedWallet),
                                e.xp6(6),
                                e.hij(" ", e.xi3(8, 3, n.fluxBalance, 2), " "),
                                e.xp6(6),
                                e.hij(" ", n.godsBalance ? e.xi3(14, 6, n.godsBalance, 2) : "-", " "))
                        },
                        directives: [l.O5, vn],
                        pipes: [ye.XX, Zt],
            ...
            , Aa = (() => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "gu-paragraph-text", 0),
                                e._uU(1, " Select the wallet with $GODS and where your new card will be minted.\n"),
                                e.qZA(),
                                e._UZ(2, "cerberus-select-wallet-dropdown", 1),
                                e.TgZ(3, "gu-paragraph-text", 0),
                                e._uU(4, " If your wallet is not there, go to "),
                                e._UZ(5, "gu-simple-text-button", 2),
                                e._uU(6, " to connect it.\n"),
                                e.qZA())
                        },
                        directives: [vn],
        ...
        function Fa(o, r) {
            if (1 & o && (e.O4$(),
                e.TgZ(0, "svg", 1),
                e.TgZ(1, "defs"),
                e.TgZ(2, "linearGradient", 2),
                e._UZ(3, "stop", 3),
                e._UZ(4, "stop", 4),
                e._UZ(5, "stop", 5),
                e.qZA(),
                e.TgZ(6, "linearGradient", 6),
                e._UZ(7, "stop", 7),
                e._UZ(8, "stop", 8),
                e._UZ(9, "stop", 9),
                e.qZA(),
                e.TgZ(10, "linearGradient", 10),
                e._UZ(11, "stop", 11),
                e._UZ(12, "stop", 12),
                e.qZA(),
                e.qZA(),
                e.YNc(13, Za, 1, 6, "circle", 13),
                e._UZ(14, "circle", 14, 15),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.Udp("width", t.width)("height", t.width),
                    e.xp6(13),
                    e.Q6J("ngIf", t.showBackgroundRing),
                    e.xp6(1),
                    e.Udp("r", t.radius)("stroke-width", t.insetInnerStroke ? .33 * t.strokeWidth : t.strokeWidth)("stroke", t.gradientForStroke ? "url(#" + t.gradientForStroke + "-gradient)" : t.strokeColor)("fill", t.fillColor)("stroke-dasharray", t.circumference + " " + t.circumference)("stroke-dashoffset", t.circumferenceOfCircularSegment),
                    e.ekj("progressRing__circle--supressAnimation", t.supressAnimation)
            }
        }
        ...
        let Ft = (() => {
                class o {
                    constructor(t) {
                        this.elRef = t,
                            this.percentage = 0,
                            this.showBackgroundRing = !1,
                            this.supressAnimation = !1,
                            this.insetInnerStroke = !1
                    }
                    ...
                    calcCircle() {
                        this.radius = (this.width - this.strokeWidth) / 2,
                            this.circumference = 2 * Math.PI * this.radius,
                            this.circumferenceOfCircularSegment = this.circumference - this.percentage / 100 * this.circumference
                    }
                }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && e.YNc(0, Fa, 16, 19, "svg", 0),
                            2 & t && e.Q6J("ngIf", n.percentage > 0 || n.showBackgroundRing)
                        },
                        directives: [l.O5],
        ...
        function Ga(o, r) {
            ...
            if (2 & o) {
                const t = e.oxw(2);
                e.xp6(2),
                    e.Q6J("protoId", t.forgeCards.proto)("quality", t.forgeCards.quality)
            }
        }

        function Ba(o, r) {
            if (1 & o && (e.TgZ(0, "div", 7),
                e._UZ(1, "gu-icon", 8),
                e.TgZ(2, "div", 9),
                e._uU(3),
                e.ALo(4, "numberAbbreviation"),
                e.qZA(),
                e.qZA()),
            2 & o) {
                const t = e.oxw(2);
                e.xp6(3),
                    e.hij(" ", e.xi3(4, 1, t.fluxTransactionCost, 2), " ")
            }
        }
        ...
        function La(o, r) {
            ...
            2 & o) {
                const t = e.oxw(2);
                e.xp6(3),
                    e.hij(" ", t.tokenTransactionCost ? e.xi3(4, 1, t.tokenTransactionCost, 2) : "-", " ")
            }
        }

        function Ua(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Ga, 4, 2, "div", 1),
                e.YNc(2, Ba, 5, 4, "div", 2),
                e.YNc(3, La, 5, 4, "div", 2),
                e.BQk()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("ngForOf", t.forgeCards.ids),
                    e.xp6(1),
                    e.Q6J("ngIf", t.fluxTransactionCost),
                    e.xp6(1),
                    e.Q6J("ngIf", t.tokenTransactionCost)
            }
        }

        function qa(o, r) {
            if (1 & o && (e.TgZ(0, "div", 3, 4),
                e._UZ(2, "app-card2", 12),
                e.qZA()),
            2 & o) {
                const t = r.$implicit;
                e.xp6(2),
                    e.Q6J("protoId", t.protoId)("quality", t.quality)
            }
        }

        function Ea(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, qa, 3, 2, "div", 1),
                e.BQk()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("ngForOf", t.fakeForgeCards)
            }
        }
        ...
        let bn = (() => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.YNc(0, Ua, 4, 3, "ng-container", 0),
                                e.YNc(1, Ea, 2, 1, "ng-container", 0)),
                            2 & t && (e.Q6J("ngIf", n.forgeCards),
                                e.xp6(1),
                                e.Q6J("ngIf", !n.forgeCards && n.fakeForgeCards.length))
                        },
        ...
        function Va(o, r) {
            if (1 & o && e._UZ(0, "gu-paragraph-text", 27),
            2 & o) {
                const t = e.oxw();
        ...
        function ja(o, r) {
            1 & o && (e.TgZ(0, "div", 28),
                e._UZ(1, "app-inderterminate-loading"),
                e.qZA())
        }

        const Xa = function (o) {
            return {
                "cardForgeArea__etherscanLink--final": o
            }
        };
        ...
        function Ka(o, r) {
            if (1 & o) {
                ...
                e.TgZ(0, "gu-paragraph-text", 29),
                    ...
                    e._uU(1, " view transaction on etherscan.io "),
                    e.qZA()
            }
            if (2 & o) {
                const t = e.oxw();
                e.Q6J("ngClass", e.VKq(1, Xa, t.completedTransactionTxHash))
            }
        }

        const es = function (o) {
            return {
                cardForgeArea__hideSelectWallet: o
            }
        }
            , ts = function () {
            return {
        ...
        k.p8.registerPlugin(ce);
        const Dt = ({currentQuality: o = "Meteorite", nextQuality: r = "Shadow", count: t = 4} = {}) => ({
        ...
        let is = (() => {
                class o {
                    constructor(t, n, i, a, s, c, d, p, w, v, O, A, G, U, q) {
                        this.authService = t,
                            ...
                            this.cardsService = i,
                            this.modalService = a,
                            this.resizeService = s,
                            this.forgeService = c,
                            this.audioService = d,
                            this.groupingService = p,
                            this.socketService = w,
                            this.fluxService = v,
                            this.ethService = O,
                            this.forgeWalletService = A,
                            this.akuma = G,
                            this.cerberusModalService = U,
                            this.environment = q,
                            this.startTime = +new Date,
                            this.protoCards = [],
                            this.uiStateInformation = {
                                preFuseCicleStrokeColor: "#8be1e0",
                                instructionalMessage: Dt().initial,
                            ...
                            this.fluxBalance = 0,
                            this.mainTL = k.p8.timeline({
                                paused: !0
                            }),
                            this.finalTL = k.p8.timeline({
                                paused: !0
                            }),
                            ...
                            this.unsubscribe = new y.xQ,
                            this.fakeForgeCards = [],
                            this.finalFusePercentage = {
                                value: 0
                            },
                            this.preFusePercentage = {
                                value: 0
                            },
                            this.dog = "woof dog",
                            this.selectedWallet = "",
                    ...
                    logForgeViewed(t) {
                        this.analyticsService.postEvent(new Ee.Forge.Viewed.Event(t)),
                            this.akuma.postEvent("Screen", "forgeHome_opened")
                    }
                    ...
                    ngOnInit() {
                        this.logForgeViewed({
                            ...
                            this.audioService.forgeAmbience.play(),
                            this.initWalletAddress(),
                            this.initFluxBalance(),
                            this.initActiveGrouping(),
                            this.loadCards(),
                            this.initForgeCards(),
                            this.createPreForgeAnimation(),
                            this.initPreviewCardAndAnimationControl()
                    }

                    ngOnDestroy() {
                        this.forgeService.finalizeForging(),
                            this.unsubscribe.next(),
                            this.unsubscribe.complete(),
                            this.audioService.forgeAmbience.stop(),
                            this.resetForge()
                    }
                    ...
                    logEtherscanLink(t) {
                        !t || (console.info("---------------------------------------------------------------"),
                            console.info("|"),
                            console.info("|  Forge transaction underway!"),
                            console.info("|  Check your progress at"),
                            console.info(`|  https://etherscan.io/tx/${t}`),
                            console.info("|"),
                            console.info("---------------------------------------------------------------"))
                    }
                    ...
                    initCards() {
                        this.uiStateInformation.inventoryLoading = !0,
                            (0,
                                ...
                                b.b)(([t, n]) => {
                                    this.inventoryCards = t,
                                        this.protoCards = Array.from(n.values()),
                                        this.uiStateInformation.inventoryLoading = !1
                                }
                            )).subscribe()
                    }
                    ...
                    loadCards() {
                        this.uiStateInformation.inventoryLoading = !0;
                        const t = this.authService.getUserId()
                            , n = this.cardsService.fetchInventoryCardsMapV2(t).pipe((0,
                            x.q)(1), (0,
                            M.U)(i => this.cardsService.inventoryCardsMapV2ToV1(i)));
                        this.cardsService.getProtoCards$().pipe((0,
                            x.q)(1), (0,
                            pe.zg)(i => n.pipe((0,
                            M.U)(a => ({
                            inventory: a,
                            pc: i
                                ...
                                a && a.values && (this.inventoryCards = this.cardsService.convertToCards(a, i),
                                    this.protoCards = Array.from(a.values())),
                                    this.uiStateInformation.inventoryLoading = !1
                            }
                        )
                    }
                    ...
                    animateForgeAreaToUpperPosition() {
                        k.p8.to(this.cardForgeAreaDom.nativeElement, {
                            y: 4.5 * this.vh,
                            ease: "power2.inOut",
                            duration: .3
                        })
                    ...
                    initPreviewCardAndAnimationControl() {
                        this.forgeService.previewCard$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            b.b)(t => {
                                this.previewCard = t,
                                    t ? (this.uiStateInformation.previewLoading = !0,
                                        this.forgeService.validateForge().pipe((0,
                                            x.q)(1)).subscribe(n => {
                                                this.uiStateInformation.previewLoading = !1,
                                                    this.mainTL.play(),
                                                    this.fluxTransactionCost = n.flux_amount,
                                                    this.tokenTransactionCost = n.token_amount
                                            }
                                            , n => {
                                        ...
                                        this.mainTL.seek(0),
                                        this.uiStateInformation.previewLoading = !1,
                                        this.fluxTransactionCost = 0,
                                        this.tokenTransactionCost = "")
                            }
                        )).subscribe()
                    }
                        ...
                        this.forgeService.forgeCards$.pipe((0,
                            ...
                            b.b)(t => {
                                t || (this.fluxTransactionCost = 0,
                                    ...
                                    this.animateForgeAreaToLowerPosition())
                            }
                        ), (0,
                            P.h)(t => {
                                const n = t && t.ids ? t.ids.length : 0
                                    , i = this.uiStateInformation.currentForgeCardCount;
                                return this.uiStateInformation.currentForgeCardCount = n,
                                !!t && n !== i
                            }
                        )).subscribe(t => {
                                this.forgeCards = t,
                                    this.handleUpdatedForgeCards(t)
                            }
                        )
                    }
                    ...
                    handleUpdatedForgeCards(t) {
                        return (0,
                            ...
                            if (n > 0) {
                                ...
                                const s = 100 * n / i;
                                100 !== s && (this.uiStateInformation.disableCta = !0),
                                    this.animateCircularProgress({
                                        preFusePercentage: s
                                    }),
                                    this.animateForgeAreaToUpperPosition()
                            }
                        })
                    }

                    ctaClick() {
                        "Continue" === this.uiStateInformation.ctaText ? (this.forgeService.handleForgeSuccess(),
                            this.forgeService.finalizeForging(),
                            this.resetForge()) : this.queryToStartFusing()
                    }

                    resetForge() {
                        this.loadCards(),
                            this.completedTransactionTxHash = void 0,
                            this.mainTL.pause(),
                            this.mainTL.seek(0),
                            this.finalTL.seek(0),
                            this.finalTL.clear(),
                            this.mainTL.remove(this.finalTL),
                            this.mainTL.remove(this.waitForFuseResponseTL),
                            this.forgeSubmitResult = void 0,
                            this.fakeForgeCards = [],
                            this.preFusePercentage.value = 0,
                            this.finalFusePercentage.value = 0,
                            this.uiStateInformation.ctaText = "Start Fusing",
                            this.uiStateInformation.disableCta = !0,
                            this.uiStateInformation.finalFusingInProgress = !1,
                            this.uiStateInformation.preFuseCicleStrokeColor = "#8be1e0",
                            k.p8.set([this.smokeDom.nativeElement, this.ctaButtonDom.nativeElement, this.cardForgeAreaDom.nativeElement], {
                                clearProps: "all"
                            })
                    }
                    ...
                    startFusing() {
                        this.uiStateInformation.finalFusingInProgress = !0,
                            this.waitForFinalFuseResponseAnimation(),
                            this.forgeService.submitForge().pipe((0,
                                x.q)(1)).subscribe(t => {
                                    this.finalStageFuseAnimation(t.request_id),
                                        this.fluxService.fetchFluxInfo()
                                }
                                , t => {
                                    console.error("Forge->startFusing() FORGE SUBMIT error", t),
                    ...
                    handleFuseFailure(t) {
                        this.clearTransactionInProgress(),
                            console.error("Forge->handleFuseFailure()", t),
                            this.resetForge(),
                            this.forgeService.finalizeForging(),
                            this.handleValidationFail(t.error.error)
                    }
                    ...
                    waitForFinalFuseResponseAnimation() {
                        const t = this.finalCircularFuseDom.elRef.nativeElement
                            , n = this.previewCardDom.nativeElement;
                        this.waitForFuseResponseTL = k.p8.timeline({
                            repeat: -1,
                            paused: !0
                        }),
                            this.waitForFuseResponseTL.add(() => {
                                    this.uiStateInformation.disableCta = !0,
                                        this.uiStateInformation.ctaText = "Fusing ..."
                                }
                            ).set(t, {
                                opacity: 1
                            }).to(n, {
                            ...
                            this.mainTL.pause(),
                            this.mainTL.add(this.waitForFuseResponseTL.play(), "previewCardFloating"),
                            this.mainTL.play()
                    }
                    ...
                    finalStageFuseAnimation(t) {
                        const n = this.forgeCardsDom.forgeCardDoms.toArray().map(c => c.nativeElement)
                            , i = this.previewCardDom.nativeElement
                            , a = this.shimmerAreaDom.nativeElement
                            , s = this.ctaButtonDom.nativeElement;
                        this.waitForFuseResponseTL.kill(),
                            this.uiStateInformation.preFuseCicleStrokeColor = "#c6a052",
                            this.finalFusePercentage.value = 0,
                            this.fluxTransactionCost = 0,
                            this.tokenTransactionCost = "",
                            this.finalTL = k.p8.timeline({
                            ...
                            this.finalTL.to(this.cardForgeAreaDom.nativeElement, {
                                duration: .3,
                                y: 13 * this.vh,
                                ease: "power2.inOut"
                            }).to(i, {
                                ...
                                onComplete: () => {
                                    this.uiStateInformation.disableCta = !0,
                                        this.uiStateInformation.ctaText = "Continue"
                                }
                                ...
                                duration: .1,
                                opacity: 0
                            }, "restingState+=1.8").add(() => this.audioService.ForgeFuseContinue.play(), "restingState+=1.9"),
                            this.mainTL.pause(),
                            this.mainTL.add(this.finalTL.play(), "previewCardFloating"),
                            this.mainTL.play("previewCardFloating")
                    }
                    ...
                    goToWebsiteModal(t) {
                        ...
                        i.title = "YOU\u2019RE NOT DONE YET",
                            i.content = "You still need to confirm with your web wallet. The fusing process will continue in your browser.",
                            i.primaryButton = {
                                text: '\n      CONTINUE&nbsp;\n      <span>\n        <gu-icon\n          style="display: inline-flex;"\n          iconLigature="leave_website"\n          fillColor="colors.light.100">\n        </gu-icon\n      </span>\n      ',
                                closeOnClick: !0,
                                onClick: () => {
                                    this.openForgeWebsite(t),
                                        this.forgeService.handleForgeSuccess(),
                                        this.forgeService.finalizeForging(),
                                        this.resetForge()
                                }
                            }
                    ...
                    createPreForgeAnimation() {
                        const t = this.previewCardDom.nativeElement
                            , n = this.shimmerAreaDom.nativeElement
                            , i = k.p8.timeline({
                            repeat: -1,
                            paused: !0
                        });
                        i.to([n, t], {
                            ...
                            this.mainTL.set([n, t], {
                                ...
                                onComplete: () => {
                                    this.uiStateInformation.previewLoading = !1,
                                        this.uiStateInformation.disableCta = !1
                                }
                    ...
                    animateCircularProgress({preFusePercentage: t, duration: n = .65}) {
                        return new Promise(i => {
                                this.circularTween && this.circularTween.kill(),
                                    this.circularTween = k.p8.to(this.preFusePercentage, {
                                        value: t,
                                        ease: "power2.inOut",
                                        onComplete: () => {
                                            this.uiStateInformation = Object.assign({}, this.uiStateInformation),
                                                this.preFusePercentage.value = t,
                                                i()
                                        }
                                        ,
                                        duration: n
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "cerberus-forge-card-list", 0),
                                e.TgZ(1, "div", 1),
                                e._UZ(2, "cerberus-forge-area-header"),
                                e._UZ(3, "cerberus-forge-area-select-wallet", 2),
                                e.TgZ(4, "div", 3),
                                e.TgZ(5, "div", 4, 5),
                                e._UZ(7, "app-progress-circle", 6),
                                e._UZ(8, "app-progress-circle", 7, 8),
                                e.YNc(10, Va, 1, 1, "gu-paragraph-text", 9),
                                e.TgZ(11, "gu-primary-hex-button", 10, 11),
                                e.NdJ("click", function () {
                                    return n.ctaClick()
                                }),
                                e.qZA(),
                                e.YNc(13, ja, 2, 0, "div", 12),
                                e.TgZ(14, "div", 13, 14),
                                e._UZ(16, "img", 15, 16),
                                e._UZ(18, "app-card2", 17, 18),
                                e.TgZ(20, "div", 19, 20),
                                e._UZ(22, "i", 21, 22),
                                e.qZA(),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(24, "gu-vertical-space", 23),
                                e.YNc(25, Ka, 2, 3, "gu-paragraph-text", 24),
                                e.qZA(),
                                e._UZ(26, "cerberus-app-forge-cards", 25, 26),
                                e.qZA(),
                                e.qZA()),
                            2 & t && (e.ekj("cardBrowserArea--disabled", n.uiStateInformation.finalFusingInProgress || n.uiStateInformation.previewLoading || !n.selectedWallet),
                                e.Q6J("expandedViewMode", n.ExpandedViewMode.FORGING)("activeGrouping", n.activeGrouping)("protoCards", n.protoCards)("inventoryCards", n.inventoryCards),
                                e.xp6(3),
                                e.Q6J("ngClass", e.VKq(34, es, n.selectedWallet)),
                                e.xp6(1),
                                e.Q6J("hidden", !n.selectedWallet),
                                e.xp6(3),
                                e.Q6J("percentage", n.preFusePercentage.value)("width", 29 * n.vw)("strokeWidth", 2 * n.vh)("showBackgroundRing", !0)("supressAnimation", !0)("strokeColor", n.uiStateInformation.preFuseCicleStrokeColor)("insetInnerStroke", !0),
                                e.xp6(1),
                                e.Q6J("percentage", n.finalFusePercentage.value)("width", 29 * n.vw)("strokeWidth", 2 * n.vh)("showBackgroundRing", !1)("supressAnimation", !0)("insetInnerStroke", !0),
                                e.xp6(2),
                                e.Q6J("ngIf", n.uiStateInformation.instructionalMessage && !n.uiStateInformation.previewLoading && !n.uiStateInformation.finalFusingInProgress),
                                e.xp6(1),
                                e.Q6J("text", n.uiStateInformation.ctaText),
                                e.uIk("disabled", n.uiStateInformation.disableCta),
                                e.xp6(2),
                                e.Q6J("ngIf", n.uiStateInformation.previewLoading),
                                e.xp6(5),
                                e.Q6J("protoId", null == n.previewCard ? null : n.previewCard.protoId)("quality", null == n.previewCard ? null : n.previewCard.quality),
                                e.xp6(6),
                                e.Q6J("responsiveSize", e.WLB(38, os, e.DdM(36, ts), e.DdM(37, ns))),
                                e.xp6(1),
                                e.Q6J("ngIf", (null == n.transactionInProgress ? null : n.transactionInProgress.txHash) || n.completedTransactionTxHash),
                                e.xp6(1),
                                e.ekj("cardForgeArea__cardsToBeFused--disabled", n.uiStateInformation.finalFusingInProgress),
        ...
        function cs(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "div", 5),
                    e.TgZ(1, "gu-primary-hex-button", 6),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().onOkCLick()
                    }),
            ...
            if (2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("disabled", t.loading)("text", t.okButtonText)
            }
        }
        ...
        let xn = (() => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.YNc(0, as, 2, 1, "div", 0),
                                e.YNc(1, ss, 2, 1, "div", 1),
                                e.YNc(2, cs, 4, 2, "div", 2)),
                            2 & t && (e.Q6J("ngIf", n.title),
                                e.xp6(1),
                                e.Q6J("ngIf", n.message),
                                e.xp6(1),
                                e.Q6J("ngIf", n.showButtons))
                        },
                        directives: [l.O5],
        ...
        const ls = ["previewCardAreaDom"]
            ...
            , hs = ["ctaButton"]
            , ms = ["forgeCards"]
            , fs = ["finalCircularFuse"];

        function Cs(o, r) {
            if (1 & o && e._UZ(0, "gu-paragraph-text", 33),
            2 & o) {
                const t = e.oxw();
                e.Q6J("innerHTML", t.uiStateInformation.instructionalMessage, e.oJD)
            }
        ...
        function ws(o, r) {
            ...
            if (2 & o) {
                const t = e.oxw();
                e.Q6J("ngClass", e.VKq(1, bs, t.completedTransactionTxHash))
            }
        }

        k.p8.registerPlugin(ce);
        const Bt = ({currentQuality: o = "Meteorite", nextQuality: r = "Shadow", count: t = 4} = {}) => ({
            initial: "Select a card to begin...",
            midway: `Select ${t} more <span>${o}</span> ${t > 1 ? "cards" : "card"} to forge a <span>${r}</span> card.`
        });
        let Mn = (() => {
                class o {
                    constructor(t, n, i, a, s, c, d, p, w, v, O, A, G) {
                        this.authService = t,
                            this.analyticsService = n,
                            this.cardsService = i,
                            this.modalService = a,
                    ...
                    ngOnInit() {
                        this.forgeService.transactionInProgress$.pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => this.transactionInProgress = t),
                            this.logForgeViewed({
                                can_fuse: !1,
                                end_time: this.endTime = +new Date,
                                flux: 0,
                            ...
                            this.createPreForgeAnimation(),
                            this.initPreviewCardAndAnimationControl(),
                            this.initPreviousTransactionFromStorage()
                    }
                    ...
                    initPreviousTransactionFromStorage() {
                        if (this.transactionInProgress) {
                            if (!this.transactionInProgress.txHash)
                                return void this.clearTransactionInProgress();
                            this.uiStateInformation.finalFusingInProgress = !0,
                                this.animateCircularProgress({
                                    preFusePercentage: 100
                                }),
                                this.animateForgeAreaToUpperPosition(),
                                this.previewCard = {
                                ...
                                this.waitForFinalFuseResponseAnimation(),
                                this.logEtherscanLink(this.transactionInProgress.txHash),
                                (0,
                                    D.aj)([this.ethService.getTransaction$(this.transactionInProgress.txHash), this.ethService.getTransactionReceipt$(this.transactionInProgress.txHash)]).pipe((0,
                                    x.q)(1)).subscribe(([, t]) => {
                    ...
                    handleSuccessfulPreviousFuse() {
                        this.clearTransactionInProgress(),
                            this.forgeSubmitResult = "success",
                            this.fluxService.fetchFluxInfo(),
                            this.finalStageFuseAnimation(),
                            this.cardsService.setNewInventoryCardCount(1)
                    }
                                    ...
                                    t ? (this.uiStateInformation.previewLoading = !0,
                                        this.forgeService.validateForge().pipe((0,
                                            x.q)(1)).subscribe(n => {
                                                this.uiStateInformation.previewLoading = !1,
                                                    this.mainTL.play(),
                                                    this.fluxTransactionCost = n.flux_cost
                                            }
                                            , n => {
                                                this.handleValidationFail(n.error.error)
                                            }
                    ...
                    queryToStartFusing() {
                        this.modalService.createModal(xn, {
                            ...
                            position: h.e1.Custom,
                            customPosition: ".cardForgeArea__ctaButton:bottom"
                        })
                    }

                    startFusing() {
                        this.uiStateInformation.finalFusingInProgress = !0,
                            this.forgeService.setTransactionInProgress(Object.assign(Object.assign({}, this.forgeCards), {
                                reference: (0,
                                    rs.v4)()
                            })),
                            this.waitForFinalFuseResponseAnimation(),
                            this.forgeService.submitForge().pipe((0,
                                x.q)(1), (0,
                                me.w)(t => (this.forgeService.setTransactionInProgress(Object.assign(Object.assign({}, this.transactionInProgress), {
                                txHash: t
                            })),
                                this.logEtherscanLink(this.transactionInProgress.txHash),
                                this.forgeService.postTxHashForTracking({
                                    tx_hash: t,
                    ...
                    openSocketConnection() {
                        const t = i => {
                            this.socketMessagesSubscription = i.pipe((0,
                                u.R)(this.unsubscribe)).subscribe(a => this.handleSocketMessage(a))
                        }
                    ...
                    handleSocketConfirm(t) {
                        if (t >= 2) {
                            this.stopSocket(),
                                this.forgeSubmitResult = "success",
                                this.cardsService.setNewInventoryCardCount(1);
                            const n = this.fluxBalance - this.fluxTransactionCost
                                , i = this.transactionInProgress.keptId
                                , a = this.transactionInProgress.proto;
                            this.cardsService.getProtoCard(a).pipe((0,
                                x.q)(1)).subscribe(s => this.logForgeCompleted({
                                card_properties: s,
                                keep_id: i,
                                ...
                                this.fluxService.fetchFluxInfo(),
                                this.completedTransactionTxHash = this.transactionInProgress.txHash,
                                this.clearTransactionInProgress(),
                                this.finalStageFuseAnimation()
                        }
                    }
                    ...
                    handleSocketMessage(t) {
                        ...
                        if ((0,
                            se._T)(t, ["status", "confirmations", "reference"]),
                        !this.transactionInProgress || a !== this.transactionInProgress.reference)
                            return !1;
                        switch (n) {
                            case "not_found":
                    ...
                    stopSocket() {
                        ...
                        this.socketMessagesSubscription && this.socketMessagesSubscription.unsubscribe()
                    }

                    handleValidationFail(t) {
                        console.error("Forge->handleValidationFail()", t),
                        "You are locked from fusing because our bot prevention system detected unusual behavior" === t && this.modalService.createModal(_n.n, {}, {
                            blurredBackground: !0,
                            canCloseFromInside: !1,
                            position: h.e1.Center,
                    ...
                    finalStageFuseAnimation() {
                        const t = this.forgeCardsDom.forgeCardDoms.toArray().map(s => s.nativeElement)
                            , n = this.previewCardDom.nativeElement
                            , i = this.shimmerAreaDom.nativeElement
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "cerberus-half-screen-cards-list", 0),
                                e.TgZ(1, "div", 1),
                                e.TgZ(2, "h1", 2),
                                e._uU(3, " The Forge "),
                                e.qZA(),
                                ...
                                e.qZA(),
                                e.TgZ(17, "div", 10, 11),
                                e._UZ(19, "app-progress-circle", 12),
                                e._UZ(20, "app-progress-circle", 13, 14),
                                e.YNc(22, Cs, 1, 1, "gu-paragraph-text", 15),
                                e.TgZ(23, "gu-primary-hex-button", 16, 17),
                                e.NdJ("click", function () {
                                    return n.ctaClick()
                                }),
                                e.qZA(),
                                e.YNc(25, vs, 2, 0, "div", 18),
                                e.TgZ(26, "div", 19, 20),
                                e._UZ(28, "img", 21, 22),
                                e._UZ(30, "app-card2", 23, 24),
                                e.TgZ(32, "div", 25, 26),
                                e._UZ(34, "i", 27, 28),
                                e.qZA(),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(36, "gu-vertical-space", 29),
                                e.YNc(37, ws, 2, 3, "gu-paragraph-text", 30),
                                e.qZA(),
                                e._UZ(38, "cerberus-app-forge-cards", 31, 32),
                                e.qZA()),
                            2 & t && (e.ekj("cardBrowserArea--disabled", n.uiStateInformation.finalFusingInProgress || n.uiStateInformation.previewLoading),
                                e.Q6J("expandedViewMode", n.ExpandedViewMode.FORGING)("activeGrouping", n.activeGrouping)("protoCards", n.protoCards)("inventoryCards", n.inventoryCards),
                                e.xp6(10),
                                e.hij(" ", e.xi3(11, 31, n.fluxBalance, 2), " "),
                                e.xp6(9),
                                e.Q6J("percentage", n.preFusePercentage.value)("width", 29 * n.vw)("strokeWidth", 2 * n.vh)("showBackgroundRing", !0)("supressAnimation", !0)("strokeColor", n.uiStateInformation.preFuseCicleStrokeColor)("insetInnerStroke", !0),
                                e.xp6(1),
                                e.Q6J("percentage", n.finalFusePercentage.value)("width", 29 * n.vw)("strokeWidth", 2 * n.vh)("showBackgroundRing", !1)("supressAnimation", !0)("insetInnerStroke", !0),
        ...
        function xs(o, r) {
            1 & o && (e.ynx(0),
                e._UZ(1, "cerberus-forge-next-step"),
                e.BQk())
        }
        ...
        let ys = (() => {
                class o {
                    constructor(t) {
                        this.featureFlagsService = t,
                            this.unsubscribe = new y.xQ,
                            this.Flags = _.vU,
                            this.ffFusingNextStepEnabled = !1
                    }
                    ...
                    setFusingNextStepEnabledFF() {
                        this.featureFlagsService.get(_.vU.fusingNextStepEnabled).pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            if (1 & t && (e.YNc(0, xs, 2, 0, "ng-container", 0),
                                e.YNc(1, Ms, 1, 0, "ng-template", null, 1, e.W1O)),
                            2 & t) {
                                const i = e.MAs(2);
                                e.Q6J("ngIf", n.ffFusingNextStepEnabled)("ngIfElse", i)
                            }
                        },
                        directives: [l.O5, is, Mn],
        ...
        function ks(o, r) {
            if (1 & o && e._UZ(0, "gu-reward-display", 11),
            2 & o) {
                const t = e.oxw().$implicit;
        ...
        function Os(o, r) {
            if (1 & o && e._UZ(0, "gu-reward-display", 12),
            2 & o) {
                const t = e.oxw().$implicit;
                e.Q6J("text", t.title)
            }
        ...
        function Ps(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, ks, 1, 2, "gu-reward-display", 9),
                e.YNc(2, Os, 1, 1, "gu-reward-display", 10),
                e.BQk()),
            2 & o) {
                const t = r.$implicit;
                e.xp6(1),
                    e.Q6J("ngIf", "image" === t.type),
                    e.xp6(1),
                    e.Q6J("ngIf", "stars" === t.type)
            }
        }
        ...
        let yn = (() => {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "div", 0),
                                ...
                                e._UZ(2, "img", 2),
                                e.TgZ(3, "gu-heading-text", 3),
                                e._uU(4, " Collect your rewards! "),
                                e.qZA(),
                                e._UZ(5, "img", 4),
                                e.qZA(),
                                e.TgZ(6, "gu-paragraph-text", 5),
                                e._uU(7, " These items have been added to your inventory.\n"),
                                e.qZA(),
                                e.TgZ(8, "gu-vertical-space", 6),
                                e.YNc(9, Ps, 3, 2, "ng-container", 7),
                                e.qZA(),
                                e.TgZ(10, "gu-primary-hex-button", 8),
                                e.NdJ("click", function () {
                                    return n.close()
                                }),
                                e.qZA()),
                            2 & t && (e.xp6(9),
                                e.Q6J("ngForOf", n.rewards))
                        },
            ...
            , Ss = (() => {
                class o {
                    ...
                    close() {
                        this.storageService.set(["_USER_NOTIFIED"], !0),
                            this.activeModal.close("CTA closed")
                    }
                }
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "gu-icon", 0),
                                ...
                                e._UZ(1, "div", 1),
                                e.TgZ(2, "div", 2),
                                e.TgZ(3, "gu-vertical-space", 3),
                                e.TgZ(4, "gu-heading-text", 4),
                                e._uU(5, " WEEKEND RANKED UPDATE"),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(6, "gu-vertical-space", 5),
                                e.TgZ(7, "gu-paragraph-text", 6),
                                e.TgZ(8, "ul"),
                                e.TgZ(9, "li"),
                                e._uU(10, " Weekend Ranked is cancelled due to card issues brought on by Update 0.26. "),
                                e.qZA(),
                                e.TgZ(11, "li"),
                                e._uU(12, " The following weekend will host a double rewards Weekend Ranked event. "),
                                e.qZA(),
                                e.qZA(),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(13, "div", 7),
                                e.TgZ(14, "gu-primary-hex-button", 8),
                                e.NdJ("click", function () {
                                    return n.close()
                                }),
                                e._uU(15, " CLOSE "),
        ...
        function Fs(o, r) {
            if (1 & o && e._UZ(0, "img", 24),
            2 & o) {
                const t = e.oxw().$implicit
                    , n = e.oxw();
                e.Q6J("ngClass", e.WLB(2, Zs, !n.isFinalLevel(t.level), n.isFinalLevel(t.level)))("src", n.isFinalLevel(t.level) ? "/gu-assets/images/rewards-progress/final-empty-point.png" : "/gu-assets/images/rewards-progress/empty-point.png", e.LSH)
            }
        }
        ...
        function Ds(o, r) {
            if (1 & o && (e.ynx(0),
                e.TgZ(1, "div"),
                e.TgZ(2, "gu-simple-text", 25),
                e.TgZ(3, "strong"),
                e._uU(4),
                e.qZA(),
                e.qZA(),
                e.TgZ(5, "gu-simple-text", 26),
                e._uU(6),
                e.ALo(7, "titlecase"),
                e.qZA(),
                e.qZA(),
            ...
            2 & o) {
                ...
                e.xp6(4),
                    e.Oqu(t.count),
                    e.xp6(2),
                    e.hij(" x ", e.lcZ(7, 2, "neutral" === t.god ? t.rarity : t.god), " Packs ")
            }
        }

        const Gs = function (o, r) {
            return {
                progressBarContainer__nextReward__level: o,
                progressBarContainer__lastReward__level: r
            }
        };

        function Bs(o, r) {
            if (1 & o && (e.TgZ(0, "div", 14),
                e._UZ(1, "reward-state", 15),
                e.YNc(2, As, 1, 0, "div", 16),
                e.TgZ(3, "picture"),
                e.YNc(4, Is, 1, 1, "img", 17),
                e.YNc(5, Fs, 1, 5, "img", 18),
                e.qZA(),
                e.TgZ(6, "gu-paragraph-text", 19),
                e._uU(7),
                e.qZA(),
                e.TgZ(8, "div", 20),
                e.YNc(9, Ds, 8, 4, "ng-container", 21),
                e.qZA(),
                e.qZA()),
            2 & o) {
                const t = r.$implicit
                    , n = e.oxw();
                e.xp6(1),
                    e.Q6J("rewardLevel", t.level)("isAchieved", t.achieved)("playerLevel", n.currentPlayerlevel)("finalRewardLevel", 6)("diety", n.getDietyType(t.reward)),
                    e.xp6(1),
                    e.Q6J("ngIf", t.achieved),
                    e.xp6(2),
                    e.Q6J("ngIf", t.achieved),
                    e.xp6(1),
                    e.Q6J("ngIf", !t.achieved),
                    e.xp6(1),
                    e.Q6J("ngClass", e.WLB(11, Gs, !n.isFinalLevel(t.level), n.isFinalLevel(t.level))),
                    e.xp6(1),
                    e.hij(" Level ", t.level, ""),
                    e.xp6(2),
                    e.Q6J("ngForOf", t.reward)
            }
        }
        ...
        let kn = (() => {
                class o {
                    ...
                    ngOnInit() {
                        this.akumaService.postScreenEvent("quest", "NewPlayerRewards", "", "opened"),
                            this.userService.extendedAccountProperties$.pipe((0,
                                Ut.M)(this.progressionService.accountThresholds$), (0,
                                u.R)(this.unsubscribe)).subscribe(([t, n]) => {
                                    this.newPlayerRewards = n.slice(1, 7).map(i => {
                                            let a = i;
                                            return this.currentPlayerlevel = t.level,
                                                this.currentPlayerlevel >= a.level ? (a.achieved = !0,
                                                    this.progressBarPercent += a.level > 1 ? 20 : 0) : a.achieved = !1,
                                                a
                                        }
                                    )
                                }
                    ...
                    openPacks() {
                        this.akumaService.postControlEvent("quest", "NewPlayerRewards", "", "openPacks", "Btn", "pressed"),
                            this.akumaService.postFlowEvent("questRewardClaim", "succeeded"),
                            this.router.navigate([Qe.gv.routeContent(this.environment).openPacks.path])
                    }
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "gu-icon", 0),
                                ...
                                e.qZA(),
                                e.TgZ(4, "div", 4),
                                e.TgZ(5, "gu-heading-text", 5),
                                e._uU(6, " Player Progress "),
                                e.qZA(),
                                e.TgZ(7, "gu-heading-text", 6),
                                e._UZ(8, "gu-icon", 7),
                                e._uU(9, " New Player Rewards "),
                                e.qZA(),
                                e.TgZ(10, "gu-simple-text", 8),
                                e._uU(11, " Earn up to "),
                                e.TgZ(12, "strong"),
                                e._uU(13, "24 CORE PACKS"),
                                e.qZA(),
                                e._uU(14, " by playing ranked matches. "),
                                e.qZA(),
                                e.TgZ(15, "div", 9),
                                e._UZ(16, "app-progress-bar", 10),
                                e.TgZ(17, "div", 11),
                                e.YNc(18, Bs, 10, 14, "div", 12),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(19, "gu-primary-hex-button", 13),
                                e.NdJ("click", function () {
                                    return n.openPacks()
                                }),
                                e.qZA(),
                                e.qZA()),
                            2 & t && (e.xp6(16),
                                e.Q6J("percentage", n.progressBarPercent)("height", 12)("showDivider", !1)("animateFirstValue", !0),
                                e.xp6(2),
                                e.Q6J("ngForOf", n.newPlayerRewards))
                        },
        ...
        function Ls(o, r) {
            if (1 & o && (e.TgZ(0, "gu-heading-text", 14),
                e._uU(1),
                e.qZA()),
            2 & o) {
                const t = e.oxw(2);
                e.xp6(1),
                    e.hij(" ", null == t.account ? null : t.account.username + ' - ' + t.user.user_id, " ")
            }
        }

        function Us(o, r) {
            if (1 & o && (e.TgZ(0, "gu-heading-text", 15),
                e._uU(1),
                e.qZA()),
            2 & o) {
                const t = e.oxw(2);
        ...
        function Es(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "div", 16),
                    e.TgZ(1, "gu-simple-text", 17),
                    e._uU(2),
                    e.qZA(),
                    e._UZ(3, "gu-hex-progress-bar", 18),
                    e.TgZ(4, "div", 19),
                    e.NdJ("click", function () {
                        e.CHM(t);
                        const i = e.oxw(2);
                    ...
                    e.TgZ(5, "app-tooltip", 20),
                    e._UZ(6, "i", 21),
                    e._UZ(7, "gu-card-pack-picture", 22),
                    e.qZA(),
                    e.qZA(),
                    e.qZA()
            }
            if (2 & o) {
                ...
                e.xp6(2),
                    ...
                    e.xp6(2),
                    e.Q6J("autoClose", !t.isNewUserWithUnopenedPacks)("title", t.isNewUserWithUnopenedPacks ? "Click to see <br/> unlocked rewards" : t.nextReward.god + " Core " + t.nextReward.rarity + " pack"),
                    e.xp6(1),
                    e.Q6J("ngClass", e.VKq(7, qs, t.isNewUserWithUnopenedPacks)),
                    e.xp6(1),
                    e.Q6J("god", t.nextReward.god)("rarity", t.nextReward.rarity)
            }
        }

        function Ns(o, r) {
            if (1 & o && (e.ynx(0), e.TgZ(1, "div", 1), e._UZ(2, "img", 2), e.qZA(), e.TgZ(3, "div", 3), e.TgZ(4, "div", 4), e.TgZ(5, "gu-simple-text", 5), e._uU(6), e.qZA(), e.YNc(7, Ls, 2, 1, "gu-heading-text", 6), e.YNc(8, Us, 2, 1, "gu-heading-text", 7), e.TgZ(9, "div", 8), e.TgZ(10, "div", 9), e._UZ(11, "gu-icon", 10), e.TgZ(12, "gu-paragraph-text", 11), e._uU(13), e.qZA(), e.qZA(), e.TgZ(14, "div", 9), e._UZ(15, "gu-icon", 12), e.TgZ(16, "gu-paragraph-text", 11), e._uU(17), e.qZA(), e.qZA(), e.qZA(), e.qZA(), e.qZA(), e.YNc(18, Es, 8, 9, "div", 13), e.BQk()),
            2 & o) {
                const t = e.oxw();
        ...
        let On = (() => {
                class o {
                    constructor(t, n, i, a, s, c) {
                        this.guUserService = t,
                            this.progressionService = n,
                            this.packService = i,
                            this.authService = a,
                            this.cerberusModalService = s,
                            this.akumaService = c,
                            this.showProgressBar = !0,
                            this.unsubscribe = new y.xQ,
                            this.xpProgress = 0,
                            this.isNewUserWithUnopenedPacks = !1,
                            this.isNewUserEligibleForRewards = !1
                    }
                    ...
                    initUnopenedPacks() {
                        this.packService.fetchUnopenedPacks(),
                            this.packService.unopenedPacks$.pipe((0,
                                Ut.M)(this.guUserService.extendedAccountProperties$), (0,
                                u.R)(this.unsubscribe)).subscribe(([t, n]) => {
                                    this.isNewUserEligibleForRewards = n.extra.progression_version === lt.v1 && n.level <= 6,
                                    this.isEligibleUserWithUnopenedPacks(t, n) && (this.isNewUserWithUnopenedPacks = !0,
                                        this.akumaService.postScreenEvent("arena", "PopNewRewardsUnlocked", "", "opened"),
                                        this.akumaService.postFlowEvent("questNotification", "started"))
                                }
                            )
                    }
                    ...
                    initUserDetails() {
                        (0,
                            D.aj)([this.guUserService.extendedAccountProperties$, this.authService.account$, this.progressionService.accountThresholds$]).pipe((0,
                            u.R)(this.unsubscribe), (0,
                            P.h)(([t, n, i]) => !!i.length && !!n)).subscribe(([t, n, i]) => {
                                this.account = n,
                                    this.user = t,
                                    this.userNameContainsEmoji = Ts.uA.stringContainsEmoji(this.account.username),
                                    this.xpProgress = ot({
                                        xp: t.total_xp,
                                        levelThresholds: i
                                    });
                    ...
                    openRewardsModal() {
                        ...
                        this.akumaService.postControlEvent("arena", "PopNewRewardsUnlocked", "", "rewardPop", "Btn", "pressed"),
                            this.akumaService.postFlowEvent("questNotification", "succeeded"),
                            this.akumaService.postFlowEvent("questRewardClaim", "started"),
                            t.result.then(i => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && e.YNc(0, Ns, 19, 9, "ng-container", 0),
                            2 & t && e.Q6J("ngIf", n.user)
                        },
        ...
        var Je = (() => {
                return (o = Je || (Je = {})).standardPlayer = "standardPlayer",
                    o.streamer = "streamer",
                    Je;
                var o
            }
        ...
        class Rs {
            constructor(r, t, n, i, a, s, c) {
                this.title = r,
                    ...
                    this.imageURL = n,
                    this.linkURL = i,
                    this.startTimestamp = Date.parse(a),
                    this.endTimestamp = Date.parse(s),
                    this.priority = c
            }
        }
        ...
        let Pn = (() => {
                class o {
                    ...
                    loadData() {
                        this.gameApi.get("/news").pipe((0,
                            M.U)(t => this.convertToNewsItems(t)), (0,
                            b.b)(t => {
                                this.dataStore.newsItems = t,
                                    this._newsItems$.next(this.dataStore.newsItems)
                            }
                        )).subscribe()
                    }

                    convertToNewsItems(t) {
                        return t.map(n => new Rs(n.title, n.description, n.image_url, n.link_url, n.start_timestamp, n.end_timestamp, n.priority))
                    }
                }
        ...
        function Qs(o, r) {
            1 & o && (e.TgZ(0, "figure", 2),
                e._UZ(1, "img", 3),
                e.TgZ(2, "figcaption", 4),
                e.TgZ(3, "h6", 5),
                e._uU(4, "Marketplace Overlay"),
                e.qZA(),
                e.TgZ(5, "div", 6),
                e._uU(6, " Want to sell your content in your stream? "),
                e.qZA(),
                e.qZA(),
                e._UZ(7, "gu-primary-hex-button", 7),
                e.qZA())
        }
        ...
        function Hs(o, r) {
            if (1 & o) {
                ...
                e.TgZ(0, "figure", 2),
                    ...
                    e.qZA(),
                    e.qZA(),
                    e.TgZ(7, "gu-primary-hex-button", 9),
                    e.NdJ("click", function () {
                        e.CHM(t);
                        const i = e.oxw().$implicit;
        ...
        function Ys(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Hs, 8, 3, "figure", 0),
                e.BQk()),
            2 & o) {
                const t = r.$implicit
                    , n = e.oxw();
                e.xp6(1),
                    e.Q6J("ngIf", n.canDisplay(t))
            }
        }
        ...
        let Js = (() => {
                class o {
                    ...
                    canDisplay(t) {
                        ...
                        let i = !0
                            , a = !1;
                        return t.startTimestamp && n < t.startTimestamp && (i = !1),
                        t.endTimestamp && n > t.endTimestamp && (a = !0),
                        i && !a
                    }

                    gotoNewsItem(t) {
                        this.akumaService.postControlEvent("gu", "Arena", "", "blog", "Btn", "pressed"),
                            window.location.href = t.linkURL
                    }
                }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.YNc(0, Qs, 8, 0, "figure", 0),
                                e.YNc(1, Ys, 2, 1, "ng-container", 1)),
                            2 & t && (e.Q6J("ngIf", (null == n.newsItems ? null : n.newsItems.length) > 0 && n.isUserStreamer()),
                                e.xp6(1),
                                e.Q6J("ngForOf", n.newsItems))
                        },
            ...
            , Sn = (() => {
                class o {
                    constructor(t) {
                        this.contentService = t,
                            this.source = "default",
                            this.userType = Je.standardPlayer,
                            this.unsubscribe = new y.xQ
                    }
                    ...
                    ngOnInit() {
                        this.contentService.newsItems$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            P.h)(t => null !== t), (0,
                            b.b)(t => {
                    ...
                    sortNews(t) {
                        return t.sort((n, i) => {
                                ...
                                return 0 === a && (a = (n.startTimestamp ? n.startTimestamp : 0) - (i.startTimestamp ? i.startTimestamp : 0)),
                                    a
                            }
                        )
                    }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && e._UZ(0, "app-news-list", 0),
                            2 & t && e.Q6J("userType", n.userType)("newsItems", n.newsItems)
                        },
                        directives: [Js],
                        styles: ["[_nghost-%COMP%]{display:block}"]
                    }),
        ...
        function Xs(o, r) {
            if (1 & o && (e.ynx(0),
                e.TgZ(1, "div", 6),
                e.YNc(2, zs, 1, 0, "gu-icon", 7),
                e.qZA(),
                e.TgZ(3, "div", 8),
                e.YNc(4, Vs, 1, 0, "gu-icon", 7),
                e.qZA(),
                e.TgZ(5, "div", 9),
                e.YNc(6, js, 1, 0, "gu-icon", 7),
                e.qZA(),
                e.BQk()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.ekj("winCircle--complete", t.wins >= 2),
                    e.xp6(1),
                    e.Q6J("ngIf", t.wins >= 2),
                    e.xp6(1),
                    e.ekj("winCircle--complete", t.wins >= 1),
                    e.xp6(1),
                    e.Q6J("ngIf", t.wins >= 1),
                    e.xp6(1),
                    e.ekj("winCircle--complete", t.wins >= 3),
                    e.xp6(1),
                    e.Q6J("ngIf", t.wins >= 3)
            }
        }
        ...
        let Tn = (() => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "div", 0),
                                e.YNc(1, $s, 2, 3, "img", 1),
                                e.YNc(2, Ws, 1, 0, "gu-icon", 2),
                                e.YNc(3, Xs, 7, 9, "ng-container", 3),
                                e.qZA()),
                            2 & t && (e.xp6(1),
                                e.Q6J("ngIf", n.god),
                                e.xp6(1),
            ...
            , An = (() => {
                class o {
                    transform(t, n, i = !0) {
                        if (t) {
                            let a = Math.floor((+new Date(t) - +new Date(n)) / 1e3)
                                , c = "";
                            return [{
                                unit: 86400,
                                symbol: "d"
        ...
        function Ks(o, r) {
            if (1 & o && e._UZ(0, "app-flux-god-portrait", 20),
            2 & o) {
                const t = r.$implicit
                    , n = e.oxw();
        ...
        function ec(o, r) {
            ...
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.hij(" New Gauntlet begins in ", e.Dn7(2, 1, t.refreshDate, t.nowDate, !1), " ")
            }
        }

        function tc(o, r) {
            1 & o && (e.TgZ(0, "div", 21),
                e._uU(1, " Win a game to unlock your gauntlet. "),
                e.qZA())
        }
        ...
        let oc = (() => {
                class o {
                    ...
                    ngOnInit() {
                        this.gauntletService.fetchGauntletSlots(),
                            this.initGauntlet(),
                            this.initDate(),
                            this.initGauntletFlux()
                    }
                    ...
                    initGauntlet() {
                        this.gauntletService.gauntletSlots$.pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => this.gauntletSlots = t)
                    }

                    initDate() {
                        this.gauntletService.refreshDate$.pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => this.refreshDate = t)
                    }

                    initGauntletFlux() {
                        this.gauntletService.gauntletFlux$.pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => this.gauntletFlux = t)
                    }
                }
        ...
        let In = (() => {
                class o {
                    ...
                    initCards() {
                        this.loading = !0,
                            (0,
                                D.aj)([this.sealedService.sealedMode$, this.cardsService.protoCards$]).pipe((0,
                                u.R)(this.unsubscribe), (0,
                                P.h)(([t, n]) => t && n && n.size > 0)).subscribe(([t, n]) => {
                                    ...
                                    this.customInventoryCardsMap = this.createInventoryCardsMap(a),
                                        this.inventoryCards = a,
                                        this.protoCards = i,
                                        this.loading = !1
                                }
                            )
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "app-modal-sidebar", 0),
                                e.YNc(1, ic, 1, 0, "app-rectangular-spinner", 1),
                                e.YNc(2, rc, 1, 5, "app-cards-list", 2),
                                e.YNc(3, ac, 1, 5, "app-active-deck", 3)),
                            2 & t && (e.Q6J("closeButtonClickFn", n.destroyModal),
                                e.xp6(1),
                                e.Q6J("ngIf", n.loading),
                                e.xp6(1),
        ...
        function cc(o, r) {
            1 & o && e._UZ(0, "app-card2", 10),
            2 & o && e.Q6J("protoId", r.$implicit)
        }

        const lc = function (o, r, t) {
            return {
                "bottomSection__cards--three": o,
                "bottomSection__cards--four": r,
                "bottomSection__cards--five": t
            }
        };
        let dc = (() => {
                class o {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "gu-two-section-modal", 0),
                                e.NdJ("onCloseSealedDeckModal", function () {
                                    return n.secondaryCtaClick()
                                }),
                                e.TgZ(1, "gu-paragraph-text", 1),
                                e._uU(2, " Some cards could not be imported "),
                                e.qZA(),
                                e.TgZ(3, "gu-heading-text", 2),
                                e._uU(4, " You don't own these cards "),
                                e.qZA(),
                                e.TgZ(5, "gu-paragraph-text", 3),
                                e._uU(6),
                                e.qZA(),
                                e.TgZ(7, "gu-vertical-space", 4),
                                e.TgZ(8, "gu-vertical-space", 5),
                                e.YNc(9, cc, 1, 1, "app-card2", 6),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(10, "gu-vertical-space", 7),
                                e.TgZ(11, "gu-secondary-hex-button", 8),
                                e.NdJ("click", function () {
                                    return n.secondaryCtaClick()
                                }),
                                e.qZA(),
                                e.TgZ(12, "gu-primary-hex-button", 9),
                                e.NdJ("click", function () {
                                ...
                                e.qZA()),
                            2 & t && (e.xp6(6),
                                e.AsE(" ", n.unownedProtos.length, " card", 1 === n.unownedProtos.length ? "" : "s", " missing. Hit continue to continue deck building "),
                                e.xp6(2),
                                e.Q6J("ngClass", e.kEZ(4, lc, n.unownedProtos.length <= 3, 4 == n.unownedProtos.length, n.unownedProtos.length >= 5)),
                                e.xp6(1),
                                e.Q6J("ngForOf", n.unownedProtos))
                        },
        ...
        let Zn = (() => {
                class o {
                    ...
                    importClick() {
                        this.deckCodeService.decodeDeckCode(this.deckCode).pipe((0,
                            x.q)(1)).subscribe(({ownedCards: t, unownedProtos: n, domain: i}) => {
                    ...
                    showUnownedCardsModal(t, n, i) {
                        const a = this.cerberusModalService.open(dc);
                        a.componentInstance.unownedProtos = n,
                            a.result.then(({success: c}) => {
                    ...
                    openDeckbuilder(t, n) {
                        this.loading = !0,
                            this.decksService.createDeck(new de.$$(-1, "Imported Deck", t, "common", n)).pipe((0,
                                x.q)(1)).subscribe(i => {
                                    this.loading = !1,
                                        this.decksService.updateDeckSelectMode(!1),
                                        this.activeModal.close(),
                                        this.decksService.selectActiveDeck(i),
                                        this.modalService.createModal(Ye, {}, {
                                            blurredBackground: !0,
                                            canCloseFromOutside: !1,
                                            position: h.e1.Center,
                                            size: h.Cg.Workarea
                    ...
                    showErrorModal(t = "Something went wrong, try again, or contact our support team.") {
                        const i = this.cerberusModalService.open(sc.I, {
                            defaultStylings: !1,
                            centered: !0
                        }).componentInstance;
                        i.title = "DECK COULD NOT BE IMPORTED",
                            i.text = t,
                            i.ctaText = "BACK",
                            i.iconLigature = "alert_triangle",
                            i.iconFillColor = "colors.god.war.primary"
                    }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "gu-modal-background", 0),
                                e.TgZ(1, "gu-vertical-space", 1),
                                e.TgZ(2, "gu-heading-text", 2),
                                e._uU(3, " Import a gods unchained deck "),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(4, "gu-vertical-space", 3),
                                e.TgZ(5, "gu-paragraph-text", 4),
                                ...
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(7, "gu-vertical-space", 5),
                                e.TgZ(8, "gu-text-input", 6),
                                e.NdJ("onValueChange", function (a) {
                                    return n.onValueChange(a)
                                }),
                                e.qZA(),
                                e.TgZ(9, "gu-paragraph-text", 7),
                                e._uU(10, " This can be from a friend or one you found online "),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(11, "gu-vertical-space", 8),
                                e.TgZ(12, "gu-primary-hex-button", 9),
                                e.NdJ("click", function () {
                                ...
                                e.qZA()),
                            2 & t && (e.xp6(8),
                                e.Q6J("validateToPattern", e.DdM(4, gc))("valid", n.valid),
                                e.xp6(4),
                                e.Q6J("loading", n.loading)("disabled", !n.valid))
                        },
        ...
        function uc(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "gu-plain-square-button", 7),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().importDeck()
                    }),
        ...
        function _c(o, r) {
            ...
            if (2 & o) {
                const t = r.$implicit;
                e.ekj("god--unavailable", t.unavailable),
                    e.xp6(2),
                    e.Q6J("src", "/gu-assets/images/gods/" + t.name + "-medium.webp", e.LSH),
                    e.xp6(2),
                    e.Oqu(t.title),
                    e.xp6(2),
                    e.Oqu(t.description),
                    e.xp6(1),
                    e.Q6J("innerHTML", t.playstyle, e.oJD)
            }
        }
                ...
                class o {
                    constructor(t, n, i, a, s, c) {
                        this.modalService = t,
                            ...
                            this.gods = pc,
                            this.unsubscribe = new y.xQ,
                            this.GuGameModeType = S.tO,
                            this.Flags = _.vU,
                            this.close = () => {
                                this.akumaService.postControlEvent("gu", "GodChoose", "", "close", "Btn", "pressed"),
                                    this.modalService.destroyTopModal()
                            }
                    }
                    ...
                    selectGod(t) {
                        this.akumaService.postControlEvent("gu", "GodChoose", "", "godSelect", "Btn", "pressed"),
                            this.audioService.clickMediumV2.play(),
                            this.gameModeType === S.tO.SEALED_DECK ? this.onGodSelect(t, this.close.bind(this)) : this.handleDeckBuilder(t)
                    }

                    handleDeckBuilder(t) {
                        this.decksService.createDeck(new de.$$(-1, "Custom Deck", t, "common")).pipe((0,
                            x.q)(1)).subscribe(() => {
                                this.deckSelect ? this.decksService.updateDeckSelectMode(!0, this.gameModeId, this.forAI) : this.decksService.updateDeckSelectMode(!1),
                                    this.close(),
                                    this.modalService.createModal(Ye, {
                                        deckSelectMode: this.deckSelect
                                    }, {
                                        blurredBackground: !0,
                    ...
                    importDeck() {
                        this.modalService.destroyTopModal(),
                            this.cerberusModalService.open(Zn)
                    }
                }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "app-modal-sidebar", 0),
                                e.TgZ(1, "h1", 1),
                                e._uU(2, "Choose a God"),
                                e.qZA(),
                                e.TgZ(3, "p", 2),
                                e._uU(4, "Each deck must be aligned to a God. Choose which one you'd like to build around."),
                                e.qZA(),
                                e.YNc(5, uc, 2, 0, "gu-plain-square-button", 3),
                                e.TgZ(6, "div", 4),
                                e.YNc(7, _c, 8, 6, "div", 5),
                                e.qZA(),
                                e.YNc(8, hc, 7, 0, "div", 6)),
                            2 & t && (e.Q6J("closeButtonClickFn", n.close),
                                e.xp6(5),
                                e.Q6J("featureFlagIf", n.Flags.deckCodesEnabled),
                                e.xp6(2),
                                e.Q6J("ngForOf", n.gods),
                                e.xp6(1),
                                e.Q6J("ngIf", n.gameModeType === n.GuGameModeType.SEALED_DECK))
                        },
        ...
        function mc(o, r) {
            if (1 & o && e._UZ(0, "app-modal-sidebar", 8),
            2 & o) {
                const t = e.oxw();
        ...
        function fc(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "gu-plain-square-button", 9),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().importDeck()
                    }),
        ...
        var ve = (() => {
                return (o = ve || (ve = {}))[o.Death = 0] = "Death",
                    o[o.Deception = 1] = "Deception",
                    o[o.Light = 2] = "Light",
                    o[o.Magic = 3] = "Magic",
                    o[o.Nature = 4] = "Nature",
                    o[o.War = 5] = "War",
        ...
        let qt = (() => {
                class o {
                    constructor(t, n, i, a, s) {
                        this.decksService = t,
                            ...
                            this.modalHosted = !1,
                            this.forAI = !1,
                            this.deckBuilderDeckSelect = !1,
                            this.currentlyEditingDeckName = "",
                            this.unsubscribe = new y.xQ,
                            this.godFilters = [new Le("Death", ve.Death), new Le("Deception", ve.Deception), new Le("Light", ve.Light), new Le("Magic", ve.Magic), new Le("Nature", ve.Nature), new Le("War", ve.War)],
                            this.activeGodFilters = [],
                            this.Flags = _.vU,
                            this.destroyModal = () => {
                                this.audioService.clickTinyV2.play(),
                                    this.modalService.destroyTopModal()
                    ...
                    initGameModes() {
                        void 0 !== this.gameModeId && (this.deckBuilderDeckSelect = !0),
                            this.displayGauntlets = this.isRankedConstructed
                    }
                    ...
                    newDeck() {
                        this.akumaService.postControlEvent("gu", "MyDecks", "", "createDeck", "Btn", "pressed"),
                            this.audioService.clickItemV2.play(),
                    ...
                    getFilteredStream(t, n) {
                        return t.pipe((0,
                            M.U)(i => i.filter(a => this.filterStream(a, n))))
                    }
                    ...
                    godFilterChange(t) {
                        this.activeGodFilters = t,
                            this.filterDecks(this.activeGodFilters)
                    }

                    selectDeck(t) {
                        this.akumaService.postControlEvent("gu", "MyDecks", "", "deckChosen", "Btn", "pressed"),
                            this.deckBuilderDeckSelect ? this.deckBuilderDeckSelect && (this.decksService.updateDeckSelectMode(!0, this.gameModeId, this.forAI),
                                this.audioService.workshopCustomize.play(),
                                this.decksService.selectActiveDeck(t),
                                this.modalService.createModal(Ye, {}, {
                                    blurredBackground: !0,
                                    canCloseFromOutside: !1,
                                    position: h.e1.Center,
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.YNc(0, mc, 1, 1, "app-modal-sidebar", 0),
                                e.TgZ(1, "header", 1),
                                e.TgZ(2, "app-grouping-bar", 2),
                                e.NdJ("godFilterChangeList", function (a) {
                                ...
                                e._uU(4, "My Decks"),
                                e.qZA(),
                                e.YNc(5, fc, 2, 0, "gu-plain-square-button", 4),
                                e.qZA(),
                                e.TgZ(6, "div", 5),
                                e.TgZ(7, "app-create-new-button", 6),
                                e.NdJ("click", function () {
                                    return n.newDeck()
                                }),
                                e.qZA(),
                                e.YNc(8, Cc, 1, 4, "app-deck", 7),
                                e.ALo(9, "async"),
                                e.qZA()),
                            2 & t && (e.Q6J("ngIf", n.modalHosted),
                                e.xp6(2),
                                e.Q6J("godFilters", n.godFilters)("displayGroupingName", !1),
                                e.xp6(3),
                                e.Q6J("featureFlagIf", n.Flags.deckCodesEnabled),
                                e.xp6(3),
                                e.Q6J("ngForOf", e.lcZ(9, 6, n.filteredDecks$))("ngForTrackBy", n.trackDecksBy))
                        },
                        ...
                        data: {
                            animation: [(0,
                                ...
                                C.jt)("1s cubic-bezier(.8, -0.6, 0.2, 1.5)", (0,
                                C.oB)({
                                transform: "scale(1)",
                                opacity: 1
                            }))]), (0,
        ...
        let wc = (() => {
                class o {
                    ...
                    clickFullDetails() {
                        window.open("https://playgu.co/Sealed-Deck", "_blank"),
                            this.akuma.postEvent("Control", "sealeddeckInfo_FullDetailsBtn_pressed")
                    }
                }
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "gu-two-section-modal", 0),
                                ...
                                e.TgZ(1, "gu-paragraph-text", 1),
                                e._uU(2, " Sealed Deck Event: Core + Welcome Set "),
                                e.qZA(),
                                e.TgZ(3, "gu-heading-text", 2),
                                e._uU(4, " Rules & Prizes "),
                                e.qZA(),
                                e.TgZ(5, "gu-vertical-space", 3),
                                e.YNc(6, bc, 2, 1, "gu-vertical-space", 4),
                                e.qZA(),
                                e.TgZ(7, "gu-primary-hex-button", 5),
                                e.NdJ("click", function () {
                                    return n.clickFullDetails()
                                }),
                                e._uU(8, " Full Details "),
                                e.TgZ(9, "span"),
                                e._UZ(10, "gu-icon", 6),
                                e.qZA(),
                                e.qZA(),
        ...
        function xc(o, r) {
            1 & o && e._UZ(0, "div", 3),
            2 & o && e.ekj("winBoxes__win--filled", r.$implicit)
        }
        ...
        let Mc = (() => {
                class o {
                    constructor() {
                        this.maxWins = 5,
                            this.winCount = 0,
                            this.winElements = new Array(this.maxWins).fill(!1)
                    }
                    ...
                    renderWins() {
                        for (let t = 0; t < this.winCount; t++)
                            this.winElements[t] = !0
                    }
                }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "div", 0),
                                e.YNc(1, xc, 1, 2, "div", 1),
                                e.qZA(),
                                e.TgZ(2, "div", 2),
                                e._uU(3),
                                e.qZA()),
                            2 & t && (e.xp6(1),
                                e.Q6J("ngForOf", n.winElements),
                                e.xp6(2),
                                e.AsE("", n.winCount, " ", 1 == n.winCount ? "win" : "wins", ""))
                        },
                        directives: [l.sg],
        ...
        function yc(o, r) {
            1 & o && e._UZ(0, "div", 3),
            2 & o && e.ekj("lossBoxes__loss--filled", r.$implicit)
        }
        ...
        let kc = (() => {
                class o {
                    constructor() {
                        this.maxLosses = 3,
                            this.lossCount = 0,
                            this.lossElements = new Array(this.maxLosses).fill(!1)
                    }
                    ...
                    renderLosses() {
                        for (let t = 0; t < this.lossCount; t++)
                            this.lossElements[t] = !0
                    }
                }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "div", 0),
                                e.YNc(1, yc, 1, 2, "div", 1),
                                e.qZA(),
                                e.TgZ(2, "div", 2),
                                e._uU(3),
                                e.qZA()),
                            2 & t && (e.xp6(1),
                                e.Q6J("ngForOf", n.lossElements),
                                e.xp6(2),
                                e.AsE("", n.lossCount, " ", 1 == n.lossCount ? "loss" : "losses", ""))
                        },
                        directives: [l.sg],
        ...
        function Zc(o, r) {
            ...
            2 & o) {
                const t = e.oxw();
                e.xp6(2),
                    e.hij(" ", t.mode.type === t.GuGameModeType.DIRECT_CHALLENGE ? "Start" : "Play", " ")
            }
        }
        ...
        function Fc(o, r) {
            ...
            2 & o) {
                const t = e.oxw(2);
                e.xp6(4),
                    e.Oqu(e.lcZ(5, 1, t.secondsElapsed))
            }
        }
        ...
        function Dc(o, r) {
            1 & o && (e.ynx(0),
                e.TgZ(1, "div", 14),
                e._uU(2, "Hold to cancel"),
                e.qZA(),
                e.BQk())
        }

        function Gc(o, r) {
            if (1 & o && (e.YNc(0, Fc, 6, 3, "div", 11),
                e.YNc(1, Dc, 3, 0, "ng-container", 12)),
            2 & o) {
                const t = e.oxw();
                e.Q6J("ngIf", !t.isHovered),
                    e.xp6(1),
                    e.Q6J("ngIf", t.isHovered)
            }
        }

        const Bc = function (o, r, t, n) {
            return {
                hovered: o,
                active: r,
                pressed: t,
                "queue-button-container--disabled": n
            }
        }
            , Lc = function (o, r) {
            return {
        ...
        let Uc = (() => {
                class o {
                    constructor(t, n, i, a, s, c, d, p, w, v, O, A, G, U) {
                        ...
                        this.playService = t,
                            ...
                            this.queueService = i,
                            this.el = a,
                            this.guGameService = s,
                            this.resizeService = c,
                            this.modalService = d,
                            this.gameService = p,
                            this.loadoutService = w,
                            this.audioService = v,
                            this.akumaService = O,
                            this.cerberusModal = A,
                            this.featureFlagService = G,
                            this.environment = U,
                            this.disabled = !1,
                            this.openDeckSelect = new e.vpe,
                            this.secondsElapsed = 0,
                            this.progressCirclePercentage = 0,
                            this.echoPercentage = 50,
                            this.isPressed = !1,
                            this.isHovered = !1,
                            this.timeUntilCancel = 2e3,
                            this.unsubscribe = new y.xQ,
                            this.gameModeReady = !1,
                            this.GuGameModeType = S.tO,
                            this.disableButton = !1,
                            this.MIN_GAMES_PLAYED = 10,
                            this.AFTER_EVERY_X_GAMES = 5
                    }

                    ngOnInit() {
                        this.userId = this.auth.getUserId(),
                            this.watchLoadouts(),
                            this.queueService.getQueue(1, this.mode.id).pipe((0,
                                u.R)(this.unsubscribe)).subscribe(t => this.queue = t),
                            this.initTimer(),
                            this.watchForHover(),
                            this.checkWarningFeatureFlag(),
                            this.resizeService.viewPortUnits$.pipe((0,
                                u.R)(this.unsubscribe)).subscribe(({vw: t}) => {
                                    this.width = t * this.diameterVwMultiplier,
                                        this.height = t * this.diameterVwMultiplier
                                }
                            )
                    }
                    ...
                    watchLoadouts() {
                        this.loadoutService.loadouts$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            b.b)(t => {
                                this.loadouts = t
                            }
                    ...
                    watchForHover() {
                        const t = (0,
                            V.R)(this.btnContainer.nativeElement, "mouseenter").pipe((0,
                            M.U)(() => !0))
                            , n = (0,
                            V.R)(this.btnContainer.nativeElement, "mouseleave").pipe((0,
                            M.U)(() => !1));
                        (0,
                            Oc.T)(t, n).pipe((0,
                            u.R)(this.unsubscribe), (0,
                            ...
                            b.b)(i => {
                                this.isHovered = i,
                                    i ? this.audioService.arenaHoverStart.play() : (this.isPressed = !1,
                                        this.progressCirclePercentage = 0)
                            }
                        )).subscribe()
                    }
                    ...
                    onMouseDown() {
                        this.disableButton = !0,
                            this.guGameService.checkIfRequiresUpdate().pipe((0,
                                x.q)(1)).subscribe(t => {
                                    if (!t)
                                        return this.handleGameModePlayBtn(),
                                            (0,
                                                z.of)({});
                    ...
                    get isGameInstalled$() {
                        return this.gameService.currentGameContext$.pipe((0,
                            M.U)(t => this.gameService.isInstalled(t)))
                    }

                    showInfoModal(t, n) {
                        this.modalService.createModal(Dn.S, {
                            title: t,
                            text: n
                        }, {
                            blurredBackground: !0,
                        ...
                        this.isGameInstalled$.pipe((0,
                            x.q)(1)).subscribe(t => {
                                if (!t) {
                                    ...
                                    return console.error("GuQueueButton-?handleGameModePlayBtn() User not allowed to queue as game is not installed."),
                                        void this.showInfoModal("Unable to Queue", i)
                                }
                                switch (this.akumaService.postControlEvent("gu", "Arena", "", "gameMode", "PlayBtn", "pressed", {
                                    mode_name: S.tO[this.mode.type]
                                }),
                                    this.mode.type) {
                                    case S.tO.SOLO:
                    ...
                    handleTutorial() {
                        this.audioService.arenaClickStart.play(),
                            this.queueService.activeQueues$.pipe((0,
                                x.q)(1)).subscribe(t => {
                                    t.forEach(n => this.queueService.cancel(n))
                                }
                            ),
                            this.gameService.getBranch$(1).pipe((0,
                                x.q)(1), (0,
                                Ut.M)(this.guGameService.getGameMode$(this.mode.id)), (0,
                                b.b)(([t, n]) => {
                                    this.playService.play({
                                        ...
                                        player: {
                                            id: this.userId,
                                            deck: {
                                                id: n.properties.player.deck.id,
                                                global: n.properties.player.deck.global
                                            },
                                            collection: {
                                                id: n.properties.player.collection.id
                                            }
                                        },
                                        opponent: {
                                            deck: {
                                            ...
                                            collection: {
                                                id: n.properties.opponent.collection.id
                                            }
                                        }
                                    })
                                }
                    ...
                    handleSingle() {
                        if (this.audioService.arenaClickStart.play(),
                        this.deck && this.opponentsDeck)
                            this.queueService.activeQueues$.pipe((0,
                                x.q)(1)).subscribe(t => {
                                    t.forEach(n => this.queueService.cancel(n))
                                }
                            ),
                                this.logButtonInputted("Start"),
                                this.gameService.getBranch$(1).pipe((0,
                                    x.q)(1), (0,
                                    b.b)(t => {
                                        this.guGameService.incrementGameModeCount(0).pipe((0,
                                            x.q)(1)).subscribe(),
                                            this.logQueueCompletedSolo(),
                                            this.playService.play({
                                                realm: t.id,
                                                mode: 0,
                                                player: {
                                                    ...
                                                    deck: {
                                                        id: this.deck.id,
                                                        global: this.deck.global
                                                    },
                                                    collection: {
                                                        id: this.getLoadoutId()
                                                    }
                                                },
                                                opponent: {
                                                    id: this.userId,
                                                    deck: {
                                                        id: this.opponentsDeck.id,
                                                        global: this.opponentsDeck.global
                                                    },
                                                    collection: {
                                                        id: 0
                                                    }
                            ...
                            const t = !!this.deck;
                            this.logButtonInputted("selectDeck"),
                                this.openDeckSelect.emit({
                                    forAI: t
                                })
                        }
                    }
                    ...
                    buttonIsActive() {
                        this.logButtonInputted("Cancel"),
                            this.disableButton = !1,
                            this.audioService.clickMediumV1.play(),
                            (0,
                                Vt.H)(0, 50).pipe((0,
                                St.o)(() => this.isPressed), (0,
                                M.U)(t => 50 * t), (0,
                                M.U)(t => (this.progressCirclePercentage = t / this.timeUntilCancel * 100,
                            this.progressCirclePercentage >= 100)), (0,
                                P.h)(t => t), (0,
                                b.b)(() => {
                                    this.audioService.arenaCancel.play(),
                                        this.cancel()
                                }
                            )).subscribe()
                    }
                    ...
                    checkToShowModalIfNoWallet() {
                        this.auth.fetchAccountDetails().pipe((0,
                            x.q)(1)).subscribe(t => {
                    ...
                    showWarning() {
                        const n = this.cerberusModal.open(he.MZ, {
                            defaultStylings: !1,
                            centered: !0
                        }).componentInstance;
                        n.title = "No wallet connected",
                            n.content = `In order to receive the best prizes, you need to connect a wallet to your account. We are unable to give prizes for past events. Please go to the <a style="color: #8BE1E0; outline: none;" href=${this.environment.guManageWalletsURL}>Manage Wallets</a> page to add and connect.`,
                            n.primaryButton = {
                                text: "LET ME PLAY!",
                                closeOnClick: !0,
                ...
                launchQueue() {
                    ...
                    handleServerGame(t = !1) {
                        if (this.isPressed = !0,
                        !this.deck || !this.opponentsDeck && t) {
                            this.disableButton = !1;
                            const n = !!this.deck;
                            this.logButtonInputted("selectDeck"),
                                this.openDeckSelect.emit({
                            ...
                            this.isActive ? this.buttonIsActive() : (this.audioService.arenaClickStart.play(),
                                this.validateAndLaunchQueue())
                    }
                    ...
                    cancel() {
                        this.isPressed = !1,
                            this.progressCirclePercentage = 0,
                            this.queueService.cancel(this.queue)
                    }

                    mouseUp(t) {
                        0 === t.button && (this.isPressed = !1,
                            this.progressCirclePercentage = 0)
                    }
                    ...
                    initTimer() {
                        this.updateTimer(),
                            ...
                            this.timer.pipe((0,
                                u.R)(this.unsubscribe), (0,
                                b.b)(t => this.updateTimer())).subscribe()
                    }

                    updateTimer() {
                        if (null == this.queue || null === this.queue.startTimestamp)
                            this.secondsElapsed = 0;
                        else {
                    ...
                    checkWarningFeatureFlag() {
                        this.featureFlagService.get(_.vU.noWalletWarningRankedGame).pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            if (1 & t && (e.TgZ(0, "div", 0, 1),
                                e.NdJ("mousedown", function (a) {
                                    return 0 === a.button && n.onMouseDown()
                                }),
                                e.TgZ(2, "div", 2),
                                e._UZ(3, "app-progress-circle", 3),
                                e.qZA(),
                                e.TgZ(4, "div", 4),
                                e.TgZ(5, "div", 5),
                                e.YNc(6, Ic, 1, 0, "ng-container", 6),
                                e.qZA(),
                                e.qZA(),
                                e.qZA(),
                                e.YNc(7, Zc, 3, 1, "ng-template", null, 7, e.W1O),
                                e.YNc(9, Gc, 2, 2, "ng-template", null, 8, e.W1O)),
                            2 & t) {
                                const i = e.MAs(8)
                                    , a = e.MAs(10);
                                e.s9C("id", null == n.mode ? null : n.mode.name),
                                    e.Q6J("ngClass", e.l5B(10, Bc, n.isHovered, n.isActive, n.isPressed, n.disableButton || n.disabled))("ngStyle", e.WLB(15, Lc, n.width, n.height)),
                                    e.xp6(3),
                                    e.Q6J("percentage", n.progressCirclePercentage)("strokeColor", "red")("strokeWidth", .06 * n.width)("width", n.width),
                                    e.xp6(3),
                                    e.Q6J("ngIf", n.isActive)("ngIfThen", a)("ngIfElse", i)
                            }
                        },
        ...
        const qc = [[["", "slot", "inlinebeforetext"]], [["", "slot", "inlineaftertext"]], [["", "slot", "aftereverything"]]]
            , Ec = ["[slot='inlineBeforeText']", "[slot='inlineAfterText']", "[slot='afterEverything']"];
        let dt = (() => {
                class o {
                    constructor() {
                    }
        ...
        function Rc(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Nc, 1, 3, "app-card2", 11),
                e.BQk()),
            2 & o) {
                const t = r.$implicit
                    , n = e.oxw(2);
                e.xp6(1),
                    e.Q6J("ngIf", n.topThreeCards[t])
            }
        }

        function Qc(o, r) {
            if (1 & o && e._UZ(0, "app-god-badge", 13),
            2 & o) {
                const t = e.oxw(2);
        ...
        function Hc(o, r) {
            if (1 & o && e._UZ(0, "app-flux-god-portrait", 14),
            2 & o) {
                const t = e.oxw(2);
        ...
        function $c(o, r) {
            if (1 & o) {
                ...
                e.TgZ(0, "div", 4),
                    ...
                    e.YNc(1, Rc, 2, 1, "ng-container", 5),
                    e.YNc(2, Qc, 1, 1, "app-god-badge", 6),
                    e.YNc(3, Hc, 1, 3, "app-flux-god-portrait", 7),
                    e.YNc(4, Yc, 1, 3, "app-flux-god-portrait", 7),
                    e.TgZ(5, "div", 8),
                    e._UZ(6, "gu-icon", 9),
                    e.TgZ(7, "div", 10),
                    e._uU(8),
            ...
            if (2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("ngForOf", e.DdM(5, Jc)),
                    e.xp6(1),
                    e.Q6J("ngIf", !t.displayGauntlet),
                    e.xp6(1),
                    e.Q6J("ngIf", t.displayGauntlet && t.gauntletSlot),
                    e.xp6(1),
                    e.Q6J("ngIf", t.displayGauntlet && !t.gauntletSlot),
                    e.xp6(4),
                    e.hij("", t.deckCardCount, " / 30")
            }
        }

        function Wc(o, r) {
            if (1 & o && (e.TgZ(0, "footer", 15),
                e._uU(1),
                e.ALo(2, "titlecase"),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.hij(" ", e.lcZ(2, 1, t.deck.god), "\n")
            }
        }

        function zc(o, r) {
            if (1 & o && e._UZ(0, "app-god-badge", 19),
            2 & o) {
                const t = e.oxw(2);
        ...
        function Vc(o, r) {
            if (1 & o && (e.TgZ(0, "div", 20),
                e._uU(1),
                e.qZA()),
            2 & o) {
                const t = e.oxw(2);
                e.xp6(1),
                    e.hij(" ", null == t.deck ? null : t.deck.god, " ")
            }
        }
        ...
        function jc(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-create-new-button", 16),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().onEmptyDeckClick()
                    }),
                    e.YNc(1, zc, 1, 1, "app-god-badge", 17),
                    e.YNc(2, Vc, 2, 1, "div", 18),
                    e.qZA()
            }
            if (2 & o) {
                const t = e.oxw();
                e.Q6J("text", t.emptyText)("ngStyle", t.getEmptyDeckStyle()),
                    e.xp6(1),
                    e.Q6J("ngIf", null == t.deck ? null : t.deck.god),
                    e.xp6(1),
                    e.Q6J("ngIf", null == t.deck ? null : t.deck.god)
            }
        }
        ...
        function Xc(o, r) {
            ...
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.hij(" ", null == t.deck ? null : t.deck.name, "\n")
            }
        }
        ...
        let Gn = (() => {
                class o {
                    constructor(t, n, i, a) {
                        this.cardsService = t,
                            this.utils = n,
                            this.audioService = i,
                            this.gauntletService = a,
                            this.showDeckName = !1,
                            this.sound = !0,
                            this.selectDeck = new e.vpe,
                            this.topThreeCards = [],
                            this.isLocked = !1,
                            this.unsubscribe = new y.xQ
                    }
                    ...
                    getGauntlet() {
                        !this.displayGauntlet || this.gauntletService.gauntletSlots$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            M.U)(t => t.find(n => n.god === this.deck.god.toLowerCase()))).subscribe(t => {
                                this.gauntletSlot = t
                            }
                        )
                    }
                    ...
                    getThumbnailData() {
                        this.deck && "sealed_deck" === this.deck.deck_type ? this.topThreeCards = this.deck.items.slice(0, 3) : this.cardsService.qualityCounts$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            P.h)(t => t.size > 0), (0,
                            b.b)(t => this.calcThumbnail(t))).subscribe()
                    }

                    calcThumbnail(t) {
                        if (!this.deck || !this.deck.items || 0 === this.deck.items.length)
                            return void (this.topThreeCards = []);
                    ...
                    onEmptyDeckClick() {
                        this.sound && this.audioService.clickItemV2.play(),
                            this.selectDeck.emit(this.deck ? this.deck : null)
                    }
                    ...
                    getEmptyDeckStyle() {
                        return {
                            height: this.emptyContainerHeight,
                            width: this.width
                        }
                    }
                }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.YNc(0, $c, 9, 6, "div", 0),
                                e.YNc(1, Wc, 3, 3, "footer", 1),
                                e.YNc(2, jc, 3, 4, "app-create-new-button", 2),
                                e.YNc(3, Xc, 2, 1, "div", 3)),
                            2 & t && (e.Q6J("ngIf", 3 === (null == n.topThreeCards ? null : n.topThreeCards.length)),
                                e.xp6(1),
                                e.Q6J("ngIf", 3 === (null == n.topThreeCards ? null : n.topThreeCards.length) && !n.hideGodName),
                                e.xp6(1),
                                e.Q6J("ngIf", !n.topThreeCards || n.topThreeCards.length < 3),
                                e.xp6(1),
                                e.Q6J("ngIf", n.showDeckName))
                        },
                        directives: [l.O5, l.sg, Y, dn, Tn, dt, l.PC],
                        pipes: [l.rS],
        ...
        function el(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Kc, 1, 4, "gu-loadout-part", 23),
                e.BQk()),
            2 & o) {
                const t = r.$implicit
                    , n = e.oxw();
                e.xp6(1),
                    e.Q6J("ngIf", t[0].owned || !t[0].owned && n.showUnownedBoards)
            }
        }
        ...
        function tl(o, r) {
            ...
            if (2 & o) {
                const t = e.oxw().$implicit
                    , n = e.oxw();
                e.ekj("loadoutItemsArea__listingArea__list__item--aboveAll", n.tempTrinket === n.filterTrinkets(t)[0]),
                    e.Q6J("count", n.filterTrinkets(t).length)("trinket", t[0])("owned", null == n.filterTrinkets(t)[0] ? null : n.filterTrinkets(t)[0].owned)("equipped", n.isTrinketEquipped(t[0]))
            }
        }

        function nl(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, tl, 1, 6, "gu-loadout-part", 25),
                e.BQk()),
            2 & o) {
                const t = r.$implicit
                    , n = e.oxw();
                e.xp6(1),
                    e.Q6J("ngIf", t[0].owned || !t[0].owned && n.showUnownedTrinkets)
            }
        }
        ...
        function ol(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "gu-plain-square-button", 27),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().clearAll()
                    }),
        ...
        function il(o, r) {
            if (1 & o && (e.TgZ(0, "gu-heading-text", 28),
                e._uU(1),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Oqu(t.selectedBoard.name)
            }
        }
        ...
        function rl(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "gu-primary-hex-button", 29),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().saveOrSelect()
                    }),
        ...
        function sl(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.ynx(0),
                    e.YNc(1, al, 1, 1, "img", 30),
                    e.TgZ(2, "gu-circular-close-button", 31),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().clearBoard()
                    }),
            ...
            if (2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("ngIf", t.selectedBoard)
            }
        }

        function cl(o, r) {
            1 & o && (e.TgZ(0, "gu-paragraph-text", 33),
                e._uU(1, " choose a board "),
                e.qZA())
        }
        ...
        let Bn = (() => {
                class o {
                    constructor(t, n, i) {
                        this.modalService = t,
                            this.loadoutService = n,
                            this.guGameService = i,
                            this.allTrinkets = [[]],
                            this.allBoards = [[]],
                            this.selectedTrinkets = new Map,
                            this.showUnownedBoards = !0,
                            this.showUnownedTrinkets = !0,
                            this.unsubscribe = new y.xQ,
                            this.close = () => {
                                this.modalService.destroyTopModal()
                            }
                    ...
                    get ctaButtonText() {
                        let t = "Save";
                        return this.inSelectMode && (t = this.hasLoadoutChanged ? "Save and Select" : "Select"),
                            t
                    }

                    get hasLoadoutChanged() {
                        if (!this.loadout || this.loadout.board !== this.selectedBoard)
                            return !0;
                        {
                    ...
                    initLoadout() {
                        ...
                        t && this.selectedTrinkets.set("left", t),
                        n && this.selectedTrinkets.set("right", n)
                    }

                    initCollectables() {
                        (0,
                            D.aj)([this.loadoutService.allBoards$, this.loadoutService.allTrinkets$]).pipe((0,
                            u.R)(this.unsubscribe), (0,
                            M.U)(([t, n]) => {
                                const i = {}
                                    , a = {};
                    ...
                    clearSelected(t) {
                        this.selectedTrinkets.delete(t),
                            this.clearTempTrinket()
                    }
                    ...
                    clearAll() {
                        this.tempTrinket = null,
                            this.selectedTrinkets.delete("left"),
                            this.selectedTrinkets.delete("right"),
                            this.selectedBoard = null
                    }
                    ...
                    selectTrinket(t) {
                        !this.tempTrinket || (this.selectedTrinkets.set(t, this.tempTrinket),
                            this.tempTrinket = null)
                    }
                    ...
                    isTrinketEquipped(t) {
                        if (!t)
                            return null;
                        let n = !1;
                        return (this.selectedTrinkets.has("left") && this.selectedTrinkets.get("left").asset_id === t.asset_id || this.selectedTrinkets.has("right") && this.selectedTrinkets.get("right").asset_id === t.asset_id) && (n = !0),
                        this.tempTrinket && this.tempTrinket.asset_id === t.asset_id && (n = !0),
                            n
                    }
                    ...
                    filterTrinkets(t) {
                        return t.filter(i => {
                                let a = !0;
                                return this.selectedTrinkets.has("left") && this.selectedTrinkets.get("left").asset_id === i.asset_id && (a = !1),
                                this.selectedTrinkets.has("right") && this.selectedTrinkets.get("right").asset_id === i.asset_id && (a = !1),
                                    a
                            }
                        )
                    }
                    ...
                    filterBoards(t) {
                        return t.filter(i => {
                                let a = !0;
                                return this.selectedBoard && this.selectedBoard.asset_id === i.asset_id && (a = !1),
                                    a
                            }
                        )
                    }
                    ...
                    saveLoadout() {
                        const t = []
                            , n = this.selectedTrinkets.get("left")
                            , i = this.selectedTrinkets.get("right");
                        n && t.push(Object.assign(Object.assign({}, n), {
                            slot: 1
                        })),
                        i && t.push(Object.assign(Object.assign({}, i), {
                            slot: 2
                        }));
                        const a = {
                            board: {
                                asset_id: this.selectedBoard.asset_id
                            },
                            trinket: t.map(s => ({
                                slot: s.slot,
                                asset_id: s.asset_id
                        ...
                        return this.loadout ? this.updateLoadout(Object.assign(Object.assign({}, a), {
                            collection_id: this.loadout.collection_id
                        })) : this.createLoadout(a)
                    }

                    saveOrSelect() {
                        return this.hasLoadoutChanged ? this.saveLoadout().pipe((0,
                            x.q)(1)).subscribe(t => {
                                this.updateGameModeLoadout(t)
                            }
                        ) : this.updateGameModeLoadout(),
                            this.inSelectMode ? this.modalService.destroyModalsStack() : this.close()
                    }

                    updateGameModeLoadout(t) {
                        if (void 0 !== t || this.loadout)
                            return this.guGameService.updateGameModeLoadout(this.gameModeId, t || this.loadout.collection_id)
                    }
                }
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "header", 0),
                                ...
                                e._uU(3, " Back "),
                                e.qZA(),
                                e.TgZ(4, "gu-heading-text", 3),
                                e._uU(5, " build your loadout "),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(6, "section", 4),
                                e.TgZ(7, "div", 5),
                                e.TgZ(8, "header", 6),
                                e.TgZ(9, "gu-heading-text", 7),
                                e._uU(10, " Boards "),
                                e.qZA(),
                                e.TgZ(11, "gu-checkbox-input", 8),
                                e.NdJ("onCheck", function () {
                                ...
                                e.TgZ(12, "div", 9),
                                e.TgZ(13, "div", 10),
                                e.YNc(14, el, 2, 1, "ng-container", 11),
                                e.qZA(),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(15, "div", 12),
                                e.TgZ(16, "header", 6),
                                e.TgZ(17, "gu-heading-text", 7),
                                e._uU(18, " Trinkets "),
                                e.qZA(),
                                e.TgZ(19, "gu-checkbox-input", 8),
                                e.NdJ("onCheck", function () {
                                ...
                                e.TgZ(20, "div", 9),
                                e.TgZ(21, "div", 10),
                                e.YNc(22, nl, 2, 1, "ng-container", 11),
                                e.qZA(),
                                e.qZA(),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(23, "header", 13),
                                e.YNc(24, ol, 2, 0, "gu-plain-square-button", 14),
                                e.YNc(25, il, 2, 1, "gu-heading-text", 15),
                                e.YNc(26, rl, 1, 1, "gu-primary-hex-button", 16),
                                e.qZA(),
                                e.TgZ(27, "section", 17),
                                e.YNc(28, sl, 3, 1, "ng-container", 18),
                                e.YNc(29, cl, 2, 0, "gu-paragraph-text", 19),
                                e.TgZ(30, "gu-selected-trinket", 20),
                                e.NdJ("xButtonClick", function () {
                                    return n.clearSelected("left")
                                })("trinketClick", function () {
                                    return n.selectTrinket("left")
                                }),
                                e.qZA(),
                                e.TgZ(31, "gu-selected-trinket", 21),
                                e.NdJ("xButtonClick", function () {
                                ...
                                e.qZA(),
                                e.qZA(),
                                e.YNc(32, ll, 1, 0, "i", 22)),
                            2 & t && (e.xp6(4),
                                e.Q6J("responsiveSize", e.VKq(18, gl, e.DdM(17, dl))),
                                e.xp6(7),
                                e.Q6J("checked", n.showUnownedBoards),
                                e.xp6(3),
                                e.Q6J("ngForOf", n.allBoards),
                                e.xp6(5),
                                e.Q6J("checked", n.showUnownedTrinkets),
                                e.xp6(3),
                                e.Q6J("ngForOf", n.allTrinkets),
                                e.xp6(2),
                                e.Q6J("ngIf", n.selectedBoard || n.selectedTrinkets.get("left") || n.selectedTrinkets.get("right")),
                                e.xp6(1),
                                e.Q6J("ngIf", n.selectedBoard),
                                e.xp6(1),
                                e.Q6J("ngIf", n.selectedBoard),
                                e.xp6(1),
                                e.ekj("selectedLoadoutItems--active", !!n.selectedBoard),
                                e.xp6(1),
                                e.Q6J("ngIf", n.selectedBoard),
                                e.xp6(1),
                                e.Q6J("ngIf", !n.selectedBoard),
                                e.xp6(1),
                                e.Q6J("trinket", n.selectedTrinkets.get("left"))("highlight", !!n.tempTrinket),
                                e.xp6(1),
                                e.Q6J("trinket", n.selectedTrinkets.get("right"))("highlight", !!n.tempTrinket),
                                e.xp6(1),
                                e.Q6J("ngIf", n.tempTrinket))
                        },
                        directives: [l.sg, l.O5],
                ...
                class o {
                    constructor(t, n, i) {
                        this.modalService = t,
                            ...
                            this.unsubscribe = new y.xQ,
                            this.close = () => {
                                this.akumaService.postControlEvent("gu", "Loadouts", "", "close", "Btn", "pressed"),
                                    this.modalService.destroyTopModal()
                            }
                    }

                    ngOnInit() {
                        this.loadoutService.fetchData(),
                            this.initLoadouts()
                    }
                    ...
                    createLoadout() {
                        this.akumaService.postControlEvent("gu", "Loadouts", "", "createLoadout", "Btn", "pressed"),
                            this.modalService.createModal(Bn, {
                                gameModeId: this.gameModeId
                            }, {
                                blurredBackground: !0,
                                canCloseFromOutside: !1,
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "app-modal-sidebar", 0),
                                ...
                                e.qZA(),
                                e.TgZ(4, "div", 3),
                                e.TgZ(5, "app-create-new-button", 4),
                                e.NdJ("click", function () {
                                    return n.createLoadout()
                                }),
                                e.qZA(),
                                e.YNc(6, pl, 1, 2, "gu-loadout-display", 5),
                                e.qZA()),
                            2 & t && (e.Q6J("closeButtonClickFn", n.close),
                                e.xp6(6),
                                e.Q6J("ngForOf", n.loadouts))
                        },
        ...
        function _l(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-create-new-button", 3),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().chooseLoadout()
                    }),
        ...
        let hl = (() => {
                class o {
                    ...
                    initLoadout() {
                        (0,
                            D.aj)([this.loadoutService.loadouts$, this.guGameService.gameModes$]).pipe((0,
                            u.R)(this.unsubscribe), (0,
                            M.U)(([t, {gameModes: n}]) => ({
                            loadouts: t,
                            gameMode: n.find(i => i.id === this.gameModeId)
                        })), (0,
                            P.h)(({loadouts: t, gameMode: n}) => {
                                let i = !!t.length;
                                return i && !n.selectedLoadoutId && (i = !1),
                                    i
                            }
                        ), (0,
                            M.U)(({
                    ...
                    logSelectLoadout() {
                        this.guGameService.getGameMode$(this.gameModeId).pipe((0,
                            x.q)(1)).subscribe(t => {
                                this.akumaService.postControlEvent("gu", "Arena", "", "addLoadout", "Btn", "pressed", {
                                    mode_name: t.name
                                })
                            }
                        )
                    ...
                    chooseLoadout() {
                        this.logSelectLoadout(),
                            this.audioService.transitionWorkshop.play(),
                            this.modalService.createModal(Ln, {
                                gameModeId: this.gameModeId
                            }, {
                                blurredBackground: !0,
                                canCloseFromOutside: !0,
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.YNc(0, ul, 1, 3, "gu-loadout-display", 0),
                                e.YNc(1, _l, 1, 0, "app-create-new-button", 1)),
                            2 & t && (e.Q6J("ngIf", n.loadout),
                                e.xp6(1),
                                e.Q6J("ngIf", !n.loadout))
                        },
                        directives: [l.O5, dt],
        ...
        function ml(o, r) {
            1 & o && e._UZ(0, "img", 7),
            2 & o && e.Q6J("src", "/gu-assets/images/arena/update-lock.svg", e.LSH)
        }

        function fl(o, r) {
            1 & o && e._UZ(0, "img", 7),
            2 & o && e.Q6J("src", "/gu-assets/images/arena/update-error.svg", e.LSH)
        }
        ...
        function bl(o, r) {
            1 & o && (e.TgZ(0, "div", 8),
                e.TgZ(1, "h6", 9),
                e._uU(2, "Please Open Packs"),
                e.qZA(),
                e._UZ(3, "gu-primary-hex-button", 10),
                e.qZA()),
            2 & o && (e.xp6(3),
                e.Q6J("routerLink", e.DdM(1, vl)))
        }

        function wl(o, r) {
            if (1 & o && (e.TgZ(0, "div", 8),
                e.TgZ(1, "div", 11),
                e.TgZ(2, "div", 12),
                e._uU(3),
                e.qZA(),
            ...
            2 & o) {
                const t = e.oxw();
                e.xp6(3),
                    e.hij("Level ", null == t.playerProperties ? null : t.playerProperties.level, ""),
                    e.xp6(2),
                    e.hij("Level ", null == t.lock ? null : t.lock.lvlReq, ""),
                    e.xp6(1),
                    e.Q6J("percentage", t.percentage)("height", t.progressBarHeight)("showDivider", !0)("animateFirstValue", !0),
                    e.xp6(2),
                    e.hij("Reach level ", null == t.lock ? null : t.lock.lvlReq, " to unlock")
            }
        }
        ...
        function Ml(o, r) {
            if (1 & o && (e.ynx(0),
                e.TgZ(1, "h6", 9),
                e._uU(2, " DOWNLOAD IN PROGRESS "),
                e.qZA(),
                e.TgZ(3, "gu-paragraph-text", 18),
                e._uU(4, " You may not queue for a match until the update is complete "),
                e.qZA(),
                e.YNc(5, xl, 2, 1, "div", 19),
                e.BQk()),
            2 & o) {
                const t = e.oxw(2);
                e.xp6(5),
                    e.Q6J("ngIf", void 0 !== t.updatePercentage)
            }
        }
        ...
        function yl(o, r) {
            if (1 & o) {
                ...
                e.ynx(0),
                    e.TgZ(1, "h6", 9),
                    e._uU(2, "UPDATE REQUIRED"),
                    e.qZA(),
                    e.TgZ(3, "gu-primary-hex-button", 21),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw(2).updateGame()
                    }),
        ...
        function kl(o, r) {
            if (1 & o) {
                ...
                e.ynx(0),
                    e.TgZ(1, "h6", 9),
                    e._uU(2, " DOWNLOAD FAILED "),
                    e.qZA(),
                    e.TgZ(3, "gu-paragraph-text", 18),
                    e._uU(4, " Check your internet connection, and that you have sufficient disk space. "),
                    e.qZA(),
                    e.TgZ(5, "gu-primary-hex-button", 22),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw(2).updateGame()
                    }),
        ...
        function Ol(o, r) {
            if (1 & o && (e._UZ(0, "div", 16),
                e.TgZ(1, "div", 8),
                e.YNc(2, Ml, 6, 1, "ng-container", 17),
                e.YNc(3, yl, 4, 0, "ng-container", 17),
                e.YNc(4, kl, 6, 0, "ng-container", 17),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(2),
                    e.Q6J("ngIf", t.isUpdating && !t.updateError),
                    e.xp6(1),
                    e.Q6J("ngIf", t.isUpdateRequired && !t.isUpdating && !t.updateError),
                    e.xp6(1),
                    e.Q6J("ngIf", t.updateError)
            }
        }
        ...
        function Tl(o, r) {
            ...
            2 & o) {
                const t = e.oxw(3);
                e.xp6(1),
                    e.hij("", t.assetsUpdatePercentage, " %")
            }
        }
        ...
        function Al(o, r) {
            if (1 & o && (e.ynx(0),
                e.TgZ(1, "h6", 9),
                e._uU(2, " UPDATE IN PROGRESS "),
                e.qZA(),
                e.TgZ(3, "gu-paragraph-text", 18),
                e._uU(4, " You may not queue for a match until the update is complete "),
                e.qZA(),
                e.YNc(5, Tl, 2, 1, "div", 19),
                e.BQk()),
            2 & o) {
                const t = e.oxw(2);
                e.xp6(5),
                    e.Q6J("ngIf", void 0 !== t.assetsUpdatePercentage)
            }
        }
        ...
        function Zl(o, r) {
            if (1 & o && (e.YNc(0, Pl, 1, 0, "div", 23),
                e.YNc(1, Sl, 1, 0, "div", 24),
                e.TgZ(2, "div", 8),
                e.YNc(3, Al, 6, 1, "ng-container", 17),
                e.YNc(4, Il, 6, 0, "ng-container", 17),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.Q6J("ngIf", !t.assetsUpdateError),
                    e.xp6(1),
                    e.Q6J("ngIf", t.assetsUpdateError),
                    e.xp6(2),
                    e.Q6J("ngIf", !t.assetsUpdateError),
        ...
        let Dl = (() => {
                class o {
                    constructor(t, n, i, a, s) {
                        this.progressionService = t,
                            ...
                            this.isAssetsUpdateRequired = !1,
                            this.assetsUpdateError = !1,
                            this.assetsUpdateInProgress = !1,
                    ...
                    ngOnInit() {
                        this.lock.type === S.Gn.LEVEL && this.loadProgress(),
                            this.resizeService.viewPortUnits$.pipe((0,
                                u.R)(this.unsubscribe), (0,
                                b.b)(({vh: t}) => this.progressBarHeight = 2.5 * t)).subscribe(),
                            this.watchForUpdateState(),
                            this.watchForAssetsUpdateState(),
                        this.lock.type === S.Gn.ASSETS_UPDATE && !this.assetsUpdateInProgress && (this.assetsUpdateInProgress = !0,
                            this.updateNewAssets())
                    }
                    ...
                    updateGame() {
                        this.ngrxStore.dispatch(new Un.Kg)
                    }

                    updateNewAssets() {
                        this.isAssetsUpdateRequired && this.ngrxStore.dispatch(new Un.$9)
                    }
                    ...
                    watchForUpdateState() {
                        this.ngrxStore.select((0,
                            qn.DM)()).pipe((0,
                            u.R)(this.unsubscribe), (0,
                            P.h)(t => !!t)).subscribe(t => {
                                this.isUpdateRequired = t.isUpdateRequired,
                                    this.isUpdating = "downloading" === t.status || "extracting" === t.status,
                                    this.updateError = "error" === t.status,
                                    this.updatePercentage = t.percentage,
                                "completed" === t.status && this.guGameService.fetchGameModes()
                            }
                        )
                    }
                    ...
                    watchForAssetsUpdateState() {
                        this.ngrxStore.select((0,
                            ...
                            u.R)(this.unsubscribe), (0,
                            P.h)(t => !!t)).subscribe(t => {
                                this.isAssetsUpdateRequired = t.isUpdateRequired,
                                    this.assetsUpdateInProgress = "downloading" === t.status,
                                    this.assetsUpdateError = "error" === t.status,
                                    this.assetsUpdatePercentage = t.percentage,
                                "completed" === t.status && this.guGameService.fetchGameModes()
                            }
                        )
                    }
                    ...
                    loadProgress() {
                        (0,
                            D.aj)([this.guUserService.extendedAccountProperties$, this.progressionService.accountThresholds$]).pipe((0,
                            u.R)(this.unsubscribe), (0,
                            M.U)(([t, n]) => ({
                            playerProperties: t,
                            ...
                            b.b)(t => {
                                this.playerProperties = t.playerProperties,
                                    this.lvlThreshold = t.lvlThreshold,
                                    this.percentage = 100 * t.playerProperties.total_xp / t.lvlThreshold.exp
                            }
                        )).subscribe()
                    }
                }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            if (1 & t && (e.YNc(0, ml, 1, 1, "img", 0),
                                e.YNc(1, fl, 1, 1, "img", 0),
                                e.YNc(2, Cl, 1, 0, "ng-container", 1),
                                e.YNc(3, bl, 4, 2, "ng-template", null, 2, e.W1O),
                                e.YNc(5, wl, 9, 7, "ng-template", null, 3, e.W1O),
                                e.YNc(7, Ol, 5, 3, "ng-template", null, 4, e.W1O),
                                e.YNc(9, Zl, 5, 4, "ng-template", null, 5, e.W1O),
                                e.YNc(11, Fl, 3, 0, "ng-template", null, 6, e.W1O)),
                            2 & t) {
                                const i = e.MAs(4)
                                    , a = e.MAs(6)
                                    , s = e.MAs(8)
                                    , c = e.MAs(10)
                                    , d = e.MAs(12);
                                e.Q6J("ngIf", !n.assetsUpdateError && !n.updateError),
                                    e.xp6(1),
                                    e.Q6J("ngIf", n.assetsUpdateError || n.updateError),
                                    e.xp6(1),
                                    e.Q6J("ngTemplateOutlet", n.lock.type === n.LockType.CARDS ? i : n.lock.type === n.LockType.UPDATE ? s : n.lock.type === n.LockType.ASSETS_UPDATE ? c : n.lock.type === n.LockType.LEVEL ? a : d)
                            }
                        },
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "gu-two-section-modal", 0),
                                ...
                                e.ALo(3, "titlecase"),
                                e.qZA(),
                                e.TgZ(4, "gu-heading-text", 2),
                                e._uU(5, " Sealed Deck Event "),
                                e.qZA(),
                                e.TgZ(6, "gu-vertical-space", 3),
                                e.TgZ(7, "gu-vertical-space", 4),
                                e.YNc(8, Gl, 1, 1, "app-card2", 5),
                                e.qZA(),
                                e.TgZ(9, "gu-vertical-space", 6),
                                e.TgZ(10, "gu-paragraph-text", 7),
                                e._uU(11),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(12, "gu-vertical-space", 6),
                                e.TgZ(13, "gu-paragraph-text", 8),
                                e._uU(14, " Build a deck using any 30 of those cards you want, even those from other domains. Earn enough victories, and you will get to keep these three cards and win other prizes! "),
                                e.qZA(),
                                e.qZA(),
                                e.qZA(),
                                e.TgZ(15, "gu-primary-hex-button", 9),
                                e.NdJ("click", function () {
                                ...
                                e.qZA(),
                                e.qZA()),
                            2 & t && (e.Q6J("background", n.god),
                                e.xp6(2),
                                e.hij(" You have chosen to align with the God of ", e.lcZ(3, 4, n.god), " "),
                                e.xp6(6),
                                e.Q6J("ngForOf", n.protos),
                                e.xp6(3),
                                e.hij(" You have received the blessing of ", n.totalCards, " cards to use during this event. "))
                        },
                        directives: [l.sg, Y],
                        pipes: [l.rS],
        ...
        function Ul(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "gu-vertical-space", 5),
                    e.TgZ(1, "gu-vertical-space", 6),
                    e.TgZ(2, "gu-paragraph-text", 7),
                    e._uU(3),
                    e.ALo(4, "date"),
                    e.qZA(),
                    e.qZA(),
                    e.TgZ(5, "gu-special-hex-button", 8),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().clickJoinNow()
                    }),
            ...
            if (2 & o) {
                const t = e.oxw();
                e.xp6(3),
                    e.hij(" Signup before ", e.Dn7(4, 3, t.gameMode.properties.entry_cutoff, "EEEE haa", "AEDT"), " AEDT "),
                    e.xp6(2),
                    e.Q6J("disabled", t.userStarTotal < t.gameMode.properties.entry_cost),
                    e.xp6(3),
                    e.Oqu(t.gameMode.properties.entry_cost)
            }
        }
        ...
        function El(o, r) {
            if (1 & o && (e.TgZ(0, "gu-vertical-space", 11),
                e.TgZ(1, "gu-vertical-space", 12),
                e.TgZ(2, "gu-paragraph-text", 13),
                e._uU(3, " Thank you for joining! The event will commence in: "),
                e.qZA(),
                e.qZA(),
                e._UZ(4, "gu-countdown-timer", 14),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(4),
                    e.Q6J("targetTime", t.startTimestamp)("showFields", e.DdM(2, ql))
            }
        }
        ...
        function Rl(o, r) {
            if (1 & o && (e.TgZ(0, "gu-vertical-space", 15),
                e.TgZ(1, "gu-vertical-space", 16),
                e.TgZ(2, "gu-paragraph-text", 17),
                e._uU(3, " Your Record "),
                e.qZA(),
                e.qZA(),
                e.YNc(4, Nl, 1, 0, "ng-container", 18),
                e.qZA()),
            2 & o) {
                e.oxw();
                const t = e.MAs(5);
        ...
        function Hl(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "gu-vertical-space", 19),
                    e.TgZ(1, "gu-vertical-space", 20),
                    e.TgZ(2, "gu-paragraph-text", 17),
                    e._uU(3, " You have completed your run! "),
                    e.qZA(),
                    e.qZA(),
                    e.YNc(4, Ql, 1, 0, "ng-container", 18),
                    e.TgZ(5, "gu-special-hex-button", 21),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().clickCollectRewards()
                    }),
                    e._uU(6, " Collect Rewards "),
                    e.qZA(),
                    e.qZA()
            }
            if (2 & o) {
        ...
        function Yl(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "gu-paragraph-text", 28),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw(2).clickDropOut()
                    }),
                    e._uU(1, " DROP OUT "),
                    e.qZA()
            }
        ...
        function Wl(o, r) {
            if (1 & o && (e.TgZ(0, "gu-vertical-space", 22),
                e.TgZ(1, "gu-paragraph-text", 23),
                e._uU(2, " WINS "),
                e.qZA(),
                e._UZ(3, "gu-progress-step-counter", 24),
                e.qZA(),
                e.TgZ(4, "gu-vertical-space", 25),
                e.TgZ(5, "gu-paragraph-text", 23),
                e._uU(6, " LOSSES "),
                e.qZA(),
                e._UZ(7, "gu-progress-step-counter", 26),
                e.YNc(8, Yl, 2, 2, "gu-paragraph-text", 27),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.Q6J("responsiveSize", e.VKq(7, $l, e.DdM(6, Jl))),
                    e.xp6(3),
                    e.Q6J("filledSteps", t.wins)("totalSteps", t.gameMode.properties.max_wins),
                    e.xp6(4),
                    e.Q6J("filledSteps", t.losses)("totalSteps", t.gameMode.properties.max_losses),
                    e.xp6(1),
                    e.Q6J("ngIf", t.sealedModeStatus === t.SealedModeStatus.STARTED)
            }
        }
                ...
                class o {
                    constructor(t, n, i, a, s, c, d, p, w, v, O) {
                        this.audioService = t,
                            ...
                            this.cardsService = p,
                            this.packService = w,
                            this.loadoutService = v,
                            this.guGameService = O,
                            this.sealedModeStatus = ee.r.AVAILABLE,
                            this.wins = 0,
                            this.losses = 0,
                            this.userStarTotal = 0,
                            this.unsubscribe = new y.xQ,
                            this.SealedModeStatus = ee.r
                    }
                    ...
                    initStars() {
                        this.starsService.fetchUserStarsTotal(),
                            this.starsService.userStarTotal$.pipe((0,
                                u.R)(this.unsubscribe)).subscribe(t => this.userStarTotal = t)
                    }

                    watchSealMode() {
                        this.sealedService.sealedMode$.pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => {
                                this.sealedMode = t,
                                t && (this.wins = t.wins,
                                    this.losses = t.losses,
                                    this.startTimestamp = new Date(t.game_mode_data.properties.start_time_server).getTime() / 1e3)
                            }
                        )
                    }

                    clickCollectRewards() {
                        this.akuma.postEvent("Control", "arenaHome_SealedDeckCollectRewardsBtn_pressed"),
                            this.akuma.postEvent("Flow", "_sealDeckRun_succeeded"),
                        "function" == typeof gtag && gtag("event", "_sealDeckRun_succeeded"),
                            this.collectRewards()
                    }

                    collectRewards() {
                        this.sealedService.claimRewards$(this.sealedMode.sealed_id).pipe((0,
                            x.q)(1)).subscribe(t => {
                    ...
                    handleRewards(t) {
                        this.cardsService.fetchInventory(),
                            this.packService.fetchUnopenedPacks(),
                            this.loadoutService.fetchData(),
                            this.modalService.destroyTopModal(),
                            this.modalService.createModal(yn, {
                                rewards: t
                            }, {
                                blurredBackground: !0,
                                canCloseFromOutside: !1,
                    ...
                    onGodSelect(t, n) {
                        this.sealedService.enterSealed$(t).pipe((0,
                            x.q)(1)).subscribe(i => {
                                this.decksService.fetchDecks(),
                                    this.starsService.fetchUserStarsTotal(),
                                    this.decksService.selectActiveDeckById(i.deck_id),
                                    this.decksService.updateDeckSelectMode(!0, S.B_.SEALED_DECK),
                                    n();
                    ...
                    openWelcomeModal(t, n, i, a) {
                        ...
                        c.god = t,
                            c.protos = n,
                            c.totalCards = a,
                            c.onContinueClicked = this.onWelcomeModalContinueClicked.bind(this, n, i)
                    }

                    onWelcomeModalContinueClicked(t, n) {
                        this.audioService.clickItemV2.play(),
                            this.akuma.postEvent("Screen", "sealeddeckGodchosen_opened"),
                            this.modalService.createModal(In, {}, {
                                blurredBackground: !0,
                                canCloseFromOutside: !0,
                                position: h.e1.Center,
                                size: h.Cg.Workarea
                    ...
                    clickDropOut() {
                        this.akuma.postEvent("Control", "arenaHome_dropoutSealedBtn_pressed"),
                            this.akuma.postEvent("Flow", "_sealedDeckRun_failed"),
                        "function" == typeof gtag && gtag("event", "_sealedDeckRun_failed"),
                            this.audioService.clickItemV1.play(),
                            this.modalService.createModal(xn, {
                                ...
                                position: h.e1.Custom,
                                customPosition: ".winsLosses__dropCta:top"
                            })
                    }

                    clickJoinNow() {
                        this.akuma.postEvent("Control", "arenaHome_joinsSealedBtn_pressed", {
                            cost: this.gameMode.properties.entry_cost
                        }),
                            this.akuma.postEvent("Flow", "_sealedDeckRun_started", {
                                cost: this.gameMode.properties.entry_cost
                            }),
                        "function" == typeof gtag && gtag("event", "_sealedDeckRun_started", {
                            cost: this.gameMode.properties.entry_cost
                        }),
                            this.guGameService.clearGameModeDeck(S.B_.SEALED_DECK, !1),
                            this.guGameService.fetchGameModes(),
                            this.audioService.clickItemV2.play(),
                            this.modalService.createModal(Fn, {
        ...
        function Vl(o, r) {
            ...
            2 & o) {
                const t = e.oxw(2);
                e.xp6(1),
                    e.hij(" Event Starts: ", e.Dn7(2, 1, t.gameMode.properties.start_time_server, "EEEE h:mmaa", "AEDT"), " AEDT ")
            }
        }
        ...
        function jl(o, r) {
            ...
            2 & o) {
                const t = e.oxw(2);
                e.xp6(1),
                    e.hij(" Time Remaining: ", e.Dn7(2, 1, t.gameMode.end_timestamp_server, t.nowDate, !1), " ")
            }
        }

        function Xl(o, r) {
            if (1 & o && (e.TgZ(0, "gu-vertical-space", 19),
                e.YNc(1, Vl, 3, 5, "ng-container", 14),
                e.YNc(2, jl, 3, 5, "ng-container", 14),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("ngIf", t.sealedModeStatus === t.SealedModeStatus.AVAILABLE || t.sealedModeStatus === t.SealedModeStatus.WAITING_TO_START),
                    e.xp6(1),
                    e.Q6J("ngIf", t.sealedModeStatus === t.SealedModeStatus.STARTED || t.sealedModeStatus === t.SealedModeStatus.REWARDS_AVAILABLE)
            }
        }
        ...
        function Kl(o, r) {
            ...
            if (2 & o) {
                const t = e.oxw();
                e.xp6(2),
                    e.hij(" ", t.gameMode.id === t.GuGameModeId.DIRECT_CHALLENGE ? "LEARN MORE" : "VIEW RULES & PRIZES", " ")
            }
        }

        function ed(o, r) {
            if (1 & o && (e.TgZ(0, "div", 22),
                e._uU(1),
                e.ALo(2, "dateTo"),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.hij(" ", e.Dn7(2, 1, t.refreshDate, t.nowDate, !1), " ")
            }
        }

        function td(o, r) {
            if (1 & o && (e.TgZ(0, "div", 23),
                e._UZ(1, "app-win-visualisation", 24),
                e._UZ(2, "app-loss-visualisation", 25),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("winCount", t.wins),
                    e.xp6(1),
                    e.Q6J("lossCount", t.losses)
            }
        }
        ...
        function nd(o, r) {
            1 & o && (e.TgZ(0, "div", 31),
                ...
                e._UZ(2, "div", 33),
                e.TgZ(3, "label", 34),
                e._uU(4, "Weekend Event"),
                e.qZA(),
                e.qZA())
        }

        function od(o, r) {
            if (1 & o && (e.TgZ(0, "div", 26, 27),
                e.YNc(2, nd, 5, 0, "div", 28),
                e._UZ(3, "img", 29),
                e.TgZ(4, "div", 30),
                e._uU(5),
                e.qZA(),
            ...
            2 & o) {
                const t = e.oxw();
                e.xp6(2),
                    e.Q6J("ngIf", t.gameMode.properties.sub_type === t.GuGameModeSubType.WEEKEND_EVENT),
                    e.xp6(1),
                    e.MGl("src", "/gu-assets/images/rank-progress/gu-progress-rank-cracks--", t.shieldCrackCount, ".svg", e.LSH),
                    e.xp6(1),
                    e.ekj("cardHeader__shield__rankInitials--maxRank", t.isMaxRank),
                    e.xp6(1),
                    e.hij(" ", t.currentRankInitials, " ")
            }
        }
        ...
        function ad(o, r) {
            if (1 & o) {
                ...
                e.ynx(0),
                    ...
                    e.NdJ("selectDeck", function (i) {
                        return e.CHM(t),
                            e.oxw(2).selectDeck(i)
                    }),
                    e.qZA(),
                    e.YNc(3, id, 2, 0, "div", 43),
                    e.YNc(4, rd, 1, 3, "app-deck", 44),
                    e.qZA(),
                    e._UZ(5, "app-game-mode-loadout", 45),
                    e.BQk()
            }
            if (2 & o) {
                const t = e.oxw(2);
                e.xp6(2),
                    e.Q6J("deck", t.selectedDeck)("emptyText", t.emptyDeckText)("hideGodName", !0),
                    e.xp6(1),
                    e.Q6J("ngIf", t.gameMode.type === t.GuGameModeType.SOLO),
                    e.xp6(1),
                    e.Q6J("ngIf", t.gameMode.type === t.GuGameModeType.SOLO),
                    e.xp6(1),
                    e.Q6J("gameModeId", t.gameMode.id)
            }
        }

        function sd(o, r) {
            if (1 & o && (e.TgZ(0, "div", 50),
                e._UZ(1, "i", 51),
                e.TgZ(2, "gu-simple-text", 52),
                e.TgZ(3, "strong"),
                e._uU(4),
                e.qZA(),
                e.qZA(),
        ...
        function cd(o, r) {
            if (1 & o && (e.TgZ(0, "div", 48),
                e.YNc(1, sd, 5, 1, "div", 49),
                e.qZA()),
            2 & o) {
                const t = e.oxw(2);
                e.xp6(1),
                    e.Q6J("ngForOf", t.tutorialBullets)
            }
        }
        ...
        function ld(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "div", 35),
                    e.YNc(1, ad, 6, 6, "ng-container", 36),
                    e.YNc(2, cd, 2, 1, "ng-template", null, 37, e.W1O),
                    e.TgZ(4, "div", 38),
                    e.TgZ(5, "app-gu-queue-button", 39, 40),
                    e.NdJ("openDeckSelect", function (i) {
                        return e.CHM(t),
                            e.oxw().openDeckSelect(i)
                    }),
                    e.qZA(),
                    e.qZA(),
                    e.qZA()
            ...
            if (2 & o) {
                const t = e.MAs(3)
                    , n = e.oxw();
                e.xp6(1),
                    e.Q6J("ngIf", n.gameMode.type !== n.GuGameModeType.TUTORIAL)("ngIfElse", t),
                    e.xp6(3),
                    e.ekj("hidden", n.gameMode.lock),
                    e.xp6(1),
                    e.Q6J("mode", n.gameMode)("deck", n.getPlayDeck(n.selectedDeck))("opponentsDeck", n.getPlayDeck(n.selectedAIDeck))("challengeCode", n.challengeCodeVal)("accountProperties", n.accountProperties)("disabled", n.gameMode.id === n.GuGameModeId.DIRECT_CHALLENGE && n.challengeCode.invalid)
            }
        }

        function dd(o, r) {
            if (1 & o && (e.TgZ(0, "div", 53),
                e.TgZ(1, "div", 54),
                e._uU(2),
                e.ALo(3, "titlecase"),
                e.qZA(),
                ...
                e.ALo(6, "titlecase"),
                e.qZA(),
                e._UZ(7, "app-progress-bar", 56),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(2),
                    e.Oqu(e.lcZ(3, 9, t.currentRankName)),
                    e.xp6(3),
                    e.hij(" ", e.lcZ(6, 11, t.nextRankName), " "),
                    e.xp6(2),
                    e.Q6J("forGameModeCard", !0)("showDivider", !0)("dividerPercentage", t.gameModeRank.safety_line)("percentage", t.gameModeRank.win_points)("height", t.progressBarHeight)("animateFirstValue", !1)("supressAnimation", !0)
            }
        }
        ...
        function gd(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "div", 57),
                    e.TgZ(1, "app-flux-progress-box", 58),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().openGauntletProgress()
                    }),
                    e.ynx(2, 59),
                    e._uU(3, "gauntlet of the gods"),
                    e.BQk(),
                    e.ynx(4, 60),
                    e._uU(5, "gather flux"),
                    e.BQk(),
        ...
        function ud(o, r) {
            1 & o && (e.TgZ(0, "div"),
                ...
                e.qZA(),
                e.TgZ(6, "div", 64),
                e._uU(7, " New players receive "),
                e.TgZ(8, "strong"),
                e._uU(9, "3 Core Packs "),
                e.qZA(),
                e.TgZ(10, "app-tooltip", 65),
                e._UZ(11, "gu-icon", 66),
                e.qZA(),
                e.qZA(),
                e.qZA(),
                e.qZA()),
            2 & o && (e.xp6(10),
                e.Q6J("title", "Core Packs hold <br/> non-blockchain cards that can <br/> be used to expand your decks.")("position", "left"))
        }

        function _d(o, r) {
            1 & o && (e.TgZ(0, "gu-paragraph-text", 78),
                e._uU(1, " Your code must be 3 - 40 characters long. "),
                e.qZA())
        }

        function hd(o, r) {
            1 & o && (e.TgZ(0, "gu-paragraph-text", 79),
                e._uU(1, " Create a code or use one given to you by another mortal. "),
                e.qZA())
        }

        const md = function (o, r) {
            return {
                "directChallenge__form__field__input--invalid": o,
                "directChallenge__form__field__input--valid": r
            }
        };
        ...
        function fd(o, r) {
            if (1 & o) {
                ...
                e.TgZ(0, "div", 67),
                    e.TgZ(1, "div", 68),
                    e.TgZ(2, "gu-paragraph-text", 69),
                    e._uU(3, " Challenge code "),
                    e.qZA(),
                    e.TgZ(4, "app-tooltip", 70),
                    e._UZ(5, "gu-icon", 71),
                    e.qZA(),
                    e.qZA(),
                    e.TgZ(6, "form", 72),
                    ...
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().toggleVisibility()
                    }),
                    e.qZA(),
                    e.qZA(),
                    e.YNc(10, _d, 2, 0, "gu-paragraph-text", 76),
                    e.YNc(11, hd, 2, 0, "gu-paragraph-text", 77),
                    e.qZA(),
                    e.qZA()
            }
            if (2 & o) {
                const t = e.oxw();
                e.xp6(6),
                    e.Q6J("formGroup", t.formGroup),
                    e.xp6(2),
                    e.Q6J("type", t.challengeCodeVisible ? "text" : "password")("ngClass", e.WLB(6, md, t.challengeCode.invalid && t.challengeCode.touched, t.challengeCode.valid)),
                    e.xp6(1),
                    e.Q6J("iconLigature", t.challengeCodeVisible ? "action_hidePassword" : "action_showPassword"),
                    e.xp6(1),
                    e.Q6J("ngIf", t.challengeCode.invalid && t.challengeCode.touched),
                    e.xp6(1),
                    e.Q6J("ngIf", !t.challengeCode.invalid || !t.challengeCode.touched)
            }
        }
        ...
        function Cd(o, r) {
            if (1 & o) {
                ...
                e.TgZ(0, "a", 80),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().openLink("https://blog.godsunchained.com/2021/03/19/play-to-earn-with-weekend-ranked/")
                    }),
        ...
        function bd(o, r) {
            if (1 & o && e._UZ(0, "gu-sealed-mode-card", 82),
            2 & o) {
                const t = e.oxw();
        ...
        let En = (() => {
                class o {
                    constructor(t, n, i, a, s, c, d, p, w, v, O, A, G, U, q) {
                        this.guGameService = t,
                            ...
                            this.akumaService = w,
                            this.audioService = v,
                            this.cerberusModalService = O,
                            this.sealedService = A,
                            this.decksService = G,
                            this.cerberusModal = U,
                            this.environment = q,
                            this.emptyDeckText = "Choose Deck",
                            this.aiEmptyDeck = "Choose AI Deck",
                            this.currentRankName = "",
                            this.currentRankInitials = "",
                            this.nextRankName = "",
                            this.nextRankInitials = "",
                            this.shieldCrackCount = 0,
                            this.challengeCodeVal = "",
                            this.challengeCodeVisible = !0,
                            this.sentChallengeCodeInputAnalytics = !1,
                            this.sealedModeStatus = ee.r.AVAILABLE,
                            this.unsubscribe = new y.xQ,
                            this.GuGameModeType = S.tO,
                            this.GuGameModeSubType = S.zy,
                            this.GuGameModeId = S.B_,
                            this.SealedModeStatus = ee.r,
                            this.MIN_GAMES_PLAYED = 11,
                            this.AFTER_EVERY_X_GAMES = 5,
                            this.tutorialBullets = ["Gameplay Basics", "How Mana Works", "How to Win"],
                            i.viewPortUnits$.pipe((0,
                                u.R)(this.unsubscribe), (0,
                                b.b)(({vh: ge}) => this.progressBarHeight = 2.5 * ge)).subscribe()
                    }
                    ...
                    ngOnInit() {
                        this.buildFormGroup(),
                            ...
                            this.initRanks(),
                            this.watchQueue(),
                            this.gameMode.id === S.B_.SEALED_DECK ? this.watchSealedMode() : (this.updateSelectedDecks(),
                                this.watchForDeckSelection())
                    }

                    watchSealedMode() {
                        this.sealedService.sealedModeStatus$.pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => {
                    ...
                    watchQueue() {
                        this.queueService.getQueue(1, this.gameMode.id).pipe((0,
                            u.R)(this.unsubscribe)).subscribe(t => {
                                this.queue = t,
                                    this.queueActive ? this.challengeCode.disable() : this.challengeCode.enable()
                            }
                        )
                    }
                    ...
                    watchForDeckSelection() {
                        this.guGameService.gameModes$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            M.U)(({gameModes: t}) => t.find(n => n.id === this.gameMode.id)), (0,
                            P.h)(t => null !== t), (0,
                            M.U)(t => ({
                            lastSelectedDeckId: t.lastSelectedDeckId,
                            aiSelectedDeckId: t.aiSelectedDeckId
                        })), (0,
                            b.b)(({lastSelectedDeckId: t, aiSelectedDeckId: n}) => {
                                this.gameMode.lastSelectedDeckId = t,
                                    this.gameMode.aiSelectedDeckId = n,
                    ...
                    buildFormGroup() {
                        this.formGroup = this.fb.group({
                            challengeCode: ["", [I.kI.required, I.kI.minLength(3), I.kI.maxLength(40)]]
                        }),
                            this.challengeCode.valueChanges.subscribe(t => {
                                    this.challengeCodeVal = t,
                                    this.sentChallengeCodeInputAnalytics || (this.sentChallengeCodeInputAnalytics = !0,
                                        this.akumaService.postControlEvent("gu", "Arena", "", "challengeCode", "Txt", "inputted"))
                                }
                            )
                    }
                    ...
                    initRanks() {
                        this.gameMode && this.gameMode.ranked && this.progressionService.userRankLevels$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            P.h)(t => t && t.length > 0 && t.some(n => n.game_mode === this.gameMode.id)), (0,
                            M.U)(t => t.find(n => n.game_mode === this.gameMode.id))).subscribe(t => {
                                this.gameModeRank = t,
                                    this.setRankLevelLabels(this.gameModeRank, this.isMaxRank),
                                    this.setShieldCracking(this.gameModeRank)
                            }
                        )
                    }

                    setRankLevelLabels(t, n) {
                        this.progressionService.gameRanks$.pipe((0,
                            x.q)(1), (0,
                            b.b)(i => {
                                this.isMaxRank = this.progressionService.isMaxRank(this.gameModeRank, i);
                                const a = i[t.rank_level - 1]
                                    , s = i[t.rank_level];
                                this.currentRankName = a.level_name,
                                    this.currentRankInitials = n ? Math.trunc(t.rating).toString() : a.level_short_name,
                                !this.isMaxRank && s && (this.nextRankName = s.level_name,
                                    this.nextRankInitials = s.level_short_name)
                            }
                        )).subscribe()
                    }
                    ...
                    setShieldCracking(t) {
                        let n = 3;
                        t.loss_points < 37 ? n = 0 : t.loss_points < 53 ? n = 1 : t.loss_points < 78 && (n = 2),
                            this.shieldCrackCount = n
                    }

                    ngOnChanges(t) {
                        this.initTimer(),
                        t.allDecks && this.updateSelectedDecks()
                    }

                    updateSelectedDecks() {
                        this.selectedDeck = this.allDecks.find(t => t.id === this.gameMode.lastSelectedDeckId),
                        this.gameMode.type === S.tO.SOLO && (this.selectedAIDeck = this.allDecks.find(t => t.id === this.gameMode.aiSelectedDeckId))
                    }
                    ...
                    selectDeck(t, n = !1) {
                        this.akumaService.postControlEvent("gu", "Arena", "", "addDeck", "Btn", "pressed", {
                            mode_name: this.gameMode.name
                        }),
                            this.gameMode.type === S.tO.SEALED_DECK ? (this.audioService.clickItemV2.play(),
                                this.decksService.selectActiveDeckById(this.sealedMode.deck_id),
                                this.decksService.updateDeckSelectMode(!0, S.B_.SEALED_DECK),
                                this.modalService.createModal(In, {}, {
                                    blurredBackground: !0,
                                    canCloseFromOutside: !0,
                                ...
                                this.modalService.createModal(qt, {
                    ...
                    openGauntletProgress() {
                        this.akumaService.postControlEvent("gu", "Arena", "", "gatherFlux", "Btn", "pressed"),
                            this.modalService.createModal(oc, null, {
                                blurredBackground: !0,
                                canCloseFromOutside: !1,
                                position: h.e1.Center,
                                size: h.Cg.Workarea
                    ...
                    openSealedDeckInfoModal() {
                        this.akumaService.postEvent("Control", "arenaHome_rulesBtn_pressed"),
                            this.audioService.clickItemV2.play(),
                            this.cerberusModalService.open(wc)
                    }
                }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            if (1 & t && (e._UZ(0, "img", 0), e.TgZ(1, "header", 1), e.TgZ(2, "div", 2), e.TgZ(3, "h1", 3), e._uU(4), e.qZA(), e.YNc(5, Xl, 3, 2, "gu-vertical-space", 4), e.TgZ(6, "div", 5), e._uU(7), e.qZA(), e.YNc(8, Kl, 3, 1, "gu-vertical-space", 6), e.YNc(9, ed, 3, 5, "div", 7), e.YNc(10, td, 3, 2, "div", 8), e.qZA(), e.YNc(11, od, 6, 5, "div", 9), e.qZA(), e.YNc(12, ld, 7, 10, "div", 10), e.YNc(13, dd, 8, 13, "div", 11), e.YNc(14, gd, 6, 0, "div", 12), e.YNc(15, pd, 0, 0, "ng-template", null, 13, e.W1O), e.YNc(17, ud, 12, 2, "div", 14), e.YNc(18, fd, 12, 9, "div", 15), e.YNc(19, Cd, 2, 0, "a", 16), e.YNc(20, vd, 1, 1, "app-lock", 17), e.YNc(21, bd, 1, 3, "gu-sealed-mode-card", 18)),
                            2 & t) {
                                const i = e.MAs(16);
        ...
        function xd(o, r) {
            if (1 & o && e._UZ(0, "app-game-mode-card", 4, 5),
            2 & o) {
                const t = e.oxw();
        ...
        function Md(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-game-mode-card", 7),
                    e.NdJ("click", function (i) {
                        return e.CHM(t),
                            e.oxw(2).animatedStackShuffle(i)
                    }),
                    e.qZA()
            }
            if (2 & o) {
                const t = r.$implicit
                    , n = e.oxw(2);
                e.ekj("otherModes__mode--fadedOut", t.fadedOut),
                    e.Q6J("gameMode", t.gameMode)("allDecks", n.allDecks)("accountProperties", n.accountProperties)("isPrimaryCard", !1),
                    e.uIk("gameModeId", t.gameMode.id)("gameModeName", t.gameMode.name)
            }
        }

        function yd(o, r) {
            if (1 & o && (e.ynx(0),
                e.YNc(1, Md, 1, 8, "app-game-mode-card", 6),
                e.BQk()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("ngForOf", t.otherCompModes)
            }
        }

        const kd = function (o) {
            return {
                otherModes__disable: o
            }
        };
        let Od = (() => {
                class o {
                    constructor(t, n, i, a, s, c) {
                        this.resizeService = t,
                            this.guGameService = n,
                            this.akumaService = i,
                            this.audioService = a,
                            this.authService = s,
                            this.userService = c,
                            this.maxZIndexValue = 9,
                            this.unsubscribe = new y.xQ,
                            this.userWallets = [],
                            t.viewPortUnits$.pipe((0,
                                u.R)(this.unsubscribe), (0,
                                b.b)(({vw: d}) => this.vw = 2.5 * d)).subscribe()
                    }
                    ...
                    ngOnInit() {
                        this.createCompOtherModes(this.gameModes.slice(1)),
                            this.initAccountProperties()
                    }

                    ngAfterViewInit() {
                        this.resizeService.windowSize$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            b.b)(() => {
                                this.takeMeasurements(),
                                    this.layoutStackOfCards()
                            }
                        )).subscribe(),
                            this.assignInitialStackOrderIndexes(),
                            this.layoutStackOfCards()
                    }

                    ngOnChanges(t) {
                        t.gameModes && !t.gameModes.firstChange && (this.createCompOtherModes(t.gameModes.currentValue.slice(1)),
                            setTimeout(() => {
                                    this.assignInitialStackOrderIndexes(),
                                        this.layoutStackOfCards()
                                }
                    ...
                    takeMeasurements() {
                        this.otherModesContainerWidth = this.otherModesContainer.nativeElement.offsetWidth,
                            this.modeCardWidth = this.primaryModeCard.nativeElement.offsetWidth,
                            this.overlapAmount = (this.otherModesContainerWidth - this.modeCardWidth) / (this.otherCompModes.length - 1)
                    }

                    createCompOtherModes(t) {
                        this.otherCompModes = t.map((n, i) => ({
                            gameMode: n,
                            stackOrderIndex: i,
                            fadedOut: !1
                        }))
                    ...
                    assignInitialStackOrderIndexes() {
                        this.clickedModeId = "",
                            Array.from(this.otherModesContainer.nativeElement.children).forEach((t, n) => {
                                    t.setAttribute("data-stack-order-index", n),
                    ...
                    reOrderStack(t) {
                        ...
                        this.getNativeEl(t).setAttribute("data-stack-order-index", -1),
                            n.sort((s, c) => parseInt(s.getAttribute("data-stack-order-index"), 10) - parseInt(c.getAttribute("data-stack-order-index"), 10)),
                            n.forEach((s, c) => s.setAttribute("data-stack-order-index", c));
                        const a = n.reduce((s, c) => (s[c.getAttribute("gameModeId")] = +c.dataset.stackOrderIndex + 1,
                            s), {});
                    ...
                    animatedStackShuffle(t) {
                        ...
                        for (const c of t.path)
                            if ("app-game-mode-card" === c.localName) {
                        ...
                        this.akumaService.postControlEvent("gu", "Arena", "", "gameMode", "Tile", "pressed", {
                            mode_name: a
                        });
                        const s = k.p8.timeline({
                            paused: !0
                        });
                        s.to(i, {
                            duration: .25,
                            ...
                            zIndex: this.maxZIndexValue
                        }).add(() => this.reOrderStack(n)).to(i, {
                            duration: .25,
                            x: 0,
                            ease: "power2.inOut"
                        }).add(() => this.layoutStackOfCards(), "-=0.23"),
                            s.play()
                    }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        viewQuery: function (t, n) {
                            if (1 & t && (e.Gf(En, 5, e.SBq),
                                e.Gf(wd, 5)),
                            2 & t) {
                                let i;
                                e.iGM(i = e.CRH()) && (n.primaryModeCard = i.first),
                                e.iGM(i = e.CRH()) && (n.otherModesContainer = i.first)
                            }
                        },
                        inputs: {
                            gameModes: "gameModes",
                        ...
                        template: function (t, n) {
                            1 & t && (e.YNc(0, xd, 2, 4, "app-game-mode-card", 0),
                                e.TgZ(1, "div", 1, 2),
                                e.YNc(3, yd, 2, 1, "ng-container", 3),
                                e.qZA()),
                            2 & t && (e.Q6J("ngIf", n.gameModes[0]),
                                e.xp6(1),
                                e.Q6J("ngClass", e.VKq(3, kd, n.gameModes[0].lock)),
                                e.xp6(2),
                                e.Q6J("ngIf", n.otherCompModes))
                        },
        ...
        const Pd = ["refreshSection"]
            , Sd = function (o) {
            return {
                "gameModes--refreshing": o
            }
        };

        function Td(o, r) {
            if (1 & o && e._UZ(0, "app-game-mode-switcher", 7),
            2 & o) {
                const t = e.oxw(2);
                e.Q6J("gameModes", t.allGameModes)("allDecks", t.allDecks)("ngClass", e.VKq(3, Sd, t.fadeGameModeSwitcher))
            }
        }
        ...
        function Ad(o, r) {
            if (1 & o && (e.ynx(0),
                e.TgZ(1, "div", 1),
                e._UZ(2, "app-player-stats", 2),
                e.YNc(3, Td, 1, 5, "app-game-mode-switcher", 3),
                e.qZA(),
                e.TgZ(4, "h2", 4, 5),
                e._uU(6),
                e.qZA(),
                e._UZ(7, "app-news-provider", 6),
                e.BQk()),
            2 & o) {
                const t = e.oxw();
                e.xp6(3),
                    e.Q6J("ngIf", t.allGameModes && !!t.allGameModes.length),
                    e.xp6(1),
                    e.Q6J("hidden", !t.refreshing),
                    e.xp6(2),
                    e.hij(" ", t.refreshMsg, " ")
            }
        }
        ...
        let Id = (() => {
                class o {
                    constructor(t, n, i, a, s, c, d, p, w, v, O) {
                        this.gameService = t,
                            this.decksService = n,
                            this.guUserService = i,
                            this.progressionService = a,
                            this.modalService = s,
                            this.sealedService = c,
                            this.cerberusModalService = d,
                            this.cardsService = p,
                            this.packService = w,
                            this.loadoutService = v,
                            ...
                            this.fadeGameModeSwitcher = !1,
                            this.fetchDecks()
                    }

                    notifyUser() {
                        this.storageService.get(["_USER_NOTIFIED"]) || this.cerberusModalService.open(Ss, {
                            centered: !0
                        })
                    }
                    ...
                    ngOnInit() {
                        this.fetchGameModes(),
                            this.initUserDetails(),
                            this.progressionService.fetchUserRankLevel(),
                            this.watchSealedEnded()
                    }
                    ...
                    watchSealedEnded() {
                        this.sealedService.sealedModeStatus$.pipe((0,
                            u.R)(this.unsubscribe), (0,
                            P.h)(t => t === ee.r.ENDED), (0,
                            pe.VS)(t => this.sealedService.sealedMode$), (0,
                            pe.VS)(t => this.sealedService.claimRewards$(t.sealed_id))).subscribe(t => {
                                this.cardsService.fetchInventory(),
                                    this.packService.fetchUnopenedPacks(),
                                    this.loadoutService.fetchData(),
                                    this.modalService.createModal(yn, {
                    ...
                    fetchGameModes() {
                        this.gameService.gameModes$.pipe((0,
                            u.R)(this.unsubscribe)).subscribe(({gameModes: t, refresh: n}) => {
                    ...
                    showRefreshAnimation(t = this.allGameModes) {
                        if ((!this.allGameModes || 0 === this.allGameModes.length) && (this.allGameModes = [...t.sort((s, c) => s.order - c.order)]),
                            !this.refreshSection)
                            return !1;
                        this.refreshing = !0,
                            this.fadeGameModeSwitcher = !0,
                            k.p8.timeline().to(this.refreshSection.nativeElement, {
                                duration: .25,
                                y: -25,
                                opacity: 1,
                                ease: "power2.out"
                                ...
                                duration: 1
                                    ...
                                    this.fadeGameModeSwitcher = !1,
                                        this.allGameModes = [...t.sort((s, c) => s.order - c.order)]
                                }
                    ...
                    fetchDecks() {
                        (0,
                            D.aj)([this.decksService.userDecks$, this.decksService.starterDecks$]).pipe((0,
                            u.R)(this.unsubscribe), (0,
                            b.b)(([t, n]) => {
                                this.userDecks = t,
                                    this.starterDecks = n,
                    ...
                    initUserDetails() {
                        (0,
                            D.aj)([this.guUserService.extendedAccountProperties$, this.progressionService.accountThresholds$]).pipe((0,
                            u.R)(this.unsubscribe), (0,
                            P.h)(([t, n]) => !!t && !!n.length)).subscribe(([t, n]) => {
                                this.user = t,
                                    this.loaded = !0,
                                    this.xpProgress = ot({
                                        xp: t.total_xp,
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && e.YNc(0, Ad, 8, 3, "ng-container", 0),
                            2 & t && e.Q6J("ngIf", n.loaded)
                        },
                        directives: [l.O5, On, Sn, Od, l.mk],
        ...
        function Zd(o, r) {
            1 & o && (e.TgZ(0, "div", 3),
                e._UZ(1, "app-rectangular-spinner", 4),
                e.qZA())
        }

        function Fd(o, r) {
            if (1 & o && e._UZ(0, "app-cards-list", 5),
            2 & o) {
                const t = e.oxw();
        ...
        let Dd = (() => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e._UZ(0, "app-modal-sidebar", 0),
                                e.YNc(1, Zd, 2, 0, "div", 1),
                                e.YNc(2, Fd, 1, 4, "app-cards-list", 2)),
                            2 & t && (e.Q6J("closeButtonClickFn", n.close),
                                e.xp6(1),
                                e.Q6J("ngIf", !n.protoCards.length),
                                e.xp6(1),
                                e.Q6J("ngIf", n.protoCards.length))
                        },
                        directives: [ke, l.O5, at, It],
        ...
        function Bd(o, r) {
            if (1 & o) {
                const t = e.EpF();
                e.TgZ(0, "app-card2", 23),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw(2).playHoverItem()
                    }),
                    e.qZA()
            }
            if (2 & o) {
        ...
        function Ld(o, r) {
            1 & o && (e.TgZ(0, "div", 18),
                ...
                e._uU(3, "Icons"),
                e.qZA(),
                e._UZ(4, "gu-primary-hex-button", 20),
                e.qZA())
        }
        ...
        function Ed(o, r) {
            if (1 & o) {
                ...
                e.ynx(0),
                    e.TgZ(1, "section", 3),
                    e.TgZ(2, "div", 4),
                    e._UZ(3, "app-player-stats", 5),
                    e.qZA(),
                    e.TgZ(4, "div", 6),
                    e.TgZ(5, "div", 7),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().openInventoryCardsModal()
                    }),
                    e._UZ(6, "img", 8),
                    e.TgZ(7, "div", 9),
                    e.YNc(8, Bd, 1, 4, "app-card2", 10),
                    e.qZA(),
                    e.TgZ(9, "h1", 11),
                    e._uU(10, "Cards"),
                    e.qZA(),
                    e._UZ(11, "gu-primary-hex-button", 12),
                    e.qZA(),
                    e.TgZ(12, "div", 13),
                    e._UZ(13, "img", 14),
                    e.TgZ(14, "h1", 11),
                    e._uU(15, "Boards"),
                    e.qZA(),
                    e.TgZ(16, "gu-primary-hex-button", 15),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().openMyBoardsModal()
                    }),
                    e.qZA(),
                    e.qZA(),
                    e.TgZ(17, "div", 13),
                    ...
                    e._uU(20, "Trinkets"),
                    e.qZA(),
                    e.TgZ(21, "gu-primary-hex-button", 17),
                    e.NdJ("click", function () {
                        return e.CHM(t),
                            e.oxw().openMyBoardsModal()
                    }),
                    ...
                    e._uU(25, "Emotes"),
                    e.qZA(),
                    e._UZ(26, "gu-primary-hex-button", 20),
                    e.qZA(),
                    e.YNc(27, Ld, 5, 0, "div", 21),
                    e.qZA(),
                    e.qZA(),
                    e._UZ(28, "app-news-provider", 22),
                    e.BQk()
            }
            if (2 & o) {
                const t = e.oxw();
                e.xp6(3),e.MGl("leftLabel", "Collection Level ", t.userCollectionLevel, ""),e.MGl("rightLabel", "Level ", t.userCollectionLevel + 1, ""),e.Q6J("progressPercent", t.collectionProgress)("statDisplays", e.VKq(8, qd, e.VKq(6, Ud, t.user.won_matches))),e.xp6(5),e.Q6J("ngForOf", t.topCards),e.xp6(19),e.Q6J("ngIf", !1)
            }
        }
        ...
        let Nd = (() => {
                class o {
                    constructor(t, n, i, a, s, c, d) {
                        this.guUserService = t,
                            ...
                            this.loading = !1,
                            this.accountLoaded = !1,
                            this.topCards = [],
                            this.unsubscribe = new y.xQ,
                            this.inGame = !1,
                            this.collectionProgress = 50,
                            this.userCollectionLevel = 1
                    }
                    ...
                    getUserDetails() {
                        (0,
                            ...
                            b.b)(([t, n, i]) => {
                                this.user = t,
                                    this.account = n,
                                    this.accountLoaded = !0,
                                    this.percentage = this.progressionService.calcPercentage(new X.oW(t.total_xp, t.xp_to_next, t.level), i)
                            }
                        )).subscribe()
                    }
                    ...
                    getCardsData() {
                        (0,
                            D.aj)([this.cardsService.qualityCounts$, this.cardsService.inventoryCards$]).pipe((0,
                            u.R)(this.unsubscribe), (0,
                            b.b)(() => this.cardsService.setNewInventoryCardCount(0)), (0,
                            P.h)(([t, n]) => t.size > 0 && n.length > 0)).subscribe(([t, n]) => {
                    ...
                    openInventoryCardsModal() {
                        this.audioService.transitionWorkshop.play(),
                            this.modalService.createModal(Dd, {
                                modalHosted: !0
                            }, {
                                blurredBackground: !0,
                                canCloseFromOutside: !0,
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.YNc(0, Gd, 1, 0, "app-rectangular-spinner", 0),
                                e.YNc(1, Ed, 29, 10, "ng-container", 1)),
                            2 & t && (e.Q6J("ngIf", n.loading),
                                e.xp6(1),
                                e.Q6J("ngIf", !n.inGame && n.user))
                        },
                        directives: [l.O5, at, On, l.sg, Sn, Y, Pt],
        ...
        function Qd(o, r) {
            ...
            2 & o) {
                const t = r.$implicit
                    , n = r.last;
                e.xp6(1),
                    e.MGl("src", "/gu-assets/images/cardpacks/cropped/", t.type, ".webp", e.LSH),
                    e.xp6(1),
                    e.Q6J("ngIf", !n),
                    e.xp6(2),
                    e.hij(" ", t.count, " "),
                    e.xp6(1),
                    e.Gre("pack__label__colored ", t.type.toLowerCase(), ""),
                    e.xp6(1),
                    e.hij(" ", e.lcZ(7, 8, t.type), " "),
                    e.xp6(2),
                    e.hij(" ", 1 === t.count ? "Pack" : "Packs", " ")
            }
        }

        function Hd(o, r) {
            if (1 & o && (e.TgZ(0, "div", 7),
                e.YNc(1, Qd, 9, 10, "div", 8),
                e.qZA()),
            2 & o) {
                const t = e.oxw();
                e.xp6(1),
                    e.Q6J("ngForOf", t.packGroups)
            }
        }
        ...
        let Yd = (() => {
                class o {
                    ...
                    ngOnInit() {
                        this.packService.unopenedPacks$.pipe((0,
                            P.h)(t => t && t.length > 0), (0,
                            M.U)(t => t.filter(n => "starter" === n.pack_source)), (0,
                            P.h)(t => t && t.length > 0), (0,
                            x.q)(1), (0,
                            M.U)(t => this.utils.groupBy(t, n => n.god)), (0,
                            b.b)(t => {
                                this.packGroups = Array.from(t.keys()).map(n => ({
                                    type: n,
                                    count: t.get(n).length
                                }))
                            }
                        )).subscribe()
                    }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "h2", 0),
                                e._uU(1, "Welcome to Gods Unchained!"),
                                e.qZA(),
                                e.TgZ(2, "div", 1),
                                e._uU(3, "As part of your welcome pack we have given you:"),
                                e.qZA(),
                                e.YNc(4, Hd, 2, 1, "div", 2),
                                e.TgZ(5, "footer", 3),
                                e.TgZ(6, "div", 4),
                                e._uU(7, " Please visit the Temple "),
                                e._UZ(8, "gu-icon", 5),
                                e._uU(9, " to Open them "),
                                e.qZA(),
                                e.TgZ(10, "gu-primary-hex-button", 6),
                                e.NdJ("click", function () {
                                    return n.continue()
                                }),
                                e.qZA(),
                                e.qZA()),
                            2 & t && (e.xp6(4),
                                e.Q6J("ngIf", n.packGroups),
                                e.xp6(4),
                                e.Q6J("iconLigature", "temple"))
                        },
                        directives: [l.O5, l.sg],
                        pipes: [l.rS],
                ...
                class o {
                    constructor(t, n, i, a, s, c, d, p) {
                        this.gameService = t,
                            ...
                            this.appRef = c,
                            this.progressionService = d,
                            this.cerberusModalService = p
                    }

                    canActivate(t, n) {
                        const i = this.authService.getUserId();
                        return this.requiresManualUpdate() ? (this.forceManualUpdateModal(),
                            !1) : (this.letUserIn(i),
                            !0)
                    }

                    letUserIn(t) {
                        this.userHasStarterPacks$(t).pipe((0,
                            x.q)(1)).subscribe(n => {
                                !0 === n && this.modalService.createModal(Yd, {
                                    onClose: null
                                }, {
                                    canCloseFromOutside: !1,
                                    position: h.e1.Center,
                    ...
                    userHasStarterPacks$(t) {
                        return this.packService.fetchUnopenedPacksById().pipe((0,
                            x.q)(1), (0,
                            M.U)(n => {
                                if (!n || 0 === n.length)
                                    return !1;
        ...
        const $d = [{
            ...
            children: [{
                ...
                data: {
                    state: F.referrals,
                    featureFlag: _.vU.referralsEnabled
                },
                canActivate: [_t.s]
            }, {
                path: F.spgp,
                ...
                data: {
                    state: F.playToEarn,
                    featureFlag: _.vU.playToEarnEnabled
                },
                canActivate: [_t.s]
            }]
        }];
        let Wd = (() => {
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275inj = e.cJS({
                        imports: [[we.Bz.forChild($d)], we.Bz]
                    }),
                    o
            }
        )();
        ...
        function zd(o, r) {
            ...
            if (2 & o) {
                ...
                e.xp6(1),
                    e.MGl("title", "Group by ", t.name, ""),
                    e.xp6(1),
                    e.Tol(t.name.toLowerCase()),
                    e.Q6J("ngClass", e.VKq(6, Rn, n.isSelected(t)))("title", "Show decks for god: " + t.name),
                    e.xp6(1),
                    e.Q6J("iconLigature", "god_" + t.name.toLowerCase())
            }
        }
        ...
        let Vd = (() => {
                class o {
                    constructor(t) {
                        this.audio = t,
                            this.godFilters = [],
                            this.displayGroupingName = !0,
                            this.godFilterChangeList = new e.vpe,
                            this.activeGodFilters = []
                    }
                    ...
                    selectAllGodFilters() {
                        this.audio.clickTinyV1.play(),
                            this.activeGodFilters = [],
                            this.godFilterChangeList.emit(this.godFilters)
                    }

                    selectGodFilter(t) {
                        this.audio.clickTinyV1.play(),
                            this.activeGodFilters.some(n => n.type === t.type) ? this.activeGodFilters = this.activeGodFilters.filter(n => n.type !== t.type) : this.activeGodFilters.push(t),
                            this.godFilterChangeList.emit(this.activeGodFilters)
                    }
                ...
                return o.\u0275fac = function (t) {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        inputs: {
                            godFilters: "godFilters",
                            displayGroupingName: "displayGroupingName"
                        },
                        outputs: {
                            godFilterChangeList: "godFilterChangeList"
                        },
                        decls: 4,
                        vars: 4,
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "app-tooltip", 0),
                                ...
                                e.qZA(),
                                e.qZA(),
                                e.YNc(3, zd, 4, 8, "ng-container", 3)),
                            2 & t && (e.xp6(1),
                                e.Q6J("ngClass", e.VKq(2, Rn, n.isAllGodFiltersSelected)),
                                e.xp6(2),
                                e.Q6J("ngForOf", n.godFilters))
                        },
                        directives: [Fe.K, l.mk, l.sg],
        ...
        const jd = ["groupsContainer"];

        function Xd(o, r) {
            if (1 & o && e._UZ(0, "app-inventory-cards", 7),
            2 & o) {
                const t = e.oxw();
                e.Q6J("showBundle", !0)("expandedViewMode", t.expandedViewMode)("columns", 4)("showCardCounts", !1)("showUnowned", !1)("displayedGroupedProtos", t.displayedGroupedProtos)("filterCardIds", t.filterCardIds)
            }
        ...
        function Kd(o, r) {
            if (1 & o && e._UZ(0, "app-group-quality", 8),
            2 & o) {
                const t = e.oxw();
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "header", 0),
                                ...
                                e.YNc(6, Xd, 1, 7, "app-inventory-cards", 5),
                                e.YNc(7, Kd, 1, 6, "app-group-quality", 6),
                                e.qZA()),
                            2 & t && (e.xp6(2),
                                e.Oqu(n.title),
                                e.xp6(1),
        ...
        const tg = function (o, r) {
            return {
                rewardState__nextReward__container: o,
                rewardState__lastReward__container: r
            }
        }
            , ng = function (o, r, t, n, i, a) {
            return {
            ...
            , og = function (o, r) {
            return {
                rewardState__nextReward__packImage: o,
                rewardState__lastReward__packImage: r
            }
        };
        let ig = (() => {
                class o {
                    ...
                    o.\u0275cmp = e.Xpm({
                        ...
                        template: function (t, n) {
                            1 & t && (e.TgZ(0, "div", 0),
                                ...
                                e.qZA(),
                                e.qZA()),
                            2 & t && (e.Q6J("className", n.isAchieved || n.isNextLevel() ? "activeState" : "inactiveState")("ngClass", e.WLB(5, tg, !n.isFinalLevel(), n.isFinalLevel())),
                                e.xp6(1),
                                e.Q6J("ngClass", e.HTZ(8, ng, !n.isFinalLevel() && n.isAchieved, n.isFinalLevel() && n.isAchieved, !n.isFinalLevel() && !n.isAchieved && n.isNextLevel(), n.isFinalLevel() && !n.isAchieved && n.isNextLevel(), !n.isFinalLevel() && !n.isAchieved && !n.isNextLevel(), n.isFinalLevel() && !n.isAchieved && !n.isNextLevel())),
                                e.xp6(2),
                                e.MGl("src", "/gu-assets/images/cardpacks/", n.diety, ".webp", e.LSH),
                                e.Q6J("ngClass", e.WLB(15, og, !n.isFinalLevel(), n.isFinalLevel())))
                        },
                        directives: [l.mk],
        ...
        e.B6R(Mn, [eg, Ft, l.O5, wn, Y, l.mk, bn], [ye.XX]),
            e.B6R(qt, [l.O5, ke, Vd, rt.w, dt, l.sg, Gn], [l.Ov]),
            e.B6R(kn, [Re, l.sg, ig, l.O5, l.mk], [l.rS])
    }
    ,
    20991: (gt, be, g) => {
        g.d(be, {
        ...
        let pe = (() => {
                class M {
                    ...
                    canActivate(P, $e) {
                        return this.featureFlagService.get(P.data.featureFlag).pipe((0,
                            z.h)(ze => !0 === ze))
                    }
                }
        ...
        let P = (() => {
                class R {
                    transform(E, ae) {
                        ...
                        if (E < 1e3)
                            return E;
                        _e = Math.floor(Math.log(E) / Math.log(1e3));
                        const $ = E / Math.pow(1e3, _e);
                        if (Number.isNaN($))
                            return null;
                        const Te = b[_e - 1];
            ...
            , $e = (() => {
                class R {
                    transform(E, ae, ..._e) {
                        const $ = JSON.parse(JSON.stringify(E));
                ...
                return R.\u0275fac = function (E) {
                    ...
                    ,
                    R.\u0275pipe = M.Yjl({
                        name: "filterNavItemsByFeatureFlags",
                        type: R,
                        pure: !0
                    }),
                    R
    ...
    76638: (gt, be, g) => {
        ...
        let z = (() => {
                class V {
                    transform(M) {
                        return !M || M.length < 11 ? M : `${M.slice(0, 6)}...${M.slice(M.length - 4)}`
                    }
                }
